    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Manage</strong> Sections</h2>
                    </div>
                    <div class="body">
                        <ul class="nav nav-tabs padding-0">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#sublist">Section List</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addsub">Add Section</a></li>
                        </ul>                        
                    </div>
                </div>
                <div class="tab-content">                   
                      ...
                      foreach ($result->result() as $row) {
                          ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:showConfirmMessage('<?php echo $row->id; ?>','<?php echo $row->section; ?>');"><i class="zmdi zmdi-delete"></i>
                                                    </a>
                    ...
                    <div class="tab-pane" id="addsub">
                        <div class="card">
                            <form method="post" action="<?php echo site_url('section');?>">
                            <div class="body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" value="" name="field_section" placeholder="Section Name" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-raised btn-round btn-primary">Add Section</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
function showConfirmMessage(id,section) {
    swal({
        title: "Are you sure?",
        text: "You want to delete Section: "+ section +" with id :" + id,
        type: "warning",
        ...
        post('<?php echo site_url('section');?>', {delete: 'yes',id: id});
    });
}
</script>
</body>
