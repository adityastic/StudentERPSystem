    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Manage</strong> Subjects</h2>
                    </div>
                    <div class="body">
                        <ul class="nav nav-tabs padding-0">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#sublist">Subject List</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addsub">Add Subject</a></li>
                        </ul>                        
                    </div>
                </div>
                <div class="tab-content">                   
                      ...
                      foreach ($result->result() as $row) {
                          ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:showConfirmMessage('<?php echo $row->id; ?>','<?php echo $row->subject; ?>');"><i class="zmdi zmdi-delete"></i>
                                                    </a>
                    ...
                    <div class="tab-pane" id="addsub">
                        <div class="card">
                            <form method="post" action="<?php echo site_url('subject');?>">
                            <div class="body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" value="" name="field_subject" placeholder="Subject Name" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-raised btn-round btn-primary">Add Subject</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
function showConfirmMessage(id,subject) {
    swal({
        title: "Are you sure?",
        text: "You want to delete Subject: "+subject +" with id :" + id,
        type: "warning",
        ...
        post('<?php echo site_url('subject');?>', {delete: 'yes',id: id});
    });
}
</script>
</body>
