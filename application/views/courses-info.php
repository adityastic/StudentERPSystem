                ...
                <ul class="list">
                    ...
                    <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-graduation-cap"></i><span>Courses</span> </a>
                        <ul class="ml-menu">
                            ...
                            <li class="active"><a href="courses-info.html">Courses Info</a></li>
                        </ul>
                    </li>
            ...
            <div class="col-md-12 col-lg-4">
                <div class="card">
                    <div class="body">
                        ...
                        <a href="courses-info.html" class="btn btn-block btn-raised btn-primary btn-round waves-effect" role="button">Apply Now</a>
                    </div>
                </div>
            </div>
