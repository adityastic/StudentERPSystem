...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="../assets/images/logo.svg" width="48" height="48" alt="<?php echo $title;?>"></div>
        <p>Please wait...</p>
    </div>
</div>
...
>>>>>>> 61b4562feb0cc189e6cc0679cf38c13eaa505af8
            ...
            <!-- <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> <?php echo $title;?></a></li>
