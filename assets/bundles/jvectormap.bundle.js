! function(a) {
    ...
    a.fn.vectorMap = function(a) {
        ...
        if ("addMap" === a) jvm.Map.maps[arguments[1]] = arguments[2];
        else {
            if (("set" === a || "get" === a) && b[a][arguments[1]]) return d = arguments[1].charAt(0).toUpperCase() + arguments[1].substr(1), c[a + d].apply(c, Array.prototype.slice.call(arguments, 2));
            a = a || {}, a.container = this, c = new jvm.Map(a)
        }
        return this
    }
}(jQuery),
...
var jvm = {
    inherits: function(a, b) {
        function c() {}
        c.prototype = b.prototype, a.prototype = new c, a.prototype.constructor = a, a.parentClass = b
    },
    mixin: function(a, b) {
        var c;
    ...
    min: function(a) {
        var b, c = Number.MAX_VALUE;
        if (a instanceof Array)
            for (b = 0; b < a.length; b++) a[b] < c && (c = a[b]);
        else
            for (b in a) a[b] < c && (c = a[b]);
        return c
    },
    max: function(a) {
        var b, c = Number.MIN_VALUE;
        if (a instanceof Array)
            for (b = 0; b < a.length; b++) a[b] > c && (c = a[b]);
        else
            for (b in a) a[b] > c && (c = a[b]);
    ...
    whenImageLoaded: function(a) {
        var b = new jvm.$.Deferred,
            c = jvm.$("<img/>");
    ...
    isImageUrl: function(a) {
        return /\.\w{3,4}$/.test(a)
    }
};
jvm.$ = jQuery, Array.prototype.indexOf || (Array.prototype.indexOf = function(a, b) {
    var c;
    ...
    this.node = this.createElement(a), this.name = a, this.properties = {}, b && this.set(b)
}, jvm.AbstractElement.prototype.set = function(a, b) {
    var c;
    if ("object" == typeof a)
        for (c in a) this.properties[c] = a[c], this.applyAttr(c, a[c]);
    else this.properties[a] = b, this.applyAttr(a, b)
    ...
    this.container = a, this.setSize(b, c), this.rootElement = new jvm[this.classPrefix + "GroupElement"], this.node.appendChild(this.rootElement.node), this.container.appendChild(this.node)
}, jvm.AbstractCanvasElement.prototype.add = function(a, b) {
    b = b || this.rootElement, b.add(a), a.canvas = this
}, jvm.AbstractCanvasElement.prototype.addPath = function(a, b, c) {
    var d = new jvm[this.classPrefix + "PathElement"](a, b);
    return this.add(d, c), d
}, jvm.AbstractCanvasElement.prototype.addCircle = function(a, b, c) {
    var d = new jvm[this.classPrefix + "CircleElement"](a, b);
    return this.add(d, c), d
}, jvm.AbstractCanvasElement.prototype.addImage = function(a, b, c) {
    var d = new jvm[this.classPrefix + "ImageElement"](a, b);
    return this.add(d, c), d
}, jvm.AbstractCanvasElement.prototype.addText = function(a, b, c) {
    var d = new jvm[this.classPrefix + "TextElement"](a, b);
    return this.add(d, c), d
}, jvm.AbstractCanvasElement.prototype.addGroup = function(a) {
    var b = new jvm[this.classPrefix + "GroupElement"];
    return a ? a.node.appendChild(b.node) : this.node.appendChild(b.node), b.canvas = this, b
}, jvm.AbstractShapeElement = function(a, b, c) {
    this.style = c || {}, this.style.current = this.style.current || {}, this.isHovered = !1, this.isSelected = !1, this.updateStyle()
}, jvm.AbstractShapeElement.prototype.setStyle = function(a, b) {
    var c = {};
    "object" == typeof a ? c = a : c[a] = b, jvm.$.extend(this.style.current, c), this.updateStyle()
...
}, jvm.inherits(jvm.SVGElement, jvm.AbstractElement), jvm.SVGElement.svgns = "http://www.w3.org/2000/svg", jvm.SVGElement.prototype.createElement = function(a) {
...
}, jvm.inherits(jvm.SVGGroupElement, jvm.SVGElement), jvm.SVGGroupElement.prototype.add = function(a) {
    this.node.appendChild(a.node)
}, jvm.SVGCanvasElement = function() {
    this.classPrefix = "SVG", jvm.SVGCanvasElement.parentClass.call(this, "svg"), this.defsElement = new jvm.SVGElement("defs"), this.node.appendChild(this.defsElement.node), jvm.AbstractCanvasElement.apply(this, arguments)
}, jvm.inherits(jvm.SVGCanvasElement, jvm.SVGElement), jvm.mixin(jvm.SVGCanvasElement, jvm.AbstractCanvasElement), jvm.SVGCanvasElement.prototype.setSize = function(a, b) {
    this.width = a, this.height = b, this.node.setAttribute("width", a), this.node.setAttribute("height", b)
}, jvm.SVGCanvasElement.prototype.applyTransformParams = function(a, b, c) {
    this.scale = a, this.transX = b, this.transY = c, this.rootElement.node.setAttribute("transform", "scale(" + a + ") translate(" + b + ", " + c + ")")
}, jvm.SVGShapeElement = function(a, b) {
    jvm.SVGShapeElement.parentClass.call(this, a, b), jvm.AbstractShapeElement.apply(this, arguments)
}, jvm.inherits(jvm.SVGShapeElement, jvm.SVGElement), jvm.mixin(jvm.SVGShapeElement, jvm.AbstractShapeElement), jvm.SVGShapeElement.prototype.applyAttr = function(a, b) {
    var c, d, e = this;
    "fill" === a && jvm.isImageUrl(b) ? jvm.SVGShapeElement.images[b] ? this.applyAttr("fill", "url(#image" + jvm.SVGShapeElement.images[b] + ")") : jvm.whenImageLoaded(b).then(function(a) {
        d = new jvm.SVGElement("image"), d.node.setAttributeNS("http://www.w3.org/1999/xlink", "href", b), d.applyAttr("x", "0"), d.applyAttr("y", "0"), d.applyAttr("width", a[0].width), d.applyAttr("height", a[0].height), c = new jvm.SVGElement("pattern"), c.applyAttr("id", "image" + jvm.SVGShapeElement.imageCounter), c.applyAttr("x", 0), c.applyAttr("y", 0), c.applyAttr("width", a[0].width / 2), c.applyAttr("height", a[0].height / 2), c.applyAttr("viewBox", "0 0 " + a[0].width + " " + a[0].height), c.applyAttr("patternUnits", "userSpaceOnUse"), c.node.appendChild(d.node), e.canvas.defsElement.node.appendChild(c.node), jvm.SVGShapeElement.images[b] = jvm.SVGShapeElement.imageCounter++, e.applyAttr("fill", "url(#image" + jvm.SVGShapeElement.images[b] + ")")
    }) : jvm.SVGShapeElement.parentClass.prototype.applyAttr.apply(this, arguments)
}, jvm.SVGShapeElement.imageCounter = 1, jvm.SVGShapeElement.images = {}, jvm.SVGPathElement = function(a, b) {
    jvm.SVGPathElement.parentClass.call(this, "path", a, b), this.node.setAttribute("fill-rule", "evenodd")
}, jvm.inherits(jvm.SVGPathElement, jvm.SVGShapeElement), jvm.SVGCircleElement = function(a, b) {
    jvm.SVGCircleElement.parentClass.call(this, "circle", a, b)
}, jvm.inherits(jvm.SVGCircleElement, jvm.SVGShapeElement), jvm.SVGImageElement = function(a, b) {
    jvm.SVGImageElement.parentClass.call(this, "image", a, b)
}, jvm.inherits(jvm.SVGImageElement, jvm.SVGShapeElement), jvm.SVGImageElement.prototype.applyAttr = function(a, b) {
    var c = this;
    "image" == a ? jvm.whenImageLoaded(b).then(function(a) {
        c.node.setAttributeNS("http://www.w3.org/1999/xlink", "href", b), c.width = a[0].width, c.height = a[0].height, c.applyAttr("width", c.width), c.applyAttr("height", c.height), c.applyAttr("x", c.cx - c.width / 2), c.applyAttr("y", c.cy - c.height / 2), jvm.$(c.node).trigger("imageloaded", [a])
    }) : "cx" == a ? (this.cx = b, this.width && this.applyAttr("x", b - this.width / 2)) : "cy" == a ? (this.cy = b, this.height && this.applyAttr("y", b - this.height / 2)) : jvm.SVGImageElement.parentClass.prototype.applyAttr.apply(this, arguments)
}, jvm.SVGTextElement = function(a, b) {
    jvm.SVGTextElement.parentClass.call(this, "text", a, b)
}, jvm.inherits(jvm.SVGTextElement, jvm.SVGShapeElement), jvm.SVGTextElement.prototype.applyAttr = function(a, b) {
    "text" === a ? this.node.textContent = b : jvm.SVGTextElement.parentClass.prototype.applyAttr.apply(this, arguments)
}, jvm.VMLElement = function() {
    jvm.VMLElement.VMLInitialized || jvm.VMLElement.initializeVML(), jvm.VMLElement.parentClass.apply(this, arguments)
}, jvm.inherits(jvm.VMLElement, jvm.AbstractElement), jvm.VMLElement.VMLInitialized = !1, jvm.VMLElement.initializeVML = function() {
    try {
        document.namespaces.rvml || document.namespaces.add("rvml", "urn:schemas-microsoft-com:vml"), jvm.VMLElement.prototype.createElement = function(a) {
...
}, jvm.inherits(jvm.VMLGroupElement, jvm.VMLElement), jvm.VMLGroupElement.prototype.add = function(a) {
    this.node.appendChild(a.node)
}, jvm.VMLCanvasElement = function() {
    this.classPrefix = "VML", jvm.VMLCanvasElement.parentClass.call(this, "group"), jvm.AbstractCanvasElement.apply(this, arguments), this.node.style.position = "absolute"
}, jvm.inherits(jvm.VMLCanvasElement, jvm.VMLElement), jvm.mixin(jvm.VMLCanvasElement, jvm.AbstractCanvasElement), jvm.VMLCanvasElement.prototype.setSize = function(a, b) {
    var c, d, e, f;
    if (this.width = a, this.height = b, this.node.style.width = a + "px", this.node.style.height = b + "px", this.node.coordsize = a + " " + b, this.node.coordorigin = "0 0", this.rootElement) {
        for (c = this.rootElement.node.getElementsByTagName("shape"), e = 0, f = c.length; f > e; e++) c[e].coordsize = a + " " + b, c[e].style.width = a + "px", c[e].style.height = b + "px";
        for (d = this.node.getElementsByTagName("group"), e = 0, f = d.length; f > e; e++) d[e].coordsize = a + " " + b, d[e].style.width = a + "px", d[e].style.height = b + "px"
    }
}, jvm.VMLCanvasElement.prototype.applyTransformParams = function(a, b, c) {
    this.scale = a, this.transX = b, this.transY = c, this.rootElement.node.coordorigin = this.width - b - this.width / 100 + "," + (this.height - c - this.height / 100), this.rootElement.node.coordsize = this.width / a + "," + this.height / a
}, jvm.VMLShapeElement = function(a, b) {
    jvm.VMLShapeElement.parentClass.call(this, a, b), this.fillElement = new jvm.VMLElement("fill"), this.strokeElement = new jvm.VMLElement("stroke"), this.node.appendChild(this.fillElement.node), this.node.appendChild(this.strokeElement.node), this.node.stroked = !1, jvm.AbstractShapeElement.apply(this, arguments)
}, jvm.inherits(jvm.VMLShapeElement, jvm.VMLElement), jvm.mixin(jvm.VMLShapeElement, jvm.AbstractShapeElement), jvm.VMLShapeElement.prototype.applyAttr = function(a, b) {
    switch (a) {
        case "fill":
        ...
        case "fill-opacity":
            ...
            break;
        case "stroke":
            this.node.stroked = "none" !== b, this.node.strokecolor = b;
            break;
        case "stroke-opacity":
            this.strokeElement.node.opacity = Math.round(100 * b) + "%";
            break;
        case "stroke-width":
            this.node.stroked = 0 !== parseInt(b, 10), this.node.strokeweight = b;
            break;
        case "d":
    ...
    jvm.VMLPathElement.parentClass.call(this, "shape", a, b), this.node.coordorigin = "0 0", c.node.on = !0, c.node.matrix = "0.01,0,0,0.01,0,0", c.node.offset = "0,0", this.node.appendChild(c.node)
}, jvm.inherits(jvm.VMLPathElement, jvm.VMLShapeElement), jvm.VMLPathElement.prototype.applyAttr = function(a, b) {
    ...
    var b, c, d = 0,
        e = 0;
    return a = a.replace(/(-?\d+)e(-?\d+)/g, "0"), a.replace(/([MmLlHhVvCcSs])\s*((?:-?\d*(?:\.\d+)?\s*,?\s*)+)/g, function(a, f, g) {
        g = g.replace(/(\d)-/g, "$1,-").replace(/^\s+/g, "").replace(/\s+$/g, "").replace(/\s+/g, ",").split(","), g[0] || g.shift();
        for (var h = 0, i = g.length; i > h; h++) g[h] = Math.round(100 * g[h]);
        switch (f) {
            case "m":
...
}, jvm.inherits(jvm.VMLCircleElement, jvm.VMLShapeElement), jvm.VMLCircleElement.prototype.applyAttr = function(a, b) {
    switch (a) {
        case "r":
            this.node.style.width = 2 * b + "px", this.node.style.height = 2 * b + "px", this.applyAttr("cx", this.get("cx") || 0), this.applyAttr("cy", this.get("cy") || 0);
            break;
        case "cx":
            if (!b) return;
    ...
    return this.mode = window.SVGAngle ? "svg" : "vml", this.impl = "svg" == this.mode ? new jvm.SVGCanvasElement(a, b, c) : new jvm.VMLCanvasElement(a, b, c), this.impl.mode = this.mode, this.impl
    ...
    var a, b = [];
    for (a in this.scale) b.push({
        label: a,
        value: this.scale[a]
    });
    return b
}, jvm.NumericScale = function(a, b, c, d) {
    this.scale = [], b = b || "linear", a && this.setScale(a), b && this.setNormalizeFunction(b), void 0 !== c && this.setMin(c), void 0 !== d && this.setMax(d)
    ...
    setScale: function(a) {
        var b;
        for (this.scale = [], b = 0; b < a.length; b++) this.scale[b] = [a[b]]
    },
    ...
    getValue: function(a) {
        var b, c, d = [],
            e = 0,
            f = 0;
        for ("function" == typeof this.normalize && (a = this.normalize(a)), f = 0; f < this.scale.length - 1; f++) b = this.vectorLength(this.vectorSubtract(this.scale[f + 1], this.scale[f])), d.push(b), e += b;
        for (c = (this.maxValue - this.minValue) / e, f = 0; f < d.length; f++) d[f] *= c;
        for (f = 0, a -= this.minValue; a - d[f] >= 0;) a -= d[f], f++;
        return a = this.vectorToNum(f == this.scale.length - 1 ? this.scale[f] : this.vectorAdd(this.scale[f], this.vectorMult(this.vectorSubtract(this.scale[f + 1], this.scale[f]), a / d[f])))
    },
    vectorToNum: function(a) {
        var b, c = 0;
        for (b = 0; b < a.length; b++) c += Math.round(a[b]) * Math.pow(256, a.length - b - 1);
        return c
    },
    vectorSubtract: function(a, b) {
        var c, d = [];
        for (c = 0; c < a.length; c++) d[c] = a[c] - b[c];
        return d
    },
    ...
    vectorMult: function(a, b) {
        var c, d = [];
        for (c = 0; c < a.length; c++) d[c] = a[c] * b;
        return d
    },
    ...
    getTicks: function() {
        var a, b, c = [this.clearMinValue, this.clearMaxValue],
            d = c[1] - c[0],
            e = Math.pow(10, Math.floor(Math.log(d / 5) / Math.LN10)),
            f = 5 / d * e,
            g = [];
        for (.15 >= f ? e *= 10 : .35 >= f ? e *= 5 : .75 >= f && (e *= 2), c[0] = Math.floor(c[0] / e) * e, c[1] = Math.ceil(c[1] / e) * e, a = c[0]; a <= c[1];) b = a == c[0] ? this.clearMinValue : a == c[1] ? this.clearMaxValue : a, g.push({
            label: a,
            value: this.getValue(b)
        }), a += e;
        return g
    }
}, jvm.ColorScale = function() {
    jvm.ColorScale.parentClass.apply(this, arguments)
}, jvm.inherits(jvm.ColorScale, jvm.NumericScale), jvm.ColorScale.prototype.setScale = function(a) {
    var b;
    ...
    var b, c, d = "#";
    for (c = 0; c < a.length; c++) b = a[c].toString(16), d += 1 == b.length ? "0" + b : b;
    return d
...
}, jvm.Legend = function(a) {
    this.params = a || {}, this.map = this.params.map, this.series = this.params.series, this.body = jvm.$("<div/>"), this.body.addClass("jvectormap-legend"), this.params.cssClass && this.body.addClass(this.params.cssClass), a.vertical ? this.map.legendCntVertical.append(this.body) : this.map.legendCntHorizontal.append(this.body), this.render()
}, jvm.Legend.prototype.render = function() {
    var a, b, c, d, e = this.series.scale.getTicks(),
        f = jvm.$("<div/>").addClass("jvectormap-legend-inner");
    for (this.body.html(""), this.params.title && this.body.append(jvm.$("<div/>").addClass("jvectormap-legend-title").html(this.params.title)), this.body.append(f), a = 0; a < e.length; a++) {
        switch (b = jvm.$("<div/>").addClass("jvectormap-legend-tick"), c = jvm.$("<div/>").addClass("jvectormap-legend-tick-sample"), this.series.params.attribute) {
            case "fill":
                jvm.isImageUrl(e[a].value) ? c.css("background", "url(" + e[a].value + ")") : c.css("background", e[a].value);
                break;
            case "stroke":
                c.css("background", e[a].value);
                break;
            case "image":
                c.css("background", "url(" + e[a].value + ") no-repeat center center");
                break;
            case "r":
                jvm.$("<div/>").css({
                    "border-radius": e[a].value,
                    border: this.map.params.markerStyle.initial["stroke-width"] + "px " + this.map.params.markerStyle.initial.stroke + " solid",
                    width: 2 * e[a].value + "px",
                    height: 2 * e[a].value + "px",
                    background: this.map.params.markerStyle.initial.fill
                }).appendTo(c)
        }
        b.append(c), d = e[a].label, this.params.labelRender && (d = this.params.labelRender(d)), b.append(jvm.$("<div>" + d + " </div>").addClass("jvectormap-legend-tick-text")), f.append(b)
    }
    f.append(jvm.$("<div/>").css("clear", "both"))
}, jvm.DataSeries = function(a, b, c) {
    var d;
    a = a || {}, a.attribute = a.attribute || "fill", this.elements = b, this.params = a, this.map = c, a.attributes && this.setAttributes(a.attributes), jvm.$.isArray(a.scale) ? (d = "fill" === a.attribute || "stroke" === a.attribute ? jvm.ColorScale : jvm.NumericScale, this.scale = new d(a.scale, a.normalizeFunction, a.min, a.max)) : this.scale = a.scale ? new jvm.OrdinalScale(a.scale) : new jvm.SimpleScale(a.scale), this.values = a.values || {}, this.setValues(this.values), this.params.legend && (this.legend = new jvm.Legend($.extend({
        map: this.map,
        series: this
    }, this.params.legend)))
    ...
    setAttributes: function(a, b) {
        ...
        if ("string" == typeof a) this.elements[a] && this.elements[a].setStyle(this.params.attribute, b);
            ...
            for (c in d) this.elements[c] && this.elements[c].element.setStyle(this.params.attribute, d[c])
    },
    setValues: function(a) {
        var b, c, d = -Number.MAX_VALUE,
            e = Number.MAX_VALUE,
            f = {};
        if (this.scale instanceof jvm.OrdinalScale || this.scale instanceof jvm.SimpleScale)
            for (c in a) f[c] = a[c] ? this.scale.getValue(a[c]) : this.elements[c].element.style.initial[this.params.attribute];
        else {
            if (void 0 === this.params.min || void 0 === this.params.max)
                for (c in a) b = parseFloat(a[c]), b > d && (d = b), e > b && (e = b);
            void 0 === this.params.min ? (this.scale.setMin(e), this.params.min = e) : this.scale.setMin(this.params.min), void 0 === this.params.max ? (this.scale.setMax(d), this.params.max = d) : this.scale.setMax(this.params.max);
            for (c in a) "indexOf" != c && (b = parseFloat(a[c]), f[c] = isNaN(b) ? this.elements[c].element.style.initial[this.params.attribute] : this.scale.getValue(b))
        }
        this.setAttributes(f), jvm.$.extend(this.values, a)
    },
    clear: function() {
        var a, b = {};
        for (a in this.values) this.elements[a] && (b[a] = this.elements[a].element.shape.style.initial[this.params.attribute]);
        this.setAttributes(b), this.values = {}
    },
    setScale: function(a) {
        this.scale.setScale(a), this.values && this.setValues(this.values)
    },
    setNormalizeFunction: function(a) {
        this.scale.setNormalizeFunction(a), this.values && this.setValues(this.values)
    }
}, jvm.Proj = {
    degRad: 180 / Math.PI,
    radDeg: Math.PI / 180,
    ...
    aea: function(a, b, c) {
        var d = c * this.radDeg,
            ...
            g = a * this.radDeg,
            h = b * this.radDeg,
            i = (Math.sin(e) + Math.sin(f)) / 2,
            j = Math.cos(e) * Math.cos(e) + 2 * i * Math.sin(e),
            k = i * (h - d),
            l = Math.sqrt(j - 2 * i * Math.sin(g)) / i,
            m = Math.sqrt(j - 2 * i * Math.sin(0)) / i;
        return {
            x: l * Math.sin(k) * this.radius,
            y: -(m - l * Math.cos(k)) * this.radius
        }
    },
    aea_inv: function(a, b, c) {
        var d = a / this.radius,
            ...
            g = 29.5 * this.radDeg,
            h = 45.5 * this.radDeg,
            i = (Math.sin(g) + Math.sin(h)) / 2,
            j = Math.cos(g) * Math.cos(g) + 2 * i * Math.sin(g),
            k = Math.sqrt(j - 2 * i * Math.sin(0)) / i,
            l = Math.sqrt(d * d + (k - e) * (k - e)),
            m = Math.atan(d / (k - e));
        return {
            lat: Math.asin((j - l * l * i * i) / (2 * i)) * this.degRad,
            lng: (f + m / i) * this.degRad
        }
    },
    lcc: function(a, b, c) {
        var d = c * this.radDeg,
            ...
            g = 45 * this.radDeg,
            h = a * this.radDeg,
            i = Math.log(Math.cos(f) * (1 / Math.cos(g))) / Math.log(Math.tan(Math.PI / 4 + g / 2) * (1 / Math.tan(Math.PI / 4 + f / 2))),
            j = Math.cos(f) * Math.pow(Math.tan(Math.PI / 4 + f / 2), i) / i,
            k = j * Math.pow(1 / Math.tan(Math.PI / 4 + h / 2), i),
            l = j * Math.pow(1 / Math.tan(Math.PI / 4 + 0), i);
        return {
            x: k * Math.sin(i * (e - d)) * this.radius,
            y: -(l - k * Math.cos(i * (e - d))) * this.radius
        }
    },
    lcc_inv: function(a, b, c) {
        var d = a / this.radius,
            ...
            g = 33 * this.radDeg,
            h = 45 * this.radDeg,
            i = Math.log(Math.cos(g) * (1 / Math.cos(h))) / Math.log(Math.tan(Math.PI / 4 + h / 2) * (1 / Math.tan(Math.PI / 4 + g / 2))),
            j = Math.cos(g) * Math.pow(Math.tan(Math.PI / 4 + g / 2), i) / i,
            k = j * Math.pow(1 / Math.tan(Math.PI / 4 + 0), i),
            l = this.sgn(i) * Math.sqrt(d * d + (k - e) * (k - e)),
            m = Math.atan(d / (k - e));
        return {
            lat: (2 * Math.atan(Math.pow(j / l, 1 / i)) - Math.PI / 2) * this.degRad,
            lng: (f + m / i) * this.degRad
        }
    }
}, jvm.MapObject = function() {}, jvm.MapObject.prototype.getLabelText = function(a) {
    return this.config.label ? "function" == typeof this.config.label.render ? this.config.label.render(a) : a : null
}, jvm.MapObject.prototype.getLabelOffsets = function(a) {
    var b;
    return this.config.label && ("function" == typeof this.config.label.offsets ? b = this.config.label.offsets(a) : "object" == typeof this.config.label.offsets && (b = this.config.label.offsets[a])), b || [0, 0]
}, jvm.MapObject.prototype.setHovered = function(a) {
    this.isHovered !== a && (this.isHovered = a, this.shape.isHovered = a, this.shape.updateStyle(), this.label && (this.label.isHovered = a, this.label.updateStyle()))
}, jvm.MapObject.prototype.setSelected = function(a) {
    this.isSelected !== a && (this.isSelected = a, this.shape.isSelected = a, this.shape.updateStyle(), this.label && (this.label.isSelected = a, this.label.updateStyle()), jvm.$(this.shape).trigger("selected", [a]))
}, jvm.MapObject.prototype.setStyle = function() {
    this.shape.setStyle.apply(this.shape, arguments)
}, jvm.MapObject.prototype.remove = function() {
    this.shape.remove(), this.label && this.label.remove()
}, jvm.Region = function(a) {
    var b, c, d;
    this.config = a, this.map = this.config.map, this.shape = a.canvas.addPath({
        d: a.path,
        "data-code": a.code
    }, a.style, a.canvas.rootElement), this.shape.addClass("jvectormap-region jvectormap-element"), b = this.shape.getBBox(), c = this.getLabelText(a.code), this.config.label && c && (d = this.getLabelOffsets(a.code), this.labelX = b.x + b.width / 2 + d[0], this.labelY = b.y + b.height / 2 + d[1], this.label = a.canvas.addText({
        text: c,
        "text-anchor": "middle",
        ...
        y: this.labelY,
        "data-code": a.code
    }, a.labelStyle, a.labelsGroup), this.label.addClass("jvectormap-region jvectormap-element"))
}, jvm.inherits(jvm.Region, jvm.MapObject), jvm.Region.prototype.updateLabelPosition = function() {
    this.label && this.label.set({
        x: this.labelX * this.map.scale + this.map.transX * this.map.scale,
        y: this.labelY * this.map.scale + this.map.transY * this.map.scale
    })
}, jvm.Marker = function(a) {
    var b;
    this.config = a, this.map = this.config.map, this.isImage = !!this.config.style.initial.image, this.createShape(), b = this.getLabelText(a.index), this.config.label && b && (this.offsets = this.getLabelOffsets(a.index), this.labelX = a.cx / this.map.scale - this.map.transX, this.labelY = a.cy / this.map.scale - this.map.transY, this.label = a.canvas.addText({
        text: b,
        "data-index": a.index,
        dy: "0.6ex",
        x: this.labelX,
        y: this.labelY
    }, a.labelStyle, a.labelsGroup), this.label.addClass("jvectormap-marker jvectormap-element"))
...
}, jvm.Marker.prototype.setStyle = function(a) {
    var b;
    jvm.Marker.parentClass.prototype.setStyle.apply(this, arguments), "r" === a && this.updateLabelPosition(), (b = !!this.shape.get("image")) != this.isImage && (this.isImage = b, this.config.style = jvm.$.extend(!0, {}, this.shape.style), this.createShape())
}, jvm.Map = function(a) {
    var b, c = this;
    if (this.params = jvm.$.extend(!0, {}, jvm.Map.defaultParams, a), !jvm.Map.maps[this.params.map]) throw new Error("Attempt to use map which was not loaded: " + this.params.map);
    ...
    for (b in jvm.Map.apiEvents) this.params[b] && this.container.bind(jvm.Map.apiEvents[b] + ".jvectormap", this.params[b]);
    ...
    reset: function() {
        ...
        for (a in this.series)
            for (b = 0; b < this.series[a].length; b++) this.series[a][b].clear();
    ...
    bindContainerEvents: function() {
        ...
        this.params.panOnDrag && (this.container.mousemove(function(e) {
            return c && (d.transX -= (a - e.pageX) / d.scale, d.transY -= (b - e.pageY) / d.scale, d.applyTransform(), a = e.pageX, b = e.pageY), !1
        }).mousedown(function(d) {
            return c = !0, a = d.pageX, b = d.pageY, !1
        }), this.onContainerMouseUp = function() {
            c = !1
        }, jvm.$("body").mouseup(this.onContainerMouseUp)), this.params.zoomOnScroll && this.container.mousewheel(function(a) {
            var b = jvm.$(d.container).offset(),
                c = a.pageX - b.left,
                e = a.pageY - b.top,
                f = Math.pow(1 + d.params.zoomOnScrollSpeed / 1e3, a.deltaFactor * a.deltaY);
            d.tip.hide(), d.setScale(d.scale * f, c, e), a.preventDefault()
        })
    },
    bindContainerTouchEvents: function() {
        var a, b, c, d, e, f, g, h = this,
            i = function(i) {
                var j, k, l, m, n = i.originalEvent.touches;
                "touchstart" == i.type && (g = 0), 1 == n.length ? (1 == g && (l = h.transX, m = h.transY, h.transX -= (c - n[0].pageX) / h.scale, h.transY -= (d - n[0].pageY) / h.scale, h.applyTransform(), h.tip.hide(), (l != h.transX || m != h.transY) && i.preventDefault()), c = n[0].pageX, d = n[0].pageY) : 2 == n.length && (2 == g ? (k = Math.sqrt(Math.pow(n[0].pageX - n[1].pageX, 2) + Math.pow(n[0].pageY - n[1].pageY, 2)) / b, h.setScale(a * k, e, f), h.tip.hide(), i.preventDefault()) : (j = jvm.$(h.container).offset(), e = n[0].pageX > n[1].pageX ? n[1].pageX + (n[0].pageX - n[1].pageX) / 2 : n[0].pageX + (n[1].pageX - n[0].pageX) / 2, f = n[0].pageY > n[1].pageY ? n[1].pageY + (n[0].pageY - n[1].pageY) / 2 : n[0].pageY + (n[1].pageY - n[0].pageY) / 2, e -= j.left, f -= j.top, a = h.scale, b = Math.sqrt(Math.pow(n[0].pageX - n[1].pageX, 2) + Math.pow(n[0].pageY - n[1].pageY, 2)))), g = n.length
            };
        jvm.$(this.container).bind("touchstart", i), jvm.$(this.container).bind("touchmove", i)
    },
    bindContainerPointerEvents: function() {
        var a = this,
            ...
            c = this.container[0],
            d = function(a) {
                b.addPointer(a.pointerId)
            },
            e = function(b) {
                var c, d;
                (0 != b.translationX || 0 != b.translationY) && (c = a.transX, d = a.transY, a.transX += b.translationX / a.scale, a.transY += b.translationY / a.scale, a.applyTransform(), a.tip.hide(), (c != a.transX || d != a.transY) && b.preventDefault()), 1 != b.scale && (a.setScale(a.scale * b.scale, b.offsetX, b.offsetY), a.tip.hide(), b.preventDefault())
            };
        b.target = c, c.addEventListener("MSGestureChange", e, !1), c.addEventListener("pointerdown", d, !1)
    },
    bindElementEvents: function() {
        var a, b, c, d = this;
        this.container.mousemove(function(d) {
            Math.abs(a - d.pageX) + Math.abs(b - d.pageY) > 2 && (c = !0)
        }), this.container.delegate("[class~='jvectormap-element']", "mouseover mouseout", function(a) {
            var b = jvm.$(this).attr("class").baseVal || jvm.$(this).attr("class"),
                c = -1 === b.indexOf("jvectormap-region") ? "marker" : "region",
                e = jvm.$(this).attr("region" == c ? "data-code" : "data-index"),
                f = "region" == c ? d.regions[e].element : d.markers[e].element,
                g = "region" == c ? d.mapData.paths[e].name : d.markers[e].config.name || "",
                h = jvm.$.Event(c + "TipShow.jvectormap"),
                i = jvm.$.Event(c + "Over.jvectormap");
            "mouseover" == a.type ? (d.container.trigger(i, [e]), i.isDefaultPrevented() || f.setHovered(!0), d.tip.text(g), d.container.trigger(h, [d.tip, e]), h.isDefaultPrevented() || (d.tip.show(), d.tipWidth = d.tip.width(), d.tipHeight = d.tip.height())) : (f.setHovered(!1), d.tip.hide(), d.container.trigger(c + "Out.jvectormap", [e]))
        }), this.container.delegate("[class~='jvectormap-element']", "mousedown", function(d) {
            a = d.pageX, b = d.pageY, c = !1
        }), this.container.delegate("[class~='jvectormap-element']", "mouseup", function() {
            var a = jvm.$(this).attr("class").baseVal ? jvm.$(this).attr("class").baseVal : jvm.$(this).attr("class"),
                b = -1 === a.indexOf("jvectormap-region") ? "marker" : "region",
                e = jvm.$(this).attr("region" == b ? "data-code" : "data-index"),
                f = jvm.$.Event(b + "Click.jvectormap"),
                g = "region" == b ? d.regions[e].element : d.markers[e].element;
            c || (d.container.trigger(f, [e]), ("region" === b && d.params.regionsSelectable || "marker" === b && d.params.markersSelectable) && (f.isDefaultPrevented() || (d.params[b + "sSelectableOne"] && d.clearSelected(b + "s"), g.setSelected(!g.isSelected))))
        })
    },
    bindZoomButtons: function() {
        var a = this;
        jvm.$("<div/>").addClass("jvectormap-zoomin").text("+").appendTo(this.container), jvm.$("<div/>").addClass("jvectormap-zoomout").html("&#x2212;").appendTo(this.container), this.container.find(".jvectormap-zoomin").click(function() {
            a.setScale(a.scale * a.params.zoomStep, a.width / 2, a.height / 2, !1, a.params.zoomAnimate)
    ...
    createTip: function() {
        var a = this;
        this.tip = jvm.$("<div/>").addClass("jvectormap-tip").appendTo(jvm.$("body")), this.container.mousemove(function(b) {
            var c = b.pageX - 15 - a.tipWidth,
                d = b.pageY - 15 - a.tipHeight;
            5 > c && (c = b.pageX + 15), 5 > d && (d = b.pageY + 15), a.tip.css({
                left: c,
                top: d
            })
        })
    },
    setScale: function(a, b, c, d, e) {
        var f, g, h, i, j, k, l, m, n, o = jvm.$.Event("zoom.jvectormap"),
            p = this,
            q = 0,
            r = Math.abs(Math.round(60 * (a - this.scale) / Math.max(a, this.scale))),
            s = new jvm.$.Deferred;
        return a > this.params.zoomMax * this.baseScale ? a = this.params.zoomMax * this.baseScale : a < this.params.zoomMin * this.baseScale && (a = this.params.zoomMin * this.baseScale), void 0 !== b && void 0 !== c && (zoomStep = a / this.scale, d ? (m = b + this.defaultWidth * (this.width / (this.defaultWidth * a)) / 2, n = c + this.defaultHeight * (this.height / (this.defaultHeight * a)) / 2) : (m = this.transX - (zoomStep - 1) / a * b, n = this.transY - (zoomStep - 1) / a * c)), e && r > 0 ? (g = this.scale, h = (a - g) / r, i = this.transX * this.scale, k = this.transY * this.scale, j = (m * a - i) / r, l = (n * a - k) / r, f = setInterval(function() {
            q += 1, p.scale = g + h * q, p.transX = (i + j * q) / p.scale, p.transY = (k + l * q) / p.scale, p.applyTransform(), q == r && (clearInterval(f), p.container.trigger(o, [a / p.baseScale]), s.resolve())
        }, 10)) : (this.transX = m, this.transY = n, this.scale = a, this.applyTransform(), this.container.trigger(o, [a / this.baseScale]), s.resolve()), s
    },
    setFocus: function(a) {
        var b, c, d, e, f, g;
        if (a = a || {}, a.region ? e = [a.region] : a.regions && (e = a.regions), e) {
            for (f = 0; f < e.length; f++) this.regions[e[f]] && (c = this.regions[e[f]].element.shape.getBBox()) && (void 0 === b ? b = c : (d = {
                x: Math.min(b.x, c.x),
                y: Math.min(b.y, c.y),
                width: Math.max(b.x + b.width, c.x + c.width) - Math.min(b.x, c.x),
                height: Math.max(b.y + b.height, c.y + c.height) - Math.min(b.y, c.y)
            }, b = d));
            return this.setScale(Math.min(this.width / b.width, this.height / b.height), -(b.x + b.width / 2), -(b.y + b.height / 2), !0, a.animate)
        }
        return a.lat && a.lng ? (g = this.latLngToPoint(a.lat, a.lng), a.x = this.transX - g.x / this.scale, a.y = this.transY - g.y / this.scale) : a.x && a.y && (a.x *= -this.defaultWidth, a.y *= -this.defaultHeight), this.setScale(a.scale * this.baseScale, a.x, a.y, !0, a.animate)
    },
    ...
    setSelected: function(a, b) {
        var c;
        if ("object" != typeof b && (b = [b]), jvm.$.isArray(b))
            for (c = 0; c < b.length; c++) this[a][b[c]].element.setSelected(!0);
        else
            for (c in b) this[a][c].element.setSelected(!!b[c])
    },
    ...
    clearSelected: function(a) {
        var b, c = {},
            d = this.getSelected(a);
        for (b = 0; b < d.length; b++) c[d[b]] = !1;
        this.setSelected(a, c)
    },
    ...
    createRegions: function() {
        ...
        for (a in this.mapData.paths) b = new jvm.Region({
            map: this,
            path: this.mapData.paths[a].path,
            code: a,
        ...
        }), jvm.$(b.shape).bind("selected", function(a, b) {
            c.container.trigger("regionSelected.jvectormap", [jvm.$(this.node).attr("data-code"), b, c.getSelectedRegions()])
        }), this.regions[a] = {
            element: b,
    ...
    createMarkers: function(a) {
        ...
        if (this.markersGroup = this.markersGroup || this.canvas.addGroup(), this.markerLabelsGroup = this.markerLabelsGroup || this.canvas.addGroup(), jvm.$.isArray(a))
            for (f = a.slice(), a = {}, b = 0; b < f.length; b++) a[b] = f[b];
        for (b in a) e = a[b] instanceof Array ? {
            latLng: a[b]
        } : a[b], !1 !== (d = this.getMarkerPosition(e)) && (c = new jvm.Marker({
            map: this,
        ...
        }), jvm.$(c.shape).bind("selected", function(a, b) {
            g.container.trigger("markerSelected.jvectormap", [jvm.$(this.node).attr("data-index"), b, g.getSelectedMarkers()])
    ...
    repositionMarkers: function() {
        var a, b;
        for (a in this.markers) !1 !== (b = this.getMarkerPosition(this.markers[a].config)) && this.markers[a].element.setStyle({
            cx: b.x,
            cy: b.y
        })
    },
    repositionLabels: function() {
        var a;
        for (a in this.regions) this.regions[a].element.updateLabelPosition();
        for (a in this.markers) this.markers[a].element.updateLabelPosition()
    },
    getMarkerPosition: function(a) {
        return jvm.Map.maps[this.params.map].projection ? this.latLngToPoint.apply(this, a.latLng || [0, 0]) : {
    ...
    addMarker: function(a, b, c) {
        var d, e, f = {},
            g = [],
            c = c || [];
        for (f[a] = b, e = 0; e < c.length; e++) d = {}, void 0 !== c[e] && (d[a] = c[e]), g.push(d);
        this.addMarkers(f, g)
    },
    ...
    removeMarkers: function(a) {
        var b;
        for (b = 0; b < a.length; b++) this.markers[a[b]].element.remove(), delete this.markers[a[b]]
    },
    ...
    latLngToPoint: function(a, b) {
        var c, d, e, f = jvm.Map.maps[this.params.map].projection,
            g = f.centralMeridian;
        return -180 + g > b && (b += 360), c = jvm.Proj[f.type](a, b, g), !!(d = this.getInsetForPoint(c.x, c.y)) && (e = d.bbox, c.x = (c.x - e[0].x) / (e[1].x - e[0].x) * d.width * this.scale, c.y = (c.y - e[0].y) / (e[1].y - e[0].y) * d.height * this.scale, {
            x: c.x + this.transX * this.scale + d.left * this.scale,
            y: c.y + this.transY * this.scale + d.top * this.scale
        })
    },
    pointToLatLng: function(a, b) {
        var c, d, e, f, g, h = jvm.Map.maps[this.params.map].projection,
            i = h.centralMeridian,
            j = jvm.Map.maps[this.params.map].insets;
        for (c = 0; c < j.length; c++)
            if (d = j[c], e = d.bbox, f = a - (this.transX * this.scale + d.left * this.scale), g = b - (this.transY * this.scale + d.top * this.scale), f = f / (d.width * this.scale) * (e[1].x - e[0].x) + e[0].x, g = g / (d.height * this.scale) * (e[1].y - e[0].y) + e[0].y, f > e[0].x && f < e[1].x && g > e[0].y && g < e[1].y) return jvm.Proj[h.type + "_inv"](f, -g, i);
        return !1
    },
    getInsetForPoint: function(a, b) {
        var c, d, e = jvm.Map.maps[this.params.map].insets;
        for (c = 0; c < e.length; c++)
            if (d = e[c].bbox, a > d[0].x && a < d[1].x && b > d[0].y && b < d[1].y) return e[c]
    },
    createSeries: function() {
        ...
        for (b in this.params.series)
            for (a = 0; a < this.params.series[b].length; a++) this.series[b][a] = new jvm.DataSeries(this.params.series[b][a], this[b], this)
    },
    remove: function() {
...
}, jvm.MultiMap = function(a) {
    var b = this;
    this.maps = {}, this.params = jvm.$.extend(!0, {}, jvm.MultiMap.defaultParams, a), this.params.maxLevel = this.params.maxLevel || Number.MAX_VALUE, this.params.main = this.params.main || {}, this.params.main.multiMapLevel = 0, this.history = [this.addMap(this.params.main.map, this.params.main)], this.defaultProjection = this.history[0].mapData.projection.type, this.mapsLoaded = {}, this.params.container.css({
        position: "relative"
    ...
    addMap: function(a, b) {
        ...
        return this.params.container.append(c), this.maps[a] = new jvm.Map(jvm.$.extend(b, {
            container: c
        })), this.params.maxLevel > b.multiMapLevel && this.maps[a].container.on("regionClick.jvectormap", {
            scope: this
        }, function(a, b) {
            var c = a.data.scope,
                d = c.params.mapNameByCode(b, c);
            c.drillDownPromise && "pending" === c.drillDownPromise.state() || c.drillDown(d, b)
        }), this.maps[a]
    },
    downloadMap: function(a) {
        var b = this,
            c = jvm.$.Deferred();
        return this.mapsLoaded[a] ? c.resolve() : jvm.$.get(this.params.mapUrlByCode(a, this)).then(function() {
            b.mapsLoaded[a] = !0, c.resolve()
        }, function() {
            c.reject()
        }), c
    },
    drillDown: function(a, b) {
        var c = this.history[this.history.length - 1],
            ...
            f = this.downloadMap(b);
        e.then(function() {
            "pending" === f.state() && d.spinner.show()
        }), f.always(function() {
            d.spinner.hide()
        }), this.drillDownPromise = jvm.$.when(f, e), this.drillDownPromise.then(function() {
            c.params.container.hide(), d.maps[a] ? d.maps[a].params.container.show() : d.addMap(a, {
                map: a,
                multiMapLevel: c.params.multiMapLevel + 1
            }), d.history.push(d.maps[a]), d.backButton.show()
        })
    },
    goBack: function() {
        var a = this.history.pop(),
            b = this.history[this.history.length - 1],
            c = this;
        a.setFocus({
            scale: 1,
            x: .5,
            ...
            a.params.container.hide(), b.params.container.show(), b.updateSize(), 1 === c.history.length && c.backButton.hide(), b.setFocus({
                scale: 1,
                x: .5,
                y: .5,
                animate: !0
    ...
    mapNameByCode: function(a, b) {
        return a.toLowerCase() + "_" + b.defaultProjection + "_en"
    },
    mapUrlByCode: function(a, b) {
        return "jquery-jvectormap-data-" + a.toLowerCase() + "-" + b.defaultProjection + "-en.js"
    }
