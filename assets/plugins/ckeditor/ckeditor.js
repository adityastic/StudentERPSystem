    ...
    window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function() {
        ...
        return {
            ...
            on: function(b, d, e, m, f) {
                ...
                if (0 > g.getListenerIndex(d)) {
                    ...
                    for (var v = g.length - 1; 0 <= v; v--)
                        if (g[v].priority <= f) return g.splice(v + 1, 0, h), {
                            removeListener: l
                        };
                    g.unshift(h)
                }
            ...
            fire: function() {
                ...
                return function(f, h, l) {
                    ...
                    if (g) {
                        var v = g.listeners;
                        if (v.length)
                            for (var v = v.slice(0), u, q = 0; q < v.length; q++) {
                                if (g.errorProof) try {
                                    u = v[q].call(this, l, h, b, m)
                                } catch (t) {} else u = v[q].call(this, l, h, b, m);
                                !1 === u ? k = 1 : "undefined" != typeof u && (h = u);
                                if (a || k) break
                            }
                    }
                    h = k ? !1 : "undefined" == typeof h ? !0 : h;
                    a = f;
                    k = n;
                    return h
                }
            }(),
            fireOnce: function(a, b, k) {
                b = this.fire(a, b, k);
                delete e(this)[a];
                return b
            },
            removeListener: function(a, b) {
                var k = e(this)[a];
                if (k) {
                    var m = k.getListenerIndex(b);
                    0 <= m && k.listeners.splice(m, 1)
                }
            },
        ...
        CKEDITOR.tools = {
            ...
            clone: function(a) {
                ...
                if (a && a instanceof Array) {
                    g = [];
                    for (var f = 0; f < a.length; f++) g[f] = CKEDITOR.tools.clone(a[f]);
                    return g
                }
                ...
                g = new a.constructor;
                for (f in a) g[f] = CKEDITOR.tools.clone(a[f]);
                return g
            },
            ...
            extend: function(a) {
                var g = arguments.length,
                    f, b;
                "boolean" == typeof(f = arguments[g - 1]) ? g-- : "boolean" == typeof(f = arguments[g - 2]) && (b = arguments[g - 1], g -= 2);
                for (var h = 1; h < g; h++) {
                    var c = arguments[h],
                        d;
                    for (d in c)
            ...
            cssVendorPrefix: function(a, g, f) {
                if (f) return e + a + ":" + g + ";" + a + ":" + g;
                f = {};
                f[a] = g;
                f[e + a] = g;
                return f
            ...
            htmlEncodeAttr: function(a) {
                return CKEDITOR.tools.htmlEncode(a).replace(k, "\x26quot;")
            },
            ...
            transformPlainTextToHtml: function(a, g) {
                ...
                b = b.replace(/\n/g, "\x3cbr\x3e");
                f || (b = b.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + h + "\x3e)"), function(a) {
            ...
            search: function(a, g) {
                var f = CKEDITOR.tools.indexOf(a, g);
                return 0 <= f ? a[f] : null
            },
            bind: function(a, g) {
                return function() {
            ...
            createClass: function(a) {
                ...
                if (b) var c = g,
                    g = function() {
                        ...
                        for (g in b) {
                            var f = b[g];
                            a[g] = "function" == typeof f ? CKEDITOR.tools.bind(f, this) : f
                        }
            ...
            convertRgbToHex: function(a) {
                return a.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi, function(a, f, b, h) {
                    a = [f, b, h];
                    for (f = 0; 3 > f; f++) a[f] = ("0" + parseInt(a[f], 10).toString(16)).slice(-2);
                    return "#" + a.join("")
                })
            },
            ...
            parseCssText: function(a, g, f) {
                ...
                if (!a || ";" == a) return b;
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, f, h) {
                    g && (f = f.toLowerCase(), "font-family" == f && (h = h.replace(/\s*,\s*/g, ",")), h = CKEDITOR.tools.trim(h));
                    b[f] = h
                });
                return b
            },
            ...
            convertArrayToObject: function(a, g) {
                ...
                for (var b = 0, h = a.length; b < h; ++b) f[a[b]] = g;
                return f
            },
            fixDomain: function() {
                for (var a;;) try {
            ...
            getCookie: function(a) {
                a = a.toLowerCase();
                for (var g = document.cookie.split(";"), f, b, h = 0; h < g.length; h++)
            ...
            getCsrfToken: function() {
                ...
                if (!a || 40 != a.length) {
                    ...
                    for (f = 0; f < a.length; f++) var b = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[f] % 36),
        ...
        getIndex: function(a) {
            ...
            do a && c != this.$ && c.nodeType == CKEDITOR.NODE_TEXT && (k || b(c)) || (d++, k = c.nodeType == CKEDITOR.NODE_TEXT); while (c = c.previousSibling);
            return d
        },
        ...
        getByAddress: function(a, e) {
            for (var b = this.$.documentElement, c = 0; b && c < a.length; c++) {
                var d = a[c];
                if (e)
                    for (var k = -1, m = 0; m < b.childNodes.length; m++) {
        ...
        var d = e.getCustomData("list_marker_id") || e.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"),
            k = e.getCustomData("list_marker_names") || e.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
        a[d] = e;
        k[b] = 1;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeClass: d ? function(a) {
                ...
                b && a(b, f) && ((b = b.replace(new RegExp("(?:^|\\s+)" + f + "(?\x3d\\s|$)"), "").replace(/^\s+/, "")) ? this.setAttribute("class", b) : this.removeAttribute("class"));
                return this
            },
            hasClass: function(f) {
            ...
            hasAttribute: function() {
                function a(b) {
                    var f = this.$.attributes.getNamedItem(b);
            ...
            mergeSiblings: function() {
                function a(b, f, g) {
                    if (f && f.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (b.isIdentical(f)) {
                            for (var d = g ? b.getLast() : b.getFirst(); c.length;) c.shift().move(b, !g);
                            f.moveChildren(b, !g);
                            f.remove();
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version : 1)) {
                    var k = this.$.getBoundingClientRect(),
                        ...
                        y = !0;
                    CKEDITOR.env.ie && (y = g.getDocumentElement().contains(this), g = g.getBody().contains(this), y = e && g || !e && y);
                    y && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || m.scrollLeft, c = d.$.scrollTop || m.scrollTop) : (c = e ? d.$ : m, b = c.scrollLeft, c = c.scrollTop), b = k.left + b - p, c = k.top + c - t)
                } else
                    for (t = this, p = null; t && "body" != t.getName() && "html" != t.getName();) {
                        b += t.$.offsetLeft - t.$.scrollLeft;
                        c += t.$.offsetTop - t.$.scrollTop;
                        t.equals(this) || (b += t.$.clientLeft || 0, c += t.$.clientTop || 0);
                        for (; p && !p.equals(t);) b -= p.$.scrollLeft, c -= p.$.scrollTop, p = p.getParent();
                        p = t;
                        t = (k = t.$.offsetParent) ? new CKEDITOR.dom.element(k) : null
                    }
                a && (k = this.getWindow(), t = a.getWindow(), !k.equals(t) && k.$.frameElement && (a = (new CKEDITOR.dom.element(k.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                e = a.getDocument();
                var y = "BackCompat" == e.$.compatMode;
                a instanceof CKEDITOR.dom.window && (a = y ? e.getBody() : e.getDocumentElement());
                e = a.getWindow();
                d = t(this, e);
                var A = t(a, e),
                    z = this.$.offsetHeight;
                ...
                var r = a.$.clientHeight,
                    w = a.$.clientWidth;
                e = d.x - p(this, "left") - A.x || 0;
                k = d.y - p(this, "top") - A.y || 0;
                g = d.x + g + p(this, "right") - (A.x + w) || 0;
                d = d.y + z + p(this, "bottom") - (A.y + r) || 0;
                (0 > k || 0 < d) && m(0, !0 === b ? k : !1 === b ? d : 0 > k ? k : d);
        ...
        function a(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                var m = c.type == CKEDITOR.NODE_ELEMENT ? c : c.getParent(),
                    B = c.type == CKEDITOR.NODE_ELEMENT ? c.getChild(l) : c.getNext();
            ...
            if (a && !this._.guardRTL) {
                var D = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    F = d.type == CKEDITOR.NODE_ELEMENT ? f ? d.getChild(f - 1) : null : d.getPrevious();
            ...
            this.current ? c = this.current[k](!1, n, h) : (a ? c.type == CKEDITOR.NODE_ELEMENT && (c = 0 < l ? c.getChild(l - 1) : !1 === h(c, !0) ? null : c.getPreviousSourceNode(!0, n, h)) : (c = d, c.type == CKEDITOR.NODE_ELEMENT && ((c = c.getChild(f)) || (c = !1 === h(d, !0) ? null : d.getNextSourceNode(!0, n, h)))), c && !1 === h(c) && (c = null));
            for (; c && !this._.end;) {
                this.current = c;
        ...
        function e(a, b, c, d, f) {
            function l(a, b, g, c) {
                ...
                if (c && k) return d;
                r || c ? b.append(a.clone(!0, f), g) : (a.remove(), m && b.append(a));
                return d
            }

            function h() {
                var a, b, g, c = Math.min(N.length, H.length);
                for (a = 0; a < c; a++)
                    if (b = N[a], g = H[a], !b.equals(g)) return a;
                return a - 1
            }
            ...
            var w = a.startContainer,
                ...
                B = a.endOffset,
                D, F, E, I, G, L;
            if (r && C.type == CKEDITOR.NODE_TEXT && w.equals(C)) w = a.document.createText(w.substring(x, B)), c.append(w);
            else {
                C.type == CKEDITOR.NODE_TEXT ? r ? L = !0 : C = C.split(B) : 0 < C.getChildCount() ? B >= C.getChildCount() ? (C = C.getChild(B - 1), F = !0) : C = C.getChild(B) : I = F = !0;
                w.type == CKEDITOR.NODE_TEXT ? r ? G = !0 : w.split(x) : 0 < w.getChildCount() ? 0 === x ? (w = w.getChild(x), D = !0) : w = w.getChild(x - 1) : E = D = !0;
                for (var N = w.getParents(), H = C.getParents(), R = h(), P = N.length - 1, T = H.length - 1, O = c, J, ca, W, U = -1, K = R; K <= P; K++) {
                    ca = N[K];
                    W = ca.getNext();
                    for (K != P || ca.equals(H[K]) && P < T ? b && (J = O.append(ca.clone(0, f))) : D ? l(ca, O, !1, E) : G && O.append(a.document.createText(ca.substring(x))); W;) {
                        if (W.equals(H[K])) {
                            U = K;
                            break
                        }
                ...
                O = c;
                for (K = R; K <= T; K++)
                    if (c = H[K], W = c.getPrevious(), c.equals(N[K])) b && (O = O.getChild(0));
                    else {
                        K != T || c.equals(N[K]) && T < P ? b && (J = O.append(c.clone(0, f))) : F ? l(c, O, !1, I) : L && O.append(a.document.createText(c.substring(0, B)));
                        if (K > U)
                            for (; W;) W = l(W, O, !0);
                        O = J
                    }
        ...
        function b() {
            ...
            return function(f) {
                return c(f) || b(f) ? !0 : d(f) && !a ? a = !0 : f.type == CKEDITOR.NODE_TEXT && (f.hasAscendant("pre") || CKEDITOR.tools.trim(f.getText()).length) || f.type == CKEDITOR.NODE_ELEMENT && !f.is(k) ? !1 : !0
            }
        }
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark: function(a) {
                var b, c, d, f, l = this.collapsed;
                b = this.document.createElement("span");
                b.data("cke-bookmark", 1);
                b.setStyle("display", "none");
                b.setHtml("\x26nbsp;");
                a && (d = "cke_bm_" + CKEDITOR.tools.getNextNumber(), b.setAttribute("id", d + (l ? "C" : "S")));
                l || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), f = this.clone(), f.collapse(), f.insertNode(c));
                f = this.clone();
                f.collapse(!0);
                f.insertNode(b);
                c ? (this.setStartAfter(b), this.setEndBefore(c)) : this.moveToPosition(b, CKEDITOR.POSITION_AFTER_END);
                return {
                    startNode: a ? d + (l ? "C" : "S") : b,
                    endNode: a ? d + "E" : c,
                    serializable: a,
                    collapsed: l
                }
            ...
            createBookmark2: function() {
                function a(b) {
                    ...
                    f = g;
                    var l = d;
                    f = f.type != CKEDITOR.NODE_ELEMENT || 0 === l || l == f.getChildCount() ? 0 : f.getChild(l - 1).type == CKEDITOR.NODE_TEXT && f.getChild(l).type == CKEDITOR.NODE_TEXT;
                    f && (g = g.getChild(d - 1), d = g.getLength());
                    if (g.type == CKEDITOR.NODE_ELEMENT && 0 < d) {
                        a: {
                            for (f = g; d--;)
                                if (l = f.getChild(d).getIndex(!0), 0 <= l) {
                                    d = l;
                                    break a
                                }
                            d = -1
                    ...
                    if (g.type == CKEDITOR.NODE_TEXT) {
                        f = g;
                        for (l = 0;
                            (f = f.getPrevious()) && f.type == CKEDITOR.NODE_TEXT;) l += f.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length;
                        f = l;
                        g.getText() ? d += f : (l = g.getPrevious(c), f ? (d = f, g = l ? l.getNext() : g.getParent().getFirst()) : (g = g.getParent(), d = l ? l.getIndex(!0) + 1 : 0))
                    }
                    b.container = g;
                    b.offset = d
                }
                ...
                return function(c) {
                    ...
                    c && (a(f), b(f, this.root), d || (a(l), b(l, this.root)));
                    return {
                        start: f.container.getAddress(c),
                        end: d ? null : l.container.getAddress(c),
                    ...
                    if (d)
                        if (d >= c.getLength()) d = c.getIndex() + 1, c = c.getParent();
                            ...
                            var l = c.split(d),
                                d = c.getIndex() + 1,
                                c = c.getParent();
                            this.startContainer.equals(this.endContainer) ? this.setEnd(l, this.endOffset - this.startOffset) : c.equals(this.endContainer) && (this.endOffset += 1)
                        }
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        B.type == CKEDITOR.NODE_TEXT ? (F && (B = !CKEDITOR.tools.trim(B.substring(0, F)).length && B, x = !!B), B && ((w = B.getPrevious()) || (r = B.getParent()))) : (F && (w = B.getChild(F - 1) || B.getLast()), w || (r = B));
                        for (r = c(r); r || w;) {
                            if (r && !w) {
                                !C && r.equals(h) && (C = !0);
                                if (f ? r.isBlockBoundary() : !e.contains(r)) break;
                                x && "inline" == r.getComputedStyle("display") || (x = !1, C ? k = r : this.setStartBefore(r));
                                w = r.getPrevious()
                            }
                            for (; w;)
                                if (B = !1, w.type == CKEDITOR.NODE_COMMENT) w = w.getPrevious();
                                else {
                                    if (w.type == CKEDITOR.NODE_TEXT) D = w.getText(), d.test(D) && (w = null), B = /[\s\ufeff]$/.test(D);
                                    else if ((w.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && w.is("br")) && !w.data("cke-bookmark"))
                                        if (x && CKEDITOR.dtd.$removeEmpty[w.getName()]) {
                                            D = w.getText();
                                            if (d.test(D)) w = null;
                                            else
                                                for (var F = w.$.getElementsByTagName("*"), E = 0, I; I = F[E++];)
                                    ...
                                    B && (x ? C ? k = r : r && this.setStartBefore(r) : x = !0);
                                    if (w) {
                                        B = w.getPrevious();
                                        if (!r && !B) {
                                            r = w;
                        ...
                        r = w = null;
                        C = x = !1;
                        B.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(B.substring(F)).length ? x = !0 : (x = !B.getLength(), F == B.getLength() ? (w = B.getNext()) || (r = B.getParent()) : l(B, F) && (r = B.getParent())) : (w = B.getChild(F)) || (r = B);
                        for (; r || w;) {
                            if (r && !w) {
                                !C && r.equals(h) && (C = !0);
                                if (f ? r.isBlockBoundary() : !e.contains(r)) break;
                                x && "inline" == r.getComputedStyle("display") || (x = !1, C ? m = r : r && this.setEndAfter(r));
                                w = r.getNext()
                            }
                            for (; w;) {
                                B = !1;
                                if (w.type == CKEDITOR.NODE_TEXT) D = w.getText(), l(w, 0) || (w = null), B = /^[\s\ufeff]/.test(D);
                                    ...
                                    if ((0 < w.$.offsetWidth || b && w.is("br")) && !w.data("cke-bookmark"))
                                        if (x && CKEDITOR.dtd.$removeEmpty[w.getName()]) {
                                            ...
                                            if (d.test(D)) w = null;
                                                ...
                                                for (F = w.$.getElementsByTagName("*"), E = 0; I = F[E++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                                                        w = null;
                                                        break
                                                    }
                        ...
                        k && m && (h = k.contains(m) ? m : k, this.setStartBefore(h), this.setEndAfter(h));
                        break;
                    case CKEDITOR.ENLARGE_BLOCK_CONTENTS:
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        r = new CKEDITOR.dom.range(this.root);
                        e = this.root;
                        r.setStartAt(e, CKEDITOR.POSITION_AFTER_START);
                        r.setEnd(this.startContainer, this.startOffset);
                        r = new CKEDITOR.dom.walker(r);
                        var G, L, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                                br: 1
                            } : null),
                            H = null,
                            R = function(a) {
                        ...
                        r = r.lastBackward();
                        G = G || e;
                        this.setStartAt(G, !G.is("br") && (!r && this.checkStartOfBlock() || r && G.contains(r)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            r = this.clone();
                            r = new CKEDITOR.dom.walker(r);
                            var P = CKEDITOR.dom.walker.whitespaces(),
                                T = CKEDITOR.dom.walker.bookmark();
                            r.evaluator = function(a) {
                                return !P(a) && !T(a)
                            };
                            if ((r = r.previous()) && r.type == CKEDITOR.NODE_ELEMENT && r.is("br")) break
                        }
                        r = this.clone();
                        r.collapse();
                        r.setEndAt(e, CKEDITOR.POSITION_BEFORE_END);
                        r = new CKEDITOR.dom.walker(r);
                        r.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : R;
                        G = H = L = null;
                        r = r.lastForward();
                        G = G || e;
                        this.setEndAt(G, !r && this.checkEndOfBlock() || r && G.contains(r) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    var d = this.clone(),
                        ...
                        k = 1,
                        m = 1;
                    f && f.type == CKEDITOR.NODE_TEXT && (h ? h >= f.getLength() ? d.setStartAfter(f) : (d.setStartBefore(f), k = 0) : d.setStartBefore(f));
                    l && l.type == CKEDITOR.NODE_TEXT && (e ? e >= l.getLength() ? d.setEndAfter(l) : (d.setEndAfter(l), m = 0) : d.setEndBefore(l));
                    ...
                    d.guard = function(b, d) {
                        if (r(b)) return !0;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(w) || !1 === c && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return !1;
                        d || b.type != CKEDITOR.NODE_ELEMENT || (w = b);
                        return !0
                    };
                    k && (f = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(f, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
            ...
            splitBlock: function(a, b) {
                ...
                "br" != a && (f || (f = this.fixBlock(!0, a), l = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), l || (l = this.fixBlock(!1, a)));
                c = f && this.checkStartOfBlock();
                d = l && this.checkEndOfBlock();
                this.deleteContents();
                f && f.equals(l) && (d ? (h = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(l, CKEDITOR.POSITION_AFTER_END), l = null) : c ? (h = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f = null) : (l = this.splitElement(f, b || !1), f.is("ul", "ol") || f.appendBogus()));
                return {
                    previousBlock: f,
                    nextBlock: l,
                    wasStartOfBlock: c,
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                return function(b) {
                    for (var c = this.createBookmark(),
                            d = this[b ? "endPath" : "startPath"](), f = d.block || d.blockLimit, l; f && !f.equals(d.root) && !f.getFirst(a(f));) l = f.getParent(), this[b ? "setEndAt" : "setStartAt"](f, CKEDITOR.POSITION_AFTER_END), f.remove(1), f = l;
                    this.moveToBookmark(c)
                }
            }(),
            startPath: function() {
            ...
            moveToElementEditablePosition: function(a, b) {
                ...
                for (var c = 0; a;) {
                    ...
                    var d = a,
                        h = c,
                        e = void 0;
                    d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (e = d[b ? "getLast" : "getFirst"](l));
                    h || e || (e = d[b ? "getPrevious" : "getNext"](l));
                    a = e
                }
                return !!c
            },
            moveToClosestEditablePosition: function(a, b) {
                var c, d = 0,
                    f, l, h = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
        ...
        function b(a, c, d, f) {
            ...
            if (!f) return 0;
            if ((h = CKEDITOR.filter.instances[f.element.data("cke-filter")]) && !h.check(c)) return b(a, c, d, f.remaining);c = new CKEDITOR.dom.range(f.element);c.selectNodeContents(f.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = h;a._.nestedEditable = {
                element: f.element,
                container: d,
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (!this._.started) {
                    ...
                    e = t.startPath();
                    var p = t.endPath(),
                        y = !t.collapsed && c(t, e.block),
                        A = !t.collapsed && c(t, p.block, 1);
                    t.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    y && t.setStartAt(e.block, CKEDITOR.POSITION_BEFORE_END);
                    A && t.setEndAt(p.block, CKEDITOR.POSITION_AFTER_START);
                ...
                for (this._.nextNode = null; p;) {
                    var y = 0,
                        ...
                        z = p.type != CKEDITOR.NODE_ELEMENT,
                        r = 0;
                    if (z) p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (z = 0);
                    else {
                        var w = p.getName();
                        if (CKEDITOR.dtd.$block[w] && "false" == p.getAttribute("contenteditable")) {
                            g = p;
                            b(this, a, g);
                            break
                            ...
                            if ("br" == w) z = 1;
                            else if (!e && !p.getChildCount() && "hr" != w) {
                                g = p;
                                m = p.equals(t);
                                break
                            }
                            e && (e.setEndAt(p, CKEDITOR.POSITION_BEFORE_START), "br" != w && (this._.nextNode = p));
                            y = 1
                        } else {
                            if (p.getFirst()) {
                    ...
                    if (e && !y)
                        for (; !p.getNext(f) && !m;) {
                            w = p.getParent();
                            if (w.isBlockBoundary(this.forceBrBreak && !A && {
                                    br: 1
                                })) {
                                y = 1;
                                z = 0;
                    ...
                    z && e.setEndAt(p, CKEDITOR.POSITION_AFTER_END);
                    p = this._getNextSourceNode(p, r, t);
                    if ((m = !p) || y && e) break
                }
                if (!g) {
                    ...
                    g = g.block;
                    !g && p && !this.enforceRealBlocks && y[p.getName()] && e.checkStartOfBlock() && e.checkEndOfBlock() && !p.equals(e.root) ? g = p : !g || this.enforceRealBlocks && g.is(h) ? (g = this.range.document.createElement(a), e.extractContents().appendTo(g), g.trim(), e.insertNode(g), u = q = !0) : "li" != g.getName() ? e.checkStartOfBlock() && e.checkEndOfBlock() || (g = g.clone(!1), e.extractContents().appendTo(g), g.trim(), q = e.splitBlock(), u = !q.wasStartOfBlock, q = !q.wasEndOfBlock, e.insertNode(g)) : m || (this._.nextNode = g.equals(t) ? null : this._getNextSourceNode(e.getBoundaryNodes().endNode, 1, t))
                }
                ...
                q && (u = g.getLast()) && u.type == CKEDITOR.NODE_ELEMENT && "br" == u.getName() && (!CKEDITOR.env.needsBrFiller || u.getPrevious(k) || u.getNext(k)) && u.remove();
        ...
        function a(a, b, c, d, f) {
            ...
            for (g in b) {
                ...
                "$" != g.charAt(0) && (e.elements = g);
                c && (e.featureName = c.toLowerCase());
                var l = e;
                l.elements = m(l.elements, /\s+/) || null;
                ...
                for (k in L) {
                    ...
                    var r = l,
                        ...
                        n = void 0;
                    t ? C = !1 : t = {};
                    for (n in z) "!" == n.charAt(0) && (n = n.slice(1), p.push(n), t[n] = !0, C = !1);
                    for (; n = p.pop();) z[n] = z["!" + n], delete z["!" + n];
                    r[w] = (C ? !1 : t) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                g = E(a[c]);
                e = !0 === g.classes || !0 === g.styles || !0 === g.attributes;
                l = g;
                k = w = h = void 0;
                for (h in L) l[h] = y(l[h]);
                r = !0;
                for (k in N) {
                    h = N[k];
                    w = l[h];
                    t = [];
                    z = void 0;
                    for (z in w) - 1 < z.indexOf("*") ? t.push(new RegExp("^" + z.replace(/\*/g, ".*") + "$")) : t.push(z);
                    w = t;
                    w.length && (l[h] = w, r = !1)
                }
                l.nothingRequired = r;
                l.noProperties = !(l.attributes || l.classes || l.styles);
                if (!0 === g.elements || null === g.elements) f[e ? "unshift" : "push"](g);
                else
                    for (H in l = g.elements, delete g.elements, l)
                        if (b[H]) b[H][e ? "unshift" : "push"](g);
                        else b[H] = [g]
            }
        }
                    ...
                    if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
                        ...
                        if (a)
                            if (!0 === a) a = !0;
                                ...
                                for (var e = 0, l = c.length, h; e < l; ++e) h = c[e], g[h] || (g[h] = a(h));
                                a = !1
                            }
                        else a = !1;
                        d.allClasses = a
        ...
        function g(a) {
            var b, c, d, f, g = {},
                e = 1;
            for (a = I(a); b = a.match(H);)(c = b[2]) ? (d = n(c, "styles"), f = n(c, "attrs"), c = n(c, "classes")) : d = f = c = null, g["$" + e++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: f
        ...
        function u(a, b, d, f) {
            var g = 0,
                l;
            f.toHtml && (b.name = b.name.replace(P, "$1"));
            if (f.doCallbacks && a.elementCallbacks) {
                a: {
                    l = a.elementCallbacks;
                    for (var h = 0, k = l.length, r; h < k; ++h)
                        if (r = l[h](b)) {
                            l = r;
                            break a
                        }
            ...
            if (f.doTransform && (l = a._.transformations[b.name])) {
                v(b);
                for (h = 0; h < l.length; ++h) w(a, b, l[h]);
                t(b)
            }
            if (f.doFilter) {
                a: {
                    h = b.name;k = a._;a = k.allowedRules.elements[h];l = k.allowedRules.generic;h = k.disallowedRules.elements[h];k = k.disallowedRules.generic;r = f.skipRequired;
                    var m = {
                            valid: !1,
                            validAttributes: {},
                            validClasses: {},
                    ...
                    if (a || l) {
                        v(b);
                        if (h)
                            for (z = 0, C = h.length; z < C; ++z)
                                if (!1 === c(h[z], b, m)) {
                                    a = null;
                                    break a
                                }
                        if (k)
                            for (z = 0, C = k.length; z < C; ++z) c(k[z], b, m);
                        if (a)
                            for (z = 0, C = a.length; z < C; ++z) e(a[z], b, m, r);
                        if (l)
                            for (z = 0, C = l.length; z < C; ++z) e(l[z], b, m, r);
                        a = m
                    } else a = null
                }
                if (!a || !a.valid) return d.push(b), 1;C = a.validAttributes;
                var n = a.validStyles;l = a.validClasses;
                var h = b.attributes,
                    y = b.styles,
                    k = b.classes;r = b.classBackup;
                var H = b.styleBackup,
                    q, x, N = [],
                    m = [],
                    A = /^data-cke-/;z = !1;delete h.style;delete h["class"];delete b.classBackup;delete b.styleBackup;
                if (!a.allAttributes)
                    for (q in h) C[q] || (A.test(q) ? q == (x = q.replace(/^data-cke-saved-/, "")) || C[x] || (delete h[q], z = !0) : (delete h[q], z = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (q in y) a.allStyles || n[q] ? N.push(q + ":" + y[q]) : z = !0;
                    N.length && (h.style = N.sort().join("; "))
                } else H && (h.style = H);
                if (!a.allClasses || a.hadInvalidClass) {
                    for (q = 0; q < k.length; ++q)(a.allClasses || l[k[q]]) && m.push(k[q]);
                    m.length && (h["class"] = m.sort().join(" "));
                    r && m.length < r.split(/\s+/).length && (z = !0)
                } else r && (h["class"] = r);z && (g = 1);
                if (!f.skipFinalValidation && !p(b)) return d.push(b), 1
            }
            f.toHtml && (b.name = b.name.replace(T, "cke:$1"));
            return g
        }
        ...
        function r(a, b, c) {
            ...
            if (F.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(A()) : (a.parent && c.push({
                ...
                if ("br" == b) a.previous && !z(a.previous) && (b = A(), b.insertBefore(a)), a.next && !z(a.next) && (b = A(), b.insertAfter(a)), a.replaceWithChildren();
                else {
                    var d = a.children,
                        f;
                    b: {
                        f = F[b];
                        for (var g = 0, l = d.length, e; g < l; ++g)
                    ...
                    if (f) a.name = b, a.attributes = {}, c.push({
                        ...
                        f = a.parent;
                        for (var g = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == f.name, h, k, l = d.length; 0 < l;) e = d[--l], g && (e.type == CKEDITOR.NODE_TEXT || e.type == CKEDITOR.NODE_ELEMENT && F.$inline[e.name]) ? (h || (h = new CKEDITOR.htmlParser.element(b), h.insertAfter(a), c.push({
                            check: "parent-down",
                            el: h
                        })), h.add(e, 0)) : (h = null, k = F[f.name] || F.span, e.insertAfter(a), f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || e.type != CKEDITOR.NODE_ELEMENT || k[e.name] || c.push({
                            check: "el-up",
                            el: e
                        }));
                        a.remove()
        ...
        function C(a, b) {
            ...
            for (g in d)
                if ("class" == g)
                    for (c = d[g].split(/\s+/), l = a.classes.join("|"); h = c.pop();) {
                        if (-1 == l.indexOf(h)) return !1
        ...
        CKEDITOR.filter = function(a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                !0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(G[a.enterMode] + " " + G[a.shiftEnterMode], "default", 1), this.disallow(a.config.disallowedContent))
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                        ...
                        a: {
                            ...
                            if (e)
                                for (m = 0; m < e.length; ++m)
                                    if ((w = d.match(e[m])) && w[0].length == d.length) {
                                        c = !0;
                                        break a
                                    }
                ...
                for (var w; c = g.pop();) c.type == CKEDITOR.NODE_ELEMENT ? r(c, d, a) : c.remove();
                for (; m = a.pop();)
                    if (c = m.el, c.parent) switch (w = F[c.parent.name] || F.span, m.check) {
                        case "it":
                            F.$removeEmpty[c.name] && !c.children.length ? r(c, d, a) : p(c) || r(c, d, a);
                            break;
                        case "el-up":
                            c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || w[c.name] || r(c, d, a);
                            break;
                        case "parent-down":
                            c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || w[c.name] || r(c.parent, d, a)
                    }
                return h
            },
            ...
            addContentForms: function(a) {
                if (!this.disabled && a) {
                    ...
                    if (f) {
                        for (b = 0; b < a.length; ++b) d.push(x(a[b], f));
                ...
                if (!this.disabled && a) {
                    ...
                    for (f = 0; f < a.length; ++f) {
                        ...
                        var g = void 0,
                            ...
                            r = void 0;
                        c = [];
                        for (e = 0; e < b.length; ++e) l = b[e], "string" == typeof l ? (l = l.split(/\s*:\s*/), h = l[0], k = null, r = l[1]) : (h = l.check, k = l.left, r = l.right), g || (g = l, g = g.element ? g.element : h ? h.match(/^([a-z0-9]+)/i)[0] : g.left.getDefinition().element), k instanceof CKEDITOR.style && (k = B(k)), c.push({
                            check: h == g ? null : h,
                            left: k,
                            right: "string" == typeof r ? D(r) : r
                        });
                        b = g;
                        d[b] || (d[b] = []);
                        d[b].push(c)
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    f = d
                } else d = a.getDefinition(), f = d.styles, h = d.attributes || {}, f && !CKEDITOR.tools.isEmpty(f) ? (f = E(f), h.style = CKEDITOR.tools.writeCssText(f, !0)) : f = {}, f = {
                    name: d.element,
                    attributes: h,
                ...
                var h = CKEDITOR.tools.clone(f),
                    k = [],
                    r;
                if (!1 !== b && (r = this._.transformations[f.name])) {
                    for (d = 0; d < r.length; ++d) w(this, f, r[d]);
                    t(f)
                }
                u(this, h, k, {
                    doFilter: !0,
                ...
                b = 0 < k.length ? !1 : CKEDITOR.tools.objectCompare(f.attributes, h.attributes, !0) ? !0 : !1;
        ...
        O = CKEDITOR.filter.transformationsTools = {
            ...
            transform: function(a, b) {
                if ("string" == typeof b) a.name = b;
                    ...
                    for (g in f)
                        if ("class" == g)
                            for (c = a.classes.join("|"), l = f[g].split(/\s+/); h = l.pop();) - 1 == c.indexOf(h) && a.classes.push(h);
        ...
        return {
            load: function(b, c, d, k) {
                ...
                var f = b.length,
                    ...
                    l = [],
                    g = function(a) {
                        c && (m ? c.call(d, a) : c.call(d, h, l))
                    };
                if (0 === f) g(!0);
                else {
                    var n = function(a, b) {
                            (b ? h : l).push(a);
                            0 >= --f && (k && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), g(b))
                        },
                        v = function(b, c) {
                            a[b] = 1;
                            var d = e[b];
        ...
        load: function(a, e, b) {
            ...
            for (var c = this.loaded, d = this.registered, k = [], m = {}, f = {}, h = 0; h < a.length; h++) {
                var l = a[h];
                if (l)
                    if (c[l] || d[l]) f[l] = this.get(l);
                    else {
                ...
                m = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (f in a) {
                            ...
                            if (!e[f]) {
                                if (n.icons)
                                    for (var u = n.icons.split(","), q = u.length; q--;) CKEDITOR.skin.addIcon(u[q], n.path + "icons/" + (CKEDITOR.env.hidpi && n.hidpi ? "hidpi/" : "") + u[q] + ".png");
                                e[f] = 1
                            }
                            if (v)
                                for (v.split && (v = v.split(",")), n = 0; n < v.length; n++) k[v[n]] || b.push(v[n])
                        }
                        if (b.length) m.call(this, b);
                        else {
                            for (f in k) n = k[f], n.onLoad && !n.onLoad._called && (!1 === n.onLoad() && delete k[f], n.onLoad._called = 1);
                            c && c.call(d || window, k)
                        }
                    }, this)
                };
        ...
        function k(a, b, c) {
            if (b) {
                ...
                for (f in g) d = g[f], (c || d.contextSensitive) && d.refresh(a, b)
            }
        }
        ...
        function n(a) {
            ...
            if (d) var g = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"),
                c = c.replace(g, ""),
                c = c + ("," + d);
            if (f) var e = new RegExp("(?:^|,)(?:" + f.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"),
                c = c.replace(e, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var l in c) {
                    ...
                    if (m && (z = m.match(e)))
                        for (; m = z.pop();) CKEDITOR.error("editor-plugin-required", {
                            plugin: m.replace(",", ""),
                            requiredBy: l
                        });
                    k && !a.lang[l] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? r = a.langCode : (r = a.langCode.replace(/-.*/, ""), r = r != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, r) ? r : 0 <= CKEDITOR.tools.indexOf(k, "en") ? "en" : k[0]), h.langEntries && h.langEntries[r] ? (a.lang[l] = h.langEntries[r], r = null) : g.push(CKEDITOR.getUrl(h.path + "lang/" + r + ".js")));
                    f.push(r);
                    d.push(h)
                }
                CKEDITOR.scriptLoader.load(g, function() {
                    for (var c = ["beforeInit", "init", "afterInit"], g = 0; g < c.length; g++)
                        for (var e = 0; e < d.length; e++) {
                            var l = d[e];
                            0 === g && f[e] && l.lang && l.langEntries && (a.lang[l.name] = l.langEntries[f[e]]);
                            if (l[c[g]]) l[c[g]](a)
                        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            getSelectedHtml: function(a) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, f, g, e, l = 0; l < c.length; l++) {
                    var h = c[l],
                        k = h.startContainer;
                    k.getName && "tr" == k.getName() ? (f || (f = k.getAscendant("table").clone(), f.append(k.getAscendant("tbody").clone()), d.append(f), f = f.findOne("tbody")), g && g.equals(k) || (g = k, e = k.clone(), f.append(e)), e.append(h.cloneContents())) : d.append(h.cloneContents())
                }
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, d, k = 0, m; c = this._.htmlPartsRegex.exec(b);) {
                    d = c.index;
                    if (d > k)
                        if (k = b.substring(k, d), m) m.push(k);
                        else this.onText(k);
                ...
                if (b.length > k) this.onText(b.substring(k, b.length))
            }
        }
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(k, m, f) {
                ...
                if (0 < p.length)
                    for (var c = 0; c < p.length; c++) {
                        var d = p[c],
                            f = d.name,
                            g = CKEDITOR.dtd[f],
                            e = A.name && CKEDITOR.dtd[A.name];
                        e && !e[f] || a && g && !g[a] && CKEDITOR.dtd[a] ? f == A.name && (n(A, A.parent, 1), c--) : (b || (l(), b = 1), d = d.clone(), d.parent = A, A = d, p.splice(c, 1), c--)
                    }
            }

            function l() {
                for (; y.length;) n(y.shift(), A)
            }
            ...
            function n(b, c, d) {
                c = c || A || t;
                var e = A;
                void 0 === b.previous && (v(c, b) && (A = c, q.onTagOpen(f, {}), b.returnPoint = c = A), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (r = !1), "textarea" == b.name && (z = !1));
            ...
            q.onTagOpen = function(d, f, g, k) {
                ...
                if (a(f)) p.push(f);
                    ...
                    if ("br" == d) y.push(f);
                        ...
                        for (; !(k = (g = A.name) ? CKEDITOR.dtd[g] || (A._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || A.isUnknown || k[d]);)
                            if (A.isOptionalClose) q.onTagClose(g);
                            else if (d in b && g in b) g = A.children, (g = g[g.length - 1]) && "li" == g.name || n(g = new CKEDITOR.htmlParser.element("li"), A), !f.returnPoint && (f.returnPoint = A), A = g;
                        else if (d in CKEDITOR.dtd.$listItem && !u(d, g)) q.onTagOpen("li" == d ? "ul" : "dl", {}, 0, 1);
                        else if (g in e && !u(d, g)) !f.returnPoint && (f.returnPoint = A), A = A.parent;
                        else if (g in CKEDITOR.dtd.$inline && p.unshift(A), A.parent) n(A, A.parent, 1);
                        else {
                            f.isOrphan = 1;
                            break
                        }
            ...
            q.onText = function(a) {
                if (!(A._.hasInlineStarted && !y.length || r || z) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
                var b = A.name,
                    g = b ? CKEDITOR.dtd[b] || (A._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!z && !g["#"] && b in e) q.onTagOpen(d[b] || ""), q.onText(a);
                else {
                    l();
                    h();
                    r || z || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                    a = new CKEDITOR.htmlParser.text(a);
                    if (v(A, a)) this.onTagOpen(f, {}, 0, 1);
                    A.add(a)
                }
            };
        ...
        a.prototype = {
            ...
            exec: function(a, c) {
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    ...
                    h, l, g, n;
                for (n = 0; n < f; n++)
                    if (d && (h = c.type, l = c.name), g = m[n], !(a.nonEditable && !g.options.applyToAll || a.nestedEditable && g.options.excludeNestedEditable)) {
                        g = g.value.apply(null, e);
                        if (!1 === g || d && g && (g.name != l || g.type != h)) return g;
                        null != g && (e[0] = c = g)
                    }
                return c
            },
        ...
        function a(a, f) {
                ...
                return function(f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var e = [],
                            ...
                            r, m;
                        if (h)
                            for (l(h, 1) && e.push(h); h;) k(h) && (r = c(h)) && l(r) && ((m = c(r)) && !k(m) ? e.push(r) : (g(z).insertAfter(r), r.remove())), h = h.previous;
                        for (h = 0; h < e.length; h++) e[h].remove();
                        if (e = !a || !1 !== ("function" == typeof d ? d(f) : d)) z || CKEDITOR.env.needsBrFiller || f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? z || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (e = b(f), e = !e || "form" == f.name && "input" == e.name) : e = !1 : e = !1;
                        e && f.add(g(a))
                    }
                }
            }
            ...
            function l(a, b) {
                ...
                var c;
                return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(p)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && z && (!b || a.parent.name in w) || !z && ((c = a.previous) && "br" == c.name || !c || k(c))) ? !0 : !1
            }
            var h = {
                    elements: {}
                },
                z = "html" == f,
                w = CKEDITOR.tools.extend({}, r),
                n;
            for (n in w) "#" in A[n] || delete w[n];
            for (n in w) h.elements[n] = e(z, a.config.fillEmptyBlocks);
            h.root = e(z, !1);
                ...
                return function(b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in f || "data-cke-eol" in f) delete f["data-cke-bogus"];
                            ...
                            var e = c(b);
                            !f && k(b.parent) ? m(b.parent, g(a)) : k(f) && e && !k(e) && g(a).insertBefore(f)
                        }
                    }
                }
            }(z);
        ...
        function t(a, b) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, f) {
                return "\x3c" + c + d + "\x3e" + q(u(f), b) + "\x3c/" + c + "\x3e"
            })
        }
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, c, d) {
                var f = this.editor,
                    g, e, l, h;
                b && "object" == typeof b ? (g = b.context, c = b.fixForBody, d = b.dontFilter, e = b.filter, l = b.enterMode, h = b.protectedWhitespaces) : g = b;
        ...
        var p = /(?:&nbsp;|\xa0)$/,
            ...
            r = CKEDITOR.tools.extend({}, A.$blockLimit, A.$block),
            w = {
                elements: {
                    input: f,
                    textarea: f
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (h in m) {
                    for (f = m[h];;)
                        if (l = a.onAttributeName(b, h))
                            if (l != h) delete m[h], h = l;
                            else break;
                    else {
                        delete m[h];
                        break
                    }
                    l && (!1 === (f = a.onAttribute(b, e, l, f)) ? delete m[l] : m[l] = f)
                }
            ...
            writeHtml: function(a, b) {
                ...
                h = 0;
                for (l = m.length; h < l; h++) f = m[h], a.attribute(f[0], f[1]);
                a.openTagClose(k, this.isEmpty);
                this.writeChildrenHtml(a);
                this.isEmpty || a.closeTag(k)
            },
        ...
        var a = {},
            ...
            c = /\n/g,
            d = /\r/g;
        CKEDITOR.template = function(k) {
            if (a[k]) this.output = a[k];
            else {
                var m = k.replace(b, "\\$1").replace(c, "\\n").replace(d, "\\r").replace(e, function(a, b) {
                    return "',data['" + b + "']\x3d\x3dundefined?'{" + b + "}':data['" + b + "'],'"
                });
                this.output = a[k] = Function("data", "buffer", "return buffer?buffer.push('" + m + "'):['" + m + "'].join('');")
            }
        }
        ...
        CKEDITOR.inlineAll = function() {
            ...
            for (b in CKEDITOR.dtd.$editable)
                for (var c = CKEDITOR.document.getElementsByTag(b), d = 0, k = c.count(); d < k; d++) a = c.getItem(d), "true" == a.getAttribute("contenteditable") && (e = {
                    element: a,
                    config: {}
        ...
        function a(a, d, k, m) {
            ...
            m == CKEDITOR.ELEMENT_MODE_REPLACE && (a.setStyle("visibility", "hidden"), f._.required = a.hasAttribute("required"), a.removeAttribute("required"));
            k && f.setData(k, null, !0);
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != e.mode && m && m[a]) {
                ...
                if (e.mode) {
                    ...
                    "source" == e.mode && m == h && (e.fire("lockSnapshot", {
                        forceUpdate: !0
                    }), l = 1);
                ...
                this._.modes[a](function() {
                    ...
                    l ? e.fire("unlockSnapshot") : "wysiwyg" == a && e.fire("saveSnapshot");
                    setTimeout(function() {
                        e.fire("mode");
                        b && b.call(e)
                    }, 0)
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, e, m) {
            ...
            m.setSize("width", a, !0);
            l && (l.style.width = "1%");
            var g = (m.$.offsetHeight || 0) - (h.$.clientHeight || 0),
                f = Math.max(b - (e ? 0 : g), 0);
            b = e ? b + g : b;
        ...
        function a(a) {
            ...
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
                if (g = e(g, d)) g.appendBogus(), h = CKEDITOR.env.ie;
            m(b, d.block, f) && l.collapsed && !l.getCommonAncestor().isReadOnly() && (d = l.clone(), d.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(d), f.guard = function(a) {
                return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
            }, !f.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) && (b = l.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), h = 1, a.cancel());
            h && l.select()
        }
        ...
        function e(a, b) {
            ...
            var d = b.block || b.blockLimit,
                f = d && d.getLast(c);
            if (!(!d || !d.isBlockBoundary() || f && f.type == CKEDITOR.NODE_ELEMENT && f.isBlockBoundary() || d.is("pre") || d.getBogus())) return d
        }
        ...
        function k(a) {
            function b(a) {
                return function(b, f) {
                    f && b.type == CKEDITOR.NODE_ELEMENT && b.is(g) && (d = b);
                    if (!(f || !c(b) || a && u(b))) return !1
                }
            }
            var d, f = a.getRanges()[0];
            a = a.root;
            var g = {
                table: 1,
                ul: 1,
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    if (g)
                        for (;
                            (e = b.getCommonAncestor(0, 1)) && (l = CKEDITOR.dtd[e.getName()]) && (!l || !l[f]);) e.getName() in CKEDITOR.dtd.span ? b.splitElement(e) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(e), b.collapse(!0), e.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                },
                ...
                fixInitialSelection: function() {
                    function a() {
                        var b = c.getDocument().$,
                            d = b.getSelection(),
                            f;
                        a: if (d.anchorNode && d.anchorNode == c.$) f = !0;
                            else {
                    ...
                    function b() {
                        var a = c.getDocument().$,
                            d = a.selection,
                            f = c.getDocument().getActive();
                        "None" == d.type && f.equals(c) && (d = new CKEDITOR.dom.range(c), a = a.body.createTextRange(), d.moveToElementEditStart(c), d = d.startContainer, d.type != CKEDITOR.NODE_ELEMENT && (d = d.getParent()), a.moveToElementText(d.$), a.collapse(!0), a.select())
                    }
                    var c = this;
                ...
                extractHtmlFromRange: function(a, b) {
                    var c = A,
                        ...
                        f = this.getHtmlFromRange(a);
                    if (a.collapsed) return a.optimize(), f;
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (e) {
                            var f = d.getHead(),
                                h = f.getCustomData("stylesheet");
                            h ? e != h.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? h.$.styleSheet.cssText = e : h.setText(e)) : (e = d.appendStyleText(e), e = new CKEDITOR.dom.element(e.ownerNode || e.owningElement), f.setCustomData("stylesheet", e), e.data("cke-temp", 1))
                        }
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in m) {
                                ...
                                var f, e = b.getRanges()[0],
                                    l = e.startPath(),
                                    h, r, n, c = 8 == c;
                                CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (f = b.getSelectedElement()) || (f = k(b)) ? (a.fire("saveSnapshot"), e.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f.remove(), e.select(), a.fire("saveSnapshot"), d = 1) : e.collapsed && ((h = l.block) && (n = h[c ? "getPrevious" : "getNext"](g)) && n.type == CKEDITOR.NODE_ELEMENT && n.is("table") && e[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire("saveSnapshot"), e[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && h.remove(), e["moveToElementEdit" + (c ? "End" : "Start")](n), e.select(), a.fire("saveSnapshot"), d = 1) : l.blockLimit && l.blockLimit.is("td") && (r = l.blockLimit.getAscendant("table")) && e.checkBoundaryOfElement(r, c ? CKEDITOR.START : CKEDITOR.END) && (n = r[c ? "getPrevious" : "getNext"](g)) ? (a.fire("saveSnapshot"), e["moveToElementEdit" + (c ? "End" : "Start")](n), e.checkStartOfBlock() && e.checkEndOfBlock() ? n.remove() : e.select(), a.fire("saveSnapshot"), d = 1) : (r = l.contains(["td", "th", "caption"])) && e.checkBoundaryOfElement(r, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
                            }
                            return !d
                        });
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function(b) {
                            b.data.getKeystroke() in m && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select())
                        });
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
                            ...
                            if (b in m) {
                                ...
                                else c = d, e = b.block, d = c.endPath().block, e && d && !e.equals(d) ? (a.fire("saveSnapshot"), (f = e.getBogus()) && f.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(e, !1), b.lastElement.mergeSiblings(), l(e, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b) return;
        ...
        t = function() {
            ...
            function b(c, d) {
                ...
                f = d.range.startPath();
                for (var m = k[m.getName()], n = 0, y = c.getChildren(), p = y.count(), q = -1, w = -1, t = 0, C = f.contains(k.$list); n < p; ++n) f = y.getItem(n), a(f) ? (e = f.getName(), C && e in CKEDITOR.dtd.$list ? h = h.concat(b(f, d)) : (l = !!m[e], "br" != e || !f.data("cke-eol") || n && n != p - 1 || (t = (g = n ? h[n - 1].node : y.getItem(n + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && k.$block[g.getName()]), -1 != q || l || (q = n), l || (w = n), h.push({
                    isElement: 1,
                    isLineBreak: t,
                    ...
                    node: f,
                    allowed: 1
                }); - 1 < q && (h[q].firstNotAllowed = 1); - 1 < w && (h[w].lastNotAllowed = 1);
                return h
            }
            ...
            function d(b, c) {
                var f = [],
                    ...
                    l, h = 0,
                    m = k[c],
                    r = !b.is(k.$inline) || b.is("br");
                for (r && f.push(" "); h < e; h++) l = g.getItem(h), a(l) && !l.is(m) ? f = f.concat(d(l, c)) : f.push(l);
                r && f.push(" ");
                return f
            }
            ...
            function l(b, c, d, f) {
                ...
                (e = (new CKEDITOR.dom.walker(g)).next()) && a(e) && n[e.getName()] && (h = e.getPrevious()) && a(h) && !h.getParent().equals(b.startContainer) && d.contains(h) && f.contains(e) && e.isIdentical(h) && (e.moveChildren(h), e.remove(), l(b, c, d, f))
            }
            ...
            var k = CKEDITOR.dtd,
                ...
                p = CKEDITOR.tools.extend({}, k.$inline);
            delete p.br;
            return function(n, q, H, t) {
                var u = n.editor,
                    A = !1;
                "unfiltered_html" == q && (q = "html", A = !0);
                if (!t.checkReadOnly()) {
                    var v = (new CKEDITOR.dom.elementPath(t.startContainer, t.root)).blockLimit || t.root;
                    n = {
                        type: q,
                        dontFilter: A,
                        editable: n,
                    ...
                    t = n.mergeCandidates;
                    var J, E;
                    "text" == n.type && q.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (J = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", q.document), q.insertNode(J), q.setStartAfter(J));
                    A = new CKEDITOR.dom.elementPath(q.startContainer);
                    n.endPath = v = new CKEDITOR.dom.elementPath(q.endContainer);
                    if (!q.collapsed) {
                        var u = v.block || v.blockLimit,
                            W = q.getCommonAncestor();
                        u && !u.equals(W) && !u.contains(W) && q.checkEndOfBlock() && n.zombies.push(u);
                        q.deleteContents()
                    }
                    for (;
                        (E = g(q)) && a(E) && E.isBlockBoundary() && A.contains(E);) q.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END);
                    l(q, n.blockLimit, A, v);
                    J && (q.setEndBefore(J), q.collapse(), J.remove());
                    J = q.startPath();
                    if (u = J.contains(e, !1, 1)) q.splitElement(u), n.inlineStylesRoot = u, n.inlineStylesPeak = J.lastElement;
                    J = q.createBookmark();
                    (u = J.startNode.getPrevious(c)) && a(u) && e(u) && t.push(u);
                    (u = J.startNode.getNext(c)) && a(u) && e(u) && t.push(u);
                    for (u = J.startNode;
                        (u = u.getParent()) && e(u);) t.push(u);
                    q.moveToBookmark(J);
                    if (J = H) {
                        J = n.range;
                        if ("text" == n.type && n.inlineStylesRoot) {
                            ...
                            for (t = n.inlineStylesRoot.getParent(); !E.equals(t);) q = q.appendTo(E.clone()), E = E.getParent();
                            H = q.getOuterHtml().split("{cke-peak}").join(H)
                        }
                        E = n.blockLimit.getName();
                        if (/^\s+|\s+$/.test(H) && "span" in CKEDITOR.dtd[E]) {
                        ...
                        E = J.document.createElement("body");
                        E.setHtml(H);
                        U && (E.getFirst().remove(), E.getLast().remove());
                        if ((U = J.startPath().block) && (1 != U.getChildCount() || !U.getBogus())) a: {
                            var K;
                            if (1 == E.getChildCount() && a(K = E.getFirst()) && K.is(y) && !K.hasAttribute("contenteditable")) {
                                U = K.getElementsByTag("*");
                                J = 0;
                                for (t = U.count(); J < t; J++)
                                    if (q = U.getItem(J), !q.is(p)) break a;
                    ...
                    if (J) {
                        ...
                        var V, da;
                        q = K.startContainer;
                        var A = n.endPath.elements[0],
                            Z, v = A.getPosition(q),
                            W = !!A.getCommonAncestor(q) && v != CKEDITOR.POSITION_IDENTICAL && !(v & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        q = b(n.dataWrapper, n);
                        for (h(q, K); t < q.length; t++) {
                            v = q[t];
                            if (M = v.isLineBreak) {
                                M = K;
                                V = E;
                                var X = void 0,
                                    ga = void 0;
                                v.hasBlockSibling ? M = 1 : (X = M.startContainer.getAscendant(k.$block, 1)) && X.is({
                                    div: 1,
                                    p: 1
                                }) ? (ga = X.getPosition(V), ga == CKEDITOR.POSITION_IDENTICAL || ga == CKEDITOR.POSITION_CONTAINS ? M = 0 : (V = M.splitElement(X), M.moveToPosition(V, CKEDITOR.POSITION_AFTER_START), M = 1)) : M = 0
                            }
                            if (M) H = 0 < t;
                            else {
                                M = K.startPath();
                                !v.isBlock && m(n.editor, M.block, M.blockLimit) && (Y = f(n.editor)) && (Y = J.createElement(Y), Y.appendBogus(), K.insertNode(Y), CKEDITOR.env.needsBrFiller && (S = Y.getBogus()) && S.remove(), K.moveToPosition(Y, CKEDITOR.POSITION_BEFORE_END));
                                if ((M = K.startPath().block) && !M.equals(Q)) {
                                    if (S = M.getBogus()) S.remove(), U.push(M);
                                    Q = M
                                }
                                v.firstNotAllowed && (u = 1);
                                if (u && v.isElement) {
                                    M = K.startContainer;
                                    for (V = null; M && !k[M.getName()][v.name];) {
                                        if (M.equals(E)) {
                                            M = null;
                                            break
                                        }
                                    ...
                                    if (M) V && (da = K.splitElement(V), n.zombies.push(da), n.zombies.push(V));
                                    else {
                                        V = E.getName();
                                        Z = !t;
                                        M = t == q.length - 1;
                                        V = d(v.node, V);
                                        for (var X = [], ga = V.length, ba = 0, ea = void 0, ha = 0, ia = -1; ba < ga; ba++) ea = V[ba], " " == ea ? (ha || Z && !ba || (X.push(new CKEDITOR.dom.text(" ")), ia = X.length), ha = 1) : (X.push(ea), ha = 0);
                                        M && ia == X.length && X.pop();
                                        Z = X
                                    }
                                }
                                if (Z) {
                                    for (; M = Z.pop();) K.insertNode(M);
                                    Z = 0
                                } else K.insertNode(v.node);
                                v.lastNotAllowed && t < q.length - 1 && ((da = W ? A : da) && K.setEndAt(da, CKEDITOR.POSITION_AFTER_START), u = 0);
                                K.collapse()
                            }
                        }
                        1 != q.length ? S = !1 : (S = q[0], S = S.isElement && "false" == S.node.getAttribute("contenteditable"));
                        S && (H = !0, M = q[0].node, K.setStartAt(M, CKEDITOR.POSITION_BEFORE_START), K.setEndAt(M, CKEDITOR.POSITION_AFTER_END));
                        n.dontMoveCaret = H;
                    ...
                    if (da)
                        for (; Q = da.pop();) CKEDITOR.env.needsBrFiller ? Q.appendBogus() : Q.append(S.document.createText(" "));
                    for (; Q = n.mergeCandidates.pop();) Q.mergeSiblings();
                    S.moveToBookmark(Z);
                    if (!n.dontMoveCaret) {
                        for (Q = g(S); Q && a(Q) && !Q.is(k.$empty);) {
                            if (Q.isBlockBoundary()) S.moveToPosition(Q, CKEDITOR.POSITION_BEFORE_END);
                            else {
        ...
        p = function() {
            ...
            return function(d) {
                ...
                g.setStart(f, 0);
                g = a(g).lastBackward();
                g || (g = d.clone(), g.setEndAt(f, CKEDITOR.POSITION_BEFORE_END), g = a(g).lastForward(), e = !0);
                g || (g = f);
                g.is("table") ? (d.setStartAt(g, CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), g.remove()) : (g.is({
                    tbody: 1,
                    thead: 1,
                    tfoot: 1
                }) && (g = b(g, "tr", e)), g.is("tr") && (g = b(g, g.getParent().is("thead") ? "th" : "td", e)), (f = g.getBogus()) && f.remove(), d.moveToPosition(g, e ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END))
            }
        }();
        y = {
            eol: {
                detect: function(a, b) {
                    ...
                    e.block && f.checkBoundaryOfElement(e.block, CKEDITOR.START) && (c.setEndBefore(e.block), a.appendEolBr = 1)
                },
                fix: function(a, b) {
                    var c = b.getDocument(),
                        d;
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (f.blockLimit.is({
                        ...
                        var h = f.contains("table").getParent();
                        e = function(a) {
                            return !a.equals(h)
                        }
                        ...
                        var l = f.contains(CKEDITOR.dtd.$list).getParent();
                        e = function(a) {
                            return !a.equals(l)
                        }
                    }
                ...
                rebuildFragment: function(a, b, c, d) {
                    for (var f; c && !c.equals(b) && d(c);) f = c.clone(0, 1), a.fragment.appendTo(f), a.fragment = f, c = c.getParent()
                }
            },
            cell: {
                shrink: function(a) {
                    ...
                    var b = a.startContainer,
                        ...
                        d = a.startOffset,
                        f = a.endOffset;
                    b.type == CKEDITOR.NODE_ELEMENT && b.equals(c) && b.is("tr") && ++d == f && a.shrink(CKEDITOR.SHRINK_TEXT)
                }
            }
        };
        A = function() {
            ...
            function b(c, d, f) {
                a(d);
                a(f, 1);
                for (var g; g = f.getNext();) g.insertAfter(d), d = g;
                v(c) && c.remove()
            }
            ...
            return {
                list: {
                    detectMerge: function(a, b) {
                        ...
                        a.mergeListItems = f.block && g.block && f.block.is(CKEDITOR.dtd.$listItem) && g.block.is(CKEDITOR.dtd.$listItem);
                ...
                table: function() {
                    function a(c) {
                        ...
                        e.guard = function(a, e) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) {
                                var m = "visited_" + (e ? "out" : "in");
                                if (a.getCustomData(m)) return;
                                CKEDITOR.dom.element.setMarker(k, a, m, 1)
                            }
                            if (e && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), f.push(g);
                            else if (!e && l && a.equals(l)) g = c.clone(), g.setStartAt(l, CKEDITOR.POSITION_AFTER_START), f.push(g);
                            else {
                                if (m = !e) m = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!l || b(a, l));
                                m && (g = c.clone(), g.selectNodeContents(a), f.push(g))
                            }
                        };
                        e.lastForward();
                    ...
                    function b(a, c) {
                        var d = CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED,
                            f = a.getPosition(c);
                        return f === CKEDITOR.POSITION_IDENTICAL ? !1 : 0 === (f & d)
                    }
                    var d = {
                        td: 1,
                        th: 1,
                    ...
                    return {
                        ...
                        detectRanges: function(f, g) {
                            var e = c(g, f.bookmark),
                                h = e.clone(),
                                l, k, m = e.getCommonAncestor();
                            m.is(CKEDITOR.dtd.$tableContent) && !m.is(d) && (m = m.getAscendant("table", !0));
                            k = m;
                            m = new CKEDITOR.dom.elementPath(e.startContainer, k);
                            k = new CKEDITOR.dom.elementPath(e.endContainer, k);
                            m = m.contains("table");
                            k = k.contains("table");
                            if (m || k) m && k && b(m, k) ? (f.tableSurroundingRange = h, h.setStartAt(m, CKEDITOR.POSITION_AFTER_END), h.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), h = e.clone(), h.setEndAt(m, CKEDITOR.POSITION_AFTER_END), l = e.clone(), l.setStartAt(k, CKEDITOR.POSITION_BEFORE_START), l = a(h).concat(a(l))) : m ? k || (f.tableSurroundingRange = h, h.setStartAt(m, CKEDITOR.POSITION_AFTER_END), e.setEndAt(m, CKEDITOR.POSITION_AFTER_END)) : (f.tableSurroundingRange = h, h.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), e.setStartAt(k, CKEDITOR.POSITION_AFTER_START)), f.tableContentsRanges = l ? l : a(e)
                        },
        ...
        function b() {
            n = null;
            v && (CKEDITOR.tools.setTimeout(a, 0, this), v = !1)
        }
        ...
        function d(a) {
            ...
            return b(f) || b(g, 1) || !(f || g || d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary() && d.getBogus()) ? !0 : !1
        }
            ...
            if (c) {
                if (!1 !== b) {
                    ...
                    if (c.getLength() > e && g && g.intersectsNode(c.$)) {
                        ...
                        d.anchorNode == c.$ && d.anchorOffset > e && (h[0].offset -= e);
                        d.focusNode == c.$ && d.focusOffset > e && (h[1].offset -= e)
                    }
                }
                c.setText(f(c.getText(), 1));
                h && (c = a.getDocument().$, d = c.getSelection(), c = c.createRange(), c.setStart(h[0].node, h[0].offset), c.collapse(!0), d.removeAllRanges(), d.addRange(c), d.extend(h[1].node, h[1].offset))
            }
        }
        ...
        function h(a, b) {
            var c = CKEDITOR.dom.element.createFromHtml('\x3cdiv data-cke-hidden-sel\x3d"1" data-cke-temp\x3d"1" style\x3d"' + (CKEDITOR.env.ie ? "display:none" : "position:fixed;top:0;left:-1000px") + '"\x3e' + (b || "\x26nbsp;") + "\x3c/div\x3e", a.document);
            a.fire("lockSnapshot");
            a.editable().append(c);
            ...
            f.setStartAt(c, CKEDITOR.POSITION_AFTER_START);
            ...
            return function(c) {
                ...
                if (b[d]) {
                    var f = a.getSelection().getRanges(),
                        g = f[0];
                    1 == f.length && g.collapsed && (d = g[38 > d ? "getPreviousEditableNode" : "getNextEditableNode"]()) && d.type == CKEDITOR.NODE_ELEMENT && "false" == d.getAttribute("contenteditable") && (a.getSelection().fake(d), c.data.preventDefault(), c.cancel())
                }
            }
        }
            ...
            for (var b = 0; b < a.length; b++) {
                ...
                if (!c.collapsed) {
                    if (c.startContainer.isReadOnly())
                        for (var d = c.startContainer, f; d && !((f = d.type == CKEDITOR.NODE_ELEMENT) && d.is("body") || !d.isReadOnly());) f && "false" == d.getAttribute("contentEditable") && c.setStartAfter(d), d = d.getParent();
                    d = c.startContainer;
                    f = c.endContainer;
                    var g = c.startOffset,
                        e = c.endOffset,
                    ...
                    d.evaluator = function(d) {
                        if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
                            ...
                            d.getPosition(h.endContainer) & CKEDITOR.POSITION_CONTAINS || (f.setStartAfter(d), f.collapsed || a.splice(b + 1, 0, f));
                            return !0
                        }
                        return !1
                    };
        ...
        var n, v, u = CKEDITOR.dom.walker.invisible(1),
            q = function() {
                function a(b) {
                    return function(a) {
                ...
                function b(a) {
                    return function(b) {
                        var c = b.editor,
                            d = c.createRange(),
                            f;
                        (f = d.moveToClosestEditablePosition(b.selected, a)) || (f = d.moveToClosestEditablePosition(b.selected, !a));
                        f && c.getSelection().selectRanges([d]);
                        c.fire("saveSnapshot");
                        b.selected.remove();
                        f || (d.moveToElementEditablePosition(c.editable()), c.getSelection().selectRanges([d]));
                        c.fire("saveSnapshot");
                        return !1
                    }
                }
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            d.on("contentDom", function() {
                ...
                h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() {
                    q && CKEDITOR.env.webkit && (q = d._.previousActive && d._.previousActive.equals(f.getActive()));
                    d.unlockSelection(q);
                    q = 0
                }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || r) t ? h.attachListener(h, "beforedeactivate", b, null, null, -1) : h.attachListener(d, "selectionCheck", b, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() {
                    d.lockSelection(y);
                    q = 1
                ...
                if (CKEDITOR.env.ie && !r) {
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) n.on("mousedown", function(a) {
                            a.data.getTarget().is("html") && (g.on("mouseup", c), n.on("mouseup", c))
                        })
                    }
                }
                ...
                h.attachListener(h, "keydown", l(d), null, null, -1)
            });
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            var d, f;
            if (a)
                if (a.getRangeAt) d = (f = a.rangeCount && a.getRangeAt(0)) && new CKEDITOR.dom.node(f.commonAncestorContainer);
                else {
                    try {
                        f = a.createRange()
                    } catch (g) {}
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, {
            ...
            _createFillingCharSequenceNode: k,
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getType: t ? function() {
                ...
                if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
                    ...
                    var c = c.getRangeAt(0),
                        d = c.startContainer;
                    d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && y[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT)
                }
                return a.type = b
            },
            getRanges: function() {
                var a = t ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var f = d.children, g, e, h = b.duplicate(), l = 0, k = f.length - 1, m = -1, n, q; l <= k;)
                            if (m = Math.floor((l + k) / 2), g = f[m], h.moveToElementText(g), n = h.compareEndPoints("StartToStart", b), 0 < n) k = m - 1;
                            else if (0 > n) l = m + 1;
                        else return {
                            container: d,
                            offset: a(g)
                        ...
                        if (-1 == m || m == f.length - 1 && 0 > n) {
                            ...
                            h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                            f = d.childNodes;
                            if (!h) return g = f[f.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? {
                                container: d,
                                offset: f.length
                            } : {
                                container: g,
                            ...
                            for (d = f.length; 0 < h && 0 < d;) e = f[--d], e.nodeType == CKEDITOR.NODE_TEXT && (q = e, h -= e.nodeValue.length);
                            return {
                                container: q,
                                offset: -h
                            }
            ...
            getSelectedElement: function() {
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function() {
                        ...
                        for (var a = b.getRanges()[0].clone(), c, d, f = 2; f && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && y[c.getName()] && (d = c)); f--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                        return d && d.$
                    });
            ...
            getSelectedText: function() {
                ...
                var b = this.getNative(),
                    b = t ? "Control" == b.type ? "" : b.createRange().text : b.toString();
            ...
            selectRanges: function(a) {
                ...
                this.reset();
                if (b)
                    for (var b = this.root, c, f = 0; f < a.length; ++f) c = a[f], c.endContainer.equals(b) && (c.endOffset = Math.min(c.endOffset, b.getChildCount()));
                if (a.length)
                    if (this.isLocked) {
                        ...
                        a: {
                            var h, l;
                            if (1 == a.length && !(l = a[0]).collapsed && (e = l.getEnclosedNode()) && e.type == CKEDITOR.NODE_ELEMENT && (l = l.clone(), l.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (h = l.getEnclosedNode()) && h.type == CKEDITOR.NODE_ELEMENT && (e = h), "false" == e.getAttribute("contenteditable"))) break a;e = void 0
                        }
                        if (e) this.fake(e);
                        else {
                            if (t) {
                                ...
                                a = e.collapsed;
                                var n, q, p;
                                if ((c = e.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in y && (!c.is("a") || !c.getText())) try {
                                ...
                                g ? (h = e.document.$.body.createTextRange(), h.moveToElementText(g.$), p.setEndPoint("EndToEnd", h), p.moveEnd("character", -1)) : (n = b.getNext(l), q = b.hasAscendant("pre"), n = !(n && n.getText && n.getText().match(h)) && (q || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), q = e.document.createElement("span"), q.setHtml("\x26#65279;"), q.insertBefore(b), n && e.document.createText("﻿").insertBefore(b));
                                e.setStartBefore(b);
                                b.remove();
                                a ? (n ? (p.moveStart("character", -1), p.select(), e.document.$.selection.clear()) : p.select(), e.moveToPosition(q, CKEDITOR.POSITION_BEFORE_START), q.remove()) : (e.setEndBefore(g), g.remove(), p.select())
                            } else {
                                g = this.getNative();
                                if (!g) return;
                                ...
                                for (p = 0; p < a.length; p++) {
                                    ...
                                    e.collapsed && CKEDITOR.env.webkit && d(e) && (h = k(this.root), e.insertNode(h), (n = h.getNext()) && !h.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && "br" == n.getName() ? (m(this.root), e.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)) : e.moveToPosition(h, CKEDITOR.POSITION_AFTER_END));
                                    q.setStart(e.startContainer.$, e.startOffset);
                                    try {
                                        q.setEnd(e.endContainer.$, e.endOffset)
                                    } catch (H) {
                                        if (0 <= H.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) e.collapse(1), q.setEnd(e.endContainer.$, e.endOffset);
                                        else throw H;
                                    }
                                    g.addRange(q)
                                }
            ...
            fake: function(a, b) {
                ...
                f.setStartBefore(a);
                f.setEndAfter(a);
                d.ranges = new CKEDITOR.dom.rangeList(f);
        ...
        function b(c) {
            var f = c.document;
            if (c.collapsed) f = y(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
            else {
                var g = this.element,
                    h = this._.definition,
                ...
                if (!k) {
                    var v = c.getCommonAncestor(),
                        k = a(t, v),
                        v = a(u, v);
                    k && (A = k.getNextSourceNode(!0));
                    v && (u = v)
                }
                for (A.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (A = 0); A;) {
                    k = !1;
                    if (A.equals(u)) A = null, k = !0;
                    else {
                        var z = A.type == CKEDITOR.NODE_ELEMENT ? A.getName() : null,
                            v = z && "false" == A.getAttribute("contentEditable"),
                            w = z && A.getAttribute("data-nostyle");
                        if (z && A.data("cke-bookmark")) {
                            A = A.getNextSourceNode(!0);
                            continue
                        }
                        if (v && m && CKEDITOR.dtd.$block[z])
                            for (var C = A, x = d(C), B = void 0, D = x.length, ea = 0, C = D && new CKEDITOR.dom.range(C.getDocument()); ea < D; ++ea) {
                                var B = x[ea],
                                    ha = CKEDITOR.filter.instances[B.data("cke-filter")];
                                if (ha ? ha.check(this) : 1) C.selectNodeContents(B), b.call(this, C)
                            }
                        x = z ? !n[z] || w ? 0 : v && !m ? 0 : e(A, u, h, L) : 1;
                        if (x)
                            if (B = A.getParent(), x = h, D = g, ea = l, !B || !(B.getDtd() || CKEDITOR.dtd.span)[D] && !ea || x.parentRule && !x.parentRule(B)) k = !0;
                            else {
                                if (r || z && CKEDITOR.dtd.$removeEmpty[z] && (A.getPosition(u) | L) != L || (r = c.clone(), r.setStartBefore(A)), z = A.type, z == CKEDITOR.NODE_TEXT || v || z == CKEDITOR.NODE_ELEMENT && !A.getChildCount()) {
                                    for (var z = A, E;
                                        (k = !z.getNext(I)) && (E = z.getParent(), n[E.getName()]) && e(E, t, h, N);) z = E;
                                    r.setEndAfter(z)
                                }
                            }
                        else k = !0;
                        A = A.getNextSourceNode(w || v)
                    }
                    if (k && r && !r.collapsed) {
                        for (var k = y(this, f), v = k.hasAttributes(), w = r.getCommonAncestor(), z = {}, x = {}, B = {}, D = {}, aa, fa, F; k && w;) {
                            if (w.getName() == g) {
                                for (aa in h.attributes) !D[aa] && (F = w.getAttribute(fa)) && (k.getAttribute(aa) == F ? x[aa] = 1 : D[aa] = 1);
                                for (fa in h.styles) !B[fa] && (F = w.getStyle(fa)) && (k.getStyle(fa) == F ? z[fa] = 1 : B[fa] = 1)
                            }
                            w = w.getParent()
                        }
                        for (aa in x) k.removeAttribute(aa);
                        for (fa in z) k.removeStyle(fa);
                        v && !k.hasAttributes() && (k = null);
                        k ? (r.extractContents().appendTo(k), r.insertNode(k), q.call(this, k), k.mergeSiblings(), CKEDITOR.env.ie || k.$.normalize()) : (k = new CKEDITOR.dom.element("span"), r.extractContents().appendTo(k), r.insertNode(k), q.call(this, k), k.remove(!0));
                        r = null
                    }
                }
                c.moveToBookmark(p);
            ...
            if (a.collapsed) {
                for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, e = 0, h; e < f.elements.length && (h = f.elements[e]) && h != f.block && h != f.blockLimit; e++)
                    if (this.checkElementRemovable(h)) {
                        var l;
                        a.collapsed && (a.checkBoundaryOfElement(h, CKEDITOR.END) || (l = a.checkBoundaryOfElement(h, CKEDITOR.START))) ? (g = h, g.match = l ? "start" : "end") : (h.mergeSiblings(), h.is(this.element) ? u.call(this, h) : t(h, r(this)[h.getName()]))
                    }
                if (g) {
                    h = d;
                    for (e = 0;; e++) {
                ...
                var k = c.endNode,
                    m = this;
                b();
                for (f = d; !f.equals(k);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? u.call(this, f) : t(f, r(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g
            }
            a.moveToBookmark(c);
        ...
        function m(a) {
            ...
            if (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) {
                ...
                if (b.styles)
                    for (var f in b.styles) b.styles.hasOwnProperty(f) && a.removeStyle(f)
            }
        }
        ...
        function f(a) {
            ...
            for (var d, f = a.document, g; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = y(this, f, d), l(d, g));
            a.moveToBookmark(b)
        }
        ...
        function h(a) {
            ...
            for (var d, f; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((f = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(f), l(d, f)) : u.call(this, d));
            a.moveToBookmark(b)
        }
        ...
        function l(a, b) {
            ...
            if (d && !f) {
                ...
                b = f
            } else e ? b = v(c ? [a.getHtml()] : g(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b,
                    l;
                (l = c.getPrevious(G)) && l.type == CKEDITOR.NODE_ELEMENT && l.is("pre") && (d = n(l.getHtml(), /\n$/, "") + "\n\n" + n(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" : c.setHtml(d), l.remove())
            } else c && p(b)
        }
        ...
        function u(a, b) {
            var c = this._.definition,
                ...
                e;
            for (e in d)
                if ("class" != e && !this._.definition.fullMatch || a.getAttribute(e) == w(e, d[e])) b && "data-" == e.slice(0, 5) || (g = a.hasAttribute(e), a.removeAttribute(e));
            for (var h in c) this._.definition.fullMatch && a.getStyle(h) != w(h, c[h], !0) || (g = g || !!a.getStyle(h), a.removeStyle(h));
            t(a, f, B[a.getName()]);
            g && (this._.definition.alwaysRemoveElement ? p(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? p(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        }

        function q(a) {
            for (var b = r(this), c = a.getElementsByTag(this.element), d, f = c.count(); 0 <= --f;) d = c.getItem(f),
                d.isReadOnly() || u.call(this, d, !0);
            for (var g in b)
                if (g != this.element)
                    for (c = a.getElementsByTag(g), f = c.count() - 1; 0 <= f; f--) d = c.getItem(f), d.isReadOnly() || t(d, b[g])
        }
            ...
            if (b = b && b.attributes)
                for (var d = 0; d < b.length; d++) {
                    ...
                    if (g = a.getAttribute(f)) {
                        var e = b[d][1];
                        (null === e || e.test && e.test(g) || "string" == typeof e && g == e) && a.removeAttribute(f)
                    }
                }
            c || p(a)
        }
        ...
        function r(a) {
            ...
            if (c) {
                ...
                for (var d = 0; d < c.length; d++) {
                    var f = c[d],
                        g, e;
                    "string" == typeof f ? g = f.toLowerCase() : (g = f.element ? f.element.toLowerCase() : a.element, e = f.attributes);
                    f = b[g] || (b[g] = {});
                    if (e) {
        ...
        function x(a, b, c) {
            ...
            for (var g, e = f.createIterator(); g = e.getNextRange();) b.call(this, g, c);
            a.selectRanges(f);
        ...
        CKEDITOR.style.prototype = {
            ...
            applyToRange: function(a) {
                this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? f : this.type == CKEDITOR.STYLE_OBJECT ? k : null;
                return this.applyToRange(a)
            },
            removeFromRange: function(a) {
                this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? h : this.type == CKEDITOR.STYLE_OBJECT ? m : null;
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (d = c._AC) c = d;
                        ...
                        var d = {},
                            ...
                            g = c.attributes;
                        if (g)
                            for (var e in g) f++, d[e] = g[e];
                        if (e = CKEDITOR.style.getStyleText(c)) d.style || f++, d.style = e;
                        d._length = f;
                        c = c._AC = d
                    }
                    if (c._length) {
            ...
            buildPreview: function(a) {
                ...
                var c = ["\x3c", d],
                    f = b.attributes;
                if (f)
                    for (var g in f) c.push(" ", g, '\x3d"', f[g], '"');
                (f = CKEDITOR.style.getStyleText(b)) && c.push(' style\x3d"', f, '"');
        ...
        attachStyleStateChange: function(a, e) {
            ...
            b || (b = this._.styleStateChangeCallbacks = [], this.on("selectionChange", function(a) {
                for (var d = 0; d < b.length; d++) {
                    var e = b[d],
                        m = e.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    e.fn.call(this, m)
                }
            }));
            b.push({
        ...
        CKEDITOR.dom.elementPath = function(b, d) {
            ...
            do
                if (h.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (h.equals(d)) break;
                    if (!m && (l = h.getName(), "true" == h.getAttribute("contenteditable") ? m = h : !k && e[l] && (k = h), a[l])) {
                        if (l = !k && "div" == l) {
                            a: {
                                l = h.getChildren();
        ...
        split: function(a) {
            var e = this.$.parentNode,
                ...
                c = this.getLength(),
                d = this.getDocument(),
                k = new CKEDITOR.dom.text(this.$.splitText(a), d);
            e.childNodes.length == b && (a >= c ? (k = d.createText(""), k.insertAfter(this)) : (a = d.createText(""), a.insertAfter(k), a.remove()));
            return k
        },
        ...
        function a(a, c, d) {
            ...
            c[d ? "endContainer" : "startContainer"] = m;
            return c
        }
                ...
                return {
                    getNextRange: function(m) {
                        ...
                        if (f && 1 < a.length) {
                            ...
                            for (f.moveToBookmark(d.shift()); l--;) h = a[++e], h.moveToBookmark(d.shift()), f.setEnd(h.endContainer, h.endOffset)
                        }
                        return f
                    }
                }
        ...
        function b(a, b) {
            k[a] || (CKEDITOR.document.appendStyleSheet(e(a)), k[a] = 1);
            b && b()
        }
            ...
            setUiColor: function(a) {
                ...
                return (this.setUiColor = function(a) {
                    ...
                    var c = CKEDITOR.skin.chameleon,
                        e = "",
                        l = "";
                    "function" == typeof c && (e = c(this, "editor"), l = c(this, "panel"));
                    a = [
                        [h, a]
                    ];
                    d([b], e, a);
        ...
        return function(c, d) {
            var k = c.uiColor,
                k = {
                    id: "." + c.id,
                    defaultBorder: a(k, -.1),
                    defaultGradient: e(a(k, .9), k),
                    lightGradient: e(a(k, 1), a(k, .7)),
                    mediumGradient: e(a(k, .8), a(k, .5)),
                    ckeButtonOn: e(a(k, .6), a(k, .7)),
                    ckeResizer: a(k, -.4),
                    ckeToolbarSeparator: a(k, .5),
                    ckeColorauto: a(k, .8),
                    dialogBody: a(k, .7),
                    dialogTabSelected: e("#FFFFFF", "#FFFFFF"),
                    dialogTabSelectedBorder: "#FFF",
                    elementsPathColor: a(k, -.6),
                    elementsPathBg: k,
                    menubuttonIcon: a(k, .5),
                    menubuttonIconHover: a(k, .3)
                };
            return b[d].output(k).replace(/\[/g, "{").replace(/\]/g, "}")
        }
        ...
        onLoad: function() {
            ...
            CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
                labeledElement: function(b, c, d, f) {
                    if (!(4 > arguments.length)) {
                        ...
                        c.includeLabel && (k["aria-labelledby"] = e.labelId);
                ...
                checkbox: function(b, c, d) {
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, b, c, d, "span", null, null, function() {
                            ...
                            f.checkbox = new CKEDITOR.ui.dialog.uiElement(b, a, d, "input", null, g);
                            d.push(' \x3clabel id\x3d"', e, '" for\x3d"', g.id, '"' + (c.labelStyle ? ' style\x3d"' + c.labelStyle + '"' : "") + "\x3e", CKEDITOR.tools.htmlEncode(c.label), "\x3c/label\x3e");
                            return d.join("")
                        })
                    }
                },
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function() {
                            for (var a = [], d = [], g = (c.id ? c.id : CKEDITOR.tools.getNextId()) + "_radio", k = 0; k < c.items.length; k++) {
                                var y = c.items[k],
                                    A = void 0 !== y[2] ? y[2] : y[0],
                                    z = void 0 !== y[1] ? y[1] : y[0],
                                    r = CKEDITOR.tools.getNextId() + "_radio_input",
                                    w = r + "_label",
                                    r = CKEDITOR.tools.extend({}, c, {
                                        id: r,
                                        title: null,
                                        type: null
                                    }, !0),
                                    A = CKEDITOR.tools.extend({}, r, {
                                        title: A
                                    }, !0),
                                    C = {
                                        type: "radio",
                                    ...
                                    x = [];
                                e._["default"] == z && (C.checked = "checked");
                                m(r);
                                m(A);
                                "undefined" != typeof r.inputStyle && (r.style = r.inputStyle);
                                r.keyboardFocusable = !0;
                                f.push(new CKEDITOR.ui.dialog.uiElement(b, r, x, "input", null, C));
                                x.push(" ");
                ...
                select: function(b, c, d) {
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function() {
                            ...
                            m(a);
                            for (var k = 0, y; k < c.items.length && (y = c.items[k]); k++) e.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== y[1] ? y[1] : y[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(y[0]));
                            "undefined" != typeof a.inputStyle && (a.style = a.inputStyle);
                            f.select = new CKEDITOR.ui.dialog.uiElement(b, a, d, "select", null, g, e.join(""));
                            d.push("\x3c/div\x3e");
                            return d.join("")
                        })
                    }
                    ...
                    return function(d, f, e) {
                        if (!(3 > arguments.length)) {
                            ...
                            if (p) {
                                var y = this.focus;
                                this.focus = function() {
                                    ("function" == typeof p ? p : y).call(this);
                                    this.fire("focus")
                                };
                                f.isFocusable && (this.isFocusable = this.isFocusable);
                                this.keyboardFocusable = !0
                            }
                            CKEDITOR.ui.dialog.uiElement.call(this, d, f, k, "span", null, null, "");
                            k = k.join("").match(a);
                            m = m.match(b) || ["", "", ""];
                            c.test(m[1]) && (m[1] = m[1].slice(0, -1), m[2] = "/" + m[2]);
                            e.push([m[1], " ", k[1] || "", m[2]].join(""))
                        }
                    }
                }(),
            ...
            CKEDITOR.dialog.addUIElement("fieldset", {
                build: function(a, b, c) {
                    for (var d = b.children, f, e = [], k = [], m = 0; m < d.length && (f = d[m]); m++) {
                        var p = [];
                        e.push(p);
                        k.push(CKEDITOR.dialog._.uiElementBuilders[f.type].build(a, f, p))
                    }
        ...
        function l(a) {
            function b(c) {
                ...
                f.x += p;
                f.y += y;
                a.move(f.x + h[3] < g ? -h[3] : f.x - h[1] > l.width - k.width - g ? l.width - k.width + ("rtl" == e.lang.dir ? 0 : h[1]) : f.x, f.y + h[0] < g ? -h[0] : f.y - h[2] > l.height - k.height - g ? l.height - k.height + h[2] : f.y, 1);
        ...
        function g(a) {
            function b(c) {
                var n = "rtl" == e.lang.dir,
                    p = m.width,
                    y = m.height,
                    q = p + (c.data.$.screenX - l.x) * (n ? -1 : 1) * (a._.moved ? 1 : 2),
                    A = y + (c.data.$.screenY - l.y) * (a._.moved ? 1 : 2),
                    r = a._.element.getFirst(),
                    r = n && r.getComputedStyle("right"),
                    t = a.getPosition();
                t.y + A > k.height && (A = k.height - t.y);
                (n ? r : t.x) + q > k.width && (q = k.width - (n ? r : t.x));
                if (f == CKEDITOR.DIALOG_RESIZE_WIDTH || f == CKEDITOR.DIALOG_RESIZE_BOTH) p = Math.max(d.minWidth || 0, q - g);
                if (f == CKEDITOR.DIALOG_RESIZE_HEIGHT || f == CKEDITOR.DIALOG_RESIZE_BOTH) y = Math.max(d.minHeight || 0, A - h);
                a.resize(p, y);
                a._.moved || a.layout();
                c.data.preventDefault()
            }
            ...
            if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
                var e = a.getParentEditor(),
                    g, h, k, l, m, n, p = CKEDITOR.tools.addFunction(function(d) {
                        ...
                        f.$.getElementsByTagName("iframe").length && (n = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_dialog_resize_cover" style\x3d"height: 100%; position: absolute; width: 100%;"\x3e\x3c/div\x3e'), f.append(n));
                        ...
                        CKEDITOR.document.on("mousemove", b);
                        CKEDITOR.document.on("mouseup", c);
                        CKEDITOR.env.ie6Compat && (f = x.getChild(0).getFrameDocument(), f.on("mousemove", b), f.on("mouseup", c));
                        d.preventDefault && d.preventDefault()
                    });
                a.on("load", function() {
                    var b = "";
                    f == CKEDITOR.DIALOG_RESIZE_WIDTH ? b = " cke_resizer_horizontal" : f == CKEDITOR.DIALOG_RESIZE_HEIGHT && (b = " cke_resizer_vertical");
                    b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + e.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(e.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + p + ', event )"\x3e' + ("ltr" == e.lang.dir ? "◢" : "◣") + "\x3c/div\x3e");
        ...
        function v(a) {
            var b = CKEDITOR.document.getWindow(),
                ...
                g = C[c];
            g ? g.show() : (e = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ', CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", e, "; top: 0px; left: 0px; ", CKEDITOR.env.ie6Compat ? "" : "background-color: " + d, '" class\x3d"cke_dialog_background_cover"\x3e'], CKEDITOR.env.ie6Compat && (d = "\x3chtml\x3e\x3cbody style\x3d\\'background-color:" + d + ";\\'\x3e\x3c/body\x3e\x3c/html\x3e", e.push('\x3ciframe hidefocus\x3d"true" frameborder\x3d"0" id\x3d"cke_dialog_background_iframe" src\x3d"javascript:'), e.push("void((function(){" + encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.write( '" + d + "' );document.close();") + "})())"), e.push('" style\x3d"position:absolute;left:0;top:0;width:100%;height: 100%;filter: progid:DXImageTransform.Microsoft.Alpha(opacity\x3d0)"\x3e\x3c/iframe\x3e')), e.push("\x3c/div\x3e"), g = CKEDITOR.dom.element.createFromHtml(e.join("")), g.setOpacity(void 0 !== f ? f : .5), g.on("keydown", n), g.on("keypress", n), g.on("keyup", n), g.appendTo(CKEDITOR.document.getBody()), C[c] = g);
        ...
        function u(a) {
            x && (a.focusManager.remove(x), a = CKEDITOR.document.getWindow(), x.hide(), a.removeListener("resize", w), CKEDITOR.env.ie6Compat && a.$.setTimeout(function() {
        ...
        CKEDITOR.dialog = function(b, f) {
            ...
            function m(a) {
                ...
                if (!(1 > b.length)) {
                    ...
                    do {
                        f += a;
                        if (e && !x._.tabBarMode && (f == b.length || -1 == f)) {
                            x._.tabBarMode = !0;
            ...
            function n(c) {
                if (x == CKEDITOR.dialog._.currentTop) {
                    var d = c.data.getKeystroke(),
                        ...
                        g = [37, 38, 39, 40];
                    w = v = 0;
                    if (9 == d || d == CKEDITOR.SHIFT + 9) m(d == CKEDITOR.SHIFT + 9 ? -1 : 1), w = 1;
                    else if (d == CKEDITOR.ALT + 121 && !x._.tabBarMode && 1 < x.getPageCount()) x._.tabBarMode = !0, x._.tabs[x._.currentTabId][0].focus(), x._.currentFocusIndex = -1, w = 1;
                    else if (-1 != CKEDITOR.tools.indexOf(g, d) && x._.tabBarMode) d = -1 != CKEDITOR.tools.indexOf([f ? 39 : 37, 38], d) ? a.call(x) : e.call(x), x.selectPage(d), x._.tabs[d][0].focus(), w = 1;
                    else if (13 != d && 32 != d || !x._.tabBarMode)
                        if (13 == d) d = c.data.getTarget(), d.is("a", "button", "select", "textarea") || d.is("input") && "button" == d.$.type || ((d = this.getButton("ok")) && CKEDITOR.tools.setTimeout(d.click, 0, d), w = 1), v = 1;
                        ...
                        this._.tabBarMode = !1, this._.currentFocusIndex = -1, m(1), w = 1;
                    y(c)
                }
            }

            function y(a) {
                w ? a.data.preventDefault(1) : v && a.data.stopPropagation()
            }
            var q = CKEDITOR.dialog._.dialogDefinitions[f],
                A = CKEDITOR.tools.clone(p),
                t = b.config.dialog_buttonsOrder || "OS",
                z = b.lang.dir,
                u = {},
                w, v;
            ("OS" == t && CKEDITOR.env.mac || "rtl" == t && "ltr" == z || "ltr" == t && "rtl" == z) && A.buttons.reverse();
            q = CKEDITOR.tools.extend(q(b), A);
            ...
            A["rtl" == z ? "right" : "left"] = 0;
            this.parts.dialog.setStyles(A);
            CKEDITOR.event.call(this);
            this.definition = q = CKEDITOR.fire("dialogDefinition", {
                name: f,
                definition: q
            }, b).definition;
            if (!("removeDialogTabs" in b._) && b.config.removeDialogTabs) {
                A = b.config.removeDialogTabs.split(";");
                for (z = 0; z < A.length; z++)
                    if (t = A[z].split(":"), 2 == t.length) {
                        var C = t[0];
                        u[C] || (u[C] = []);
                        u[C].push(t[1])
                    }
                b._.removeDialogTabs = u
            }
            if (b._.removeDialogTabs && (u = b._.removeDialogTabs[f]))
                for (z = 0; z < u.length; z++) q.removeContents(u[z]);
                ...
                B(function(b) {
                    if (b.validate) {
                        var d = b.validate(this),
                            f = "string" == typeof d || !1 === d;
                        f && (a.data.hide = !1, a.stop());
                        c.call(b, !f, "string" == typeof d ? d : void 0);
                        return f
                    }
                })
            }, this, null, 0);
            ...
            this.on("show", function() {
                D.on("keydown", n, this);
                if (CKEDITOR.env.gecko) D.on("keypress", y, this)
            });
            this.on("hide", function() {
                D.removeListener("keydown", n);
                CKEDITOR.env.gecko && D.removeListener("keypress", y);
                B(function(a) {
                    d.apply(a)
                })
            });
            ...
            this.on("show", function() {
                ...
                b.config.dialog_startupFocusTab && a ? (x._.tabBarMode = !0, x._.tabs[x._.currentTabId][0].focus(), x._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = a ? -1 : this._.focusList.length - 1, q.onFocus ? (a = q.onFocus.call(this)) && a.focus() : m(1))
            ...
            for (z = 0; z < q.contents.length; z++)(u = q.contents[z]) && this.addPage(u);
            this.parts.tabs.on("click", function(a) {
                var b = a.data.getTarget();
                b.hasClass("cke_dialog_tab") && (b = b.$.id, this.selectPage(b.substring(4, b.lastIndexOf("_"))), this._.tabBarMode && (this._.tabBarMode = !1, this._.currentFocusIndex = -1, m(1)), a.data.preventDefault())
            }, this);
            z = [];
            u = CKEDITOR.dialog._.uiElementBuilders.hbox.build(this, {
                type: "hbox",
            ...
            for (z = 0; z < u.length; z++) this._.buttons[u[z].id] = u[z]
        };
        CKEDITOR.dialog.prototype = {
            ...
            move: function(a, b, c) {
                ...
                e && this._.position && this._.position.x == a && this._.position.y == b || (this._.position = {
                    x: a,
                    y: b
                }, e || (e = CKEDITOR.document.getWindow().getScrollPosition(), a += e.x, b += e.y), f && (e = this.getSize(), a = CKEDITOR.document.getWindow().getViewPaneSize().width - e.width - a), b = {
                    top: (0 < b ? b : 0) + "px"
            ...
            layout: function() {
                ...
                CKEDITOR.env.ie6Compat || (b.height + (0 < f ? f : 0) > c.height || b.width + (0 < d ? d : 0) > c.width ? a.setStyle("position", "absolute") : a.setStyle("position", "fixed"));
            ...
            addPage: function(a) {
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    for (var b = [], c = a.label ? ' title\x3d"' + CKEDITOR.tools.htmlEncode(a.label) + '"' : "", d = CKEDITOR.dialog._.uiElementBuilders.vbox.build(this, {
                            ...
                            }, b), f = this._.contents[a.id] = {}, e = d.getChild(),
                            g = 0; d = e.shift();) d.notAllowed || "hbox" == d.type || "vbox" == d.type || g++, f[d.id] = d, "function" == typeof d.getChild && e.push.apply(e, d.getChild());
                    g || (a.hidden = !0);
                    b = CKEDITOR.dom.element.createFromHtml(b.join(""));
                    b.setAttribute("role", "tabpanel");
                    d = CKEDITOR.env;
                    f = "cke_" + a.id + "_" + CKEDITOR.tools.getNextNumber();
                    c = CKEDITOR.dom.element.createFromHtml(['\x3ca class\x3d"cke_dialog_tab"', 0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ? ' style\x3d"display:none"' : "", ' id\x3d"', f, '"', d.gecko && !d.hc ? "" : ' href\x3d"javascript:void(0)"', ' tabIndex\x3d"-1" hidefocus\x3d"true" role\x3d"tab"\x3e', a.label, "\x3c/a\x3e"].join(""));
                    ...
                    a.accessKey && (E(this, this, "CTRL+" + a.accessKey, L, G), this._.accessKeyMap["CTRL+" + a.accessKey] = a.id)
                }
            },
                ...
                if (this._.currentTabId != a && !this._.tabs[a][0].hasClass("cke_dialog_tab_disabled") && !1 !== this.fire("selectPage", {
                    ...
                    for (var c in this._.tabs) {
                        var d = this._.tabs[c][0],
                            f = this._.tabs[c][1];
                        c != a && (d.removeClass("cke_dialog_tab_selected"), f.hide());
                        f.setAttribute("aria-hidden", c != a)
                    }
                    var e = this._.tabs[a];
                    e[0].addClass("cke_dialog_tab_selected");
                    CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat ? (b(e[1]), e[1].show(), setTimeout(function() {
                        b(e[1], 1)
                    }, 0)) : e[1].show();
            ...
            addFocusable: function(a, b) {
                if ("undefined" == typeof b) b = this._.focusList.length, this._.focusList.push(new m(this, a, b));
                else {
        ...
        var p = {
            ...
            y = function(a, b, c) {
                for (var d = 0, f; f = a[d]; d++)
                    if (f.id == b || c && f[c] && (f = y(f[c], b, c))) return f;
                return null
            },
            A = function(a, b, c, d, f) {
                if (c) {
                    for (var e = 0, g; g = a[e]; e++) {
                        if (g.id == c) return a.splice(e, 0, b), b;
                        if (d && g[d] && (g = A(g[d], b, c, d, !0))) return g
                    }
                    if (f) return null
                }
                a.push(b);
        ...
        r.prototype = {
            getContents: function(a) {
                return y(this.contents, a)
            },
            getButton: function(a) {
                return y(this.buttons, a)
            },
        ...
        h.prototype = {
            get: function(a) {
                return y(this.elements, a, "children")
            },
            add: function(a, b) {
        ...
        var w, C = {},
            ...
            D = function(a) {
                ...
                (b = B[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + f]) && b.length && (b = b[b.length - 1], b.keydown && b.keydown.call(b.uiElement, b.dialog, b.key), a.data.preventDefault())
            },
            F = function(a) {
                var b = a.data.$.ctrlKey || a.data.$.metaKey,
                    c = a.data.$.altKey,
                    d = a.data.$.shiftKey,
                    f = String.fromCharCode(a.data.$.keyCode);
                (b = B[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + f]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key), a.data.preventDefault()))
            },
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function(a, b, c, d, f, e, g) {
                    if (!(4 > arguments.length)) {
                        ...
                        for (var y = m["class"] && m["class"].split ? m["class"].split(" ") : [], p = 0; p < y.length; p++) y[p] && (q[y[p]] = 1);
                        y = [];
                        for (p in q) y.push(p);
                        m["class"] = y.join(" ");
                        b.title && (m.title = b.title);
                        q = (b.style || "").split(";");
                        b.align && (y = b.align, l["margin-left"] = "left" == y ? 0 : "auto", l["margin-right"] = "right" == y ? 0 : "auto");
                        for (p in l) q.push(p + ":" + l[p]);
                        b.hidden && q.push("display:none");
                        for (p = q.length - 1; 0 <= p; p--) "" === q[p] && q.splice(p, 1);
                        ...
                        this.keyboardFocusable && (this.tabIndex = b.tabIndex || 0, this.focusIndex = a._.focusList.push(this) - 1, this.on("focus", function() {
                            a._.currentFocusIndex = A.focusIndex
                        }))
                    }
                },
                    ...
                    if (!(4 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, a, f || {
                            ...
                            for (k = 0; k < c.length; k++) {
                                ...
                                h && d.push("height:" + q(h));
                                f && void 0 !== f.padding && d.push("padding:" + q(f.padding));
                                CKEDITOR.env.ie && CKEDITOR.env.quirks && e[k].align && d.push("text-align:" + e[k].align);
                ...
                vbox: function(a, b, c, d, f) {
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, a, f || {
                            ...
                            b.push('"');
                            b.push('align\x3d"', CKEDITOR.tools.htmlEncode(f && f.align || ("ltr" == a.getParentEditor().lang.dir ? "left" : "right")), '" ');
                            b.push("\x3e\x3ctbody\x3e");
                            for (var d = 0; d < c.length; d++) {
                                var k = [];
                                b.push('\x3ctr\x3e\x3ctd role\x3d"presentation" ');
                                g && k.push("width:" + q(g || "100%"));
                                h ? k.push("height:" + q(h[d])) : f && f.expand && k.push("height:" + Math.floor(100 / c.length) + "%");
                                f && void 0 !== f.padding && k.push("padding:" + q(f.padding));
                                CKEDITOR.env.ie && CKEDITOR.env.quirks && e[d].align && k.push("text-align:" + e[d].align);
            ...
            var a = {
                build: function(a, b, c) {
                    for (var d = b.children, f, e = [], g = [], h = 0; h < d.length && (f = d[h]); h++) {
                        var k = [];
                        e.push(k);
                        g.push(CKEDITOR.dialog._.uiElementBuilders[f.type].build(a, f, k))
                    }
                ...
                functions: function() {
                    ...
                    return function() {
                        ...
                        for (e = 0; e < a.length; e++)
                            if ("function" == typeof a[e]) f.push(a[e]);
                            else break;
        ...
        init: function(a) {
            var e = 0,
                b = function(b, d, h, k) {
                    if (k) {
                        ...
                        a.addCommand(h, new CKEDITOR.styleCommand(k, {
                            contentForms: g
                        }));
            ...
            b("Bold", k.bold, "bold", d.coreStyles_bold);
            b("Italic", k.italic, "italic", d.coreStyles_italic);
            b("Underline", k.underline, "underline", d.coreStyles_underline);
            b("Strike", k.strike, "strike", d.coreStyles_strike);
            b("Subscript", k.subscript, "subscript", d.coreStyles_subscript);
            b("Superscript", k.superscript, "superscript", d.coreStyles_superscript);
            a.setKeystroke([
        ...
        var a = {
            exec: function(a) {
                ...
                if (d) {
                    ...
                    var l = d.createIterator();
                    l.enlargeBr = a.config.enterMode != CKEDITOR.ENTER_BR;
                    if (b == CKEDITOR.TRISTATE_OFF) {
                        for (m = []; b = l.getNextParagraph();) m.push(b);
                        1 > m.length && (b = a.document.createElement(a.config.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), f = k.shift(), d.insertNode(b), b.append(new CKEDITOR.dom.text("﻿", a.document)), d.moveToBookmark(f), d.selectNodeContents(b), d.collapse(!0), f = d.createBookmark(), m.push(b), k.unshift(f));
                        h = m[0].getParent();
                        d = [];
                        for (f = 0; f < m.length; f++) b = m[f], h = h.getCommonAncestor(b.getParent());
                        for (b = {
                                table: 1,
                                tbody: 1,
                                tr: 1,
                        ...
                        for (d.insertBefore(m[0]); 0 < m.length;) b = m.shift(), d.append(b)
                        ...
                        b = [];
                        m = [];
                        for (h = {}; 0 < f.length;) l = f.shift(), d = l.getParent(), l.getPrevious() ? l.getNext() ? (l.breakParent(l.getParent()), m.push(l.getNext())) : l.remove().insertAfter(d) : l.remove().insertBefore(d), d.getCustomData("blockquote_processed") || (m.push(d), CKEDITOR.dom.element.setMarker(h, d, "blockquote_processed", !0)), b.push(l);
                        CKEDITOR.dom.element.clearAllMarkers(h);
                        for (f = m.length - 1; 0 <= f; f--) {
                            d = m[f];
                            a: {
                                h = d;
                                for (var l = 0, g = h.getChildCount(), n = void 0; l < g && (n = h.getChild(l)); l++)
                        ...
                        if (a.config.enterMode == CKEDITOR.ENTER_BR)
                            for (d = !0; b.length;)
                                if (l = b.shift(), "div" == l.getName()) {
                                    f = new CKEDITOR.dom.documentFragment(a.document);
                                    !d || !l.getPrevious() || l.getPrevious().type == CKEDITOR.NODE_ELEMENT && l.getPrevious().isBlockBoundary() || f.append(a.document.createElement("br"));
                                    for (d = l.getNext() && !(l.getNext().type == CKEDITOR.NODE_ELEMENT && l.getNext().isBlockBoundary()); l.getFirst();) l.getFirst().remove().appendTo(f);
        ...
        function e(b) {
            function c() {
                ...
                a.on(B.mainPasteEvent, function(a) {
                    "beforepaste" == B.mainPasteEvent && D || w(a)
                });
                "beforepaste" == B.mainPasteEvent && (a.on("paste", function(a) {
                    F || (e(), a.data.preventDefault(), w(a), k("paste") || b.openDialog("paste"))
            ...
            function m(a, c) {
                ...
                if (!d.getById("cke_pastebin")) {
                    ...
                    (p = n.getParent().isReadOnly()) ? (n.setOpacity(0), n.setAttribute("contenteditable", !0)) : n.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-10000px");
                    ...
                    var y = CKEDITOR.document.getWindow().getScrollPosition().y;
                    setTimeout(function() {
                        CKEDITOR.env.webkit && (CKEDITOR.document.getBody().$.scrollTop = y);
                        h && h.removeListener();
            ...
            function w(c) {
                ...
                f && B.canClipboardApiBeTrusted(d.dataTransfer, b) ? (c.data.preventDefault(), setTimeout(function() {
                    a(b, d)
                }, 0)) : m(c, function(c) {
            ...
            b.getClipboardData = function(a, c) {
                ...
                !1 === z() && (b.removeListener("paste", d), h && b.fire("pasteDialog", e) ? (b.on("pasteDialogCommit", f), b.on("dialogHide", function(a) {
                    a.removeListener();
        ...
        CKEDITOR.plugins.add("clipboard", {
            ...
            init: function(a) {
                ...
                a.on("paste", function(d) {
                    ...
                    "text" == f && "html" == h ? e = k(a, e, l.get("plain-text")) : n == CKEDITOR.DATA_TRANSFER_EXTERNAL && a.pasteFilter && !d.dontFilter && (e = k(a, e, a.pasteFilter));
                    d.startsWithEOL && (e = '\x3cbr data-cke-eol\x3d"1"\x3e' + e);
                    d.endsWithEOL && (e += '\x3cbr data-cke-eol\x3d"1"\x3e');
                    "auto" == f && (f = "html" == h || "html" == m ? "html" : "text");
                    d.type = f;
                    d.dataValue = e;
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            getRangeAtDropPosition: function(a, b) {
                ...
                if (document.caretRangeFromPoint) c = b.document.$.caretRangeFromPoint(d, f), h.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), h.collapse(!0);
        ...
        function a(a, c, d, k, m) {
            m = CKEDITOR.tools.genKey(c.getUniqueId(), d.getUniqueId(), a.lang.dir, a.uiColor || "", k.css || "", m || "");
            var f = e[m];
            f || (f = e[m] = new CKEDITOR.ui.panel(c, k), f.element = d.append(CKEDITOR.dom.element.createFromHtml(f.render(a), c)), f.element.setStyles({
                display: "none",
                position: "absolute"
            }));
            return f
            ...
            proto: {
                ...
                showBlock: function(a, c, d, e, m, f) {
                    ...
                    var n = this.element,
                        ...
                        p = q.x + (e || 0) - v.x,
                        y = q.y + (m || 0) - v.y;
                    !t || 1 != d && 4 != d ? t || 2 != d && 3 != d || (p += c.$.offsetWidth - 1) : p += c.$.offsetWidth;
                    if (3 == d || 4 == d) y += c.$.offsetHeight - 1;
                    ...
                    CKEDITOR.tools.setTimeout(function() {
                        var a = CKEDITOR.tools.bind(function() {
                            ...
                            var b = h.element.getWindow(),
                                ...
                                g = t ? b.width - a.right : a.left;
                            t ? e < c && (p = g > c ? p + c : b.width > c ? p - a.left : p - a.right + b.width) : e < c && (p = g > c ? p - c : b.width > c ? p - a.right + b.width : p - a.left);
                            c = a.top;
                            b.height - a.top < d && (y = c > d ? y - d : b.height > d ? y - a.bottom + b.height : y - a.top);
        ...
        beforeInit: function(a) {
            for (var e = a.config.menu_groups.split(","),
                    b = a._.menuGroups = {}, c = a._.menuItems = {}, d = 0; d < e.length; d++) b[e[d]] = d + 1;
                    ...
                    for (var e = 0; e < f.length; e++) {
                        ...
                        if (l)
                            for (var g in l) {
                                ...
                                !n || n.command && !this.editor.getCommand(n.command).state || (n.state = l[g], this.add(n))
                            }
                    }
                },
                onClick: function(a) {
            ...
            proto: {
                ...
                show: function(b, c, e, f) {
                    ...
                    if (!g) {
                        ...
                        v[9] = "next";
                        v[38] = "prev";
                        v[CKEDITOR.SHIFT + 9] = "prev";
                        v["rtl" == l.lang.dir ? 37 : 39] = CKEDITOR.env.ie ? "mouseup" : "click";
                        v[32] = CKEDITOR.env.ie ? "mouseup" : "click";
                        CKEDITOR.env.ie && (v[13] = "mouseup");
                        n = this._.element = n.element;
                        v = n.getDocument();
                        v.getBody().setStyle("overflow", "hidden");
                        v.getElementsByTag("html").getItem(0).setStyle("overflow", "hidden");
                    ...
                    a(h);
                    for (var v = l.elementPath(), v = ['\x3cdiv class\x3d"cke_menu' + (v && v.direction() != l.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], u = h.length, q = u && h[0].group, t = 0; t < u; t++) {
                        var p = h[t];
                        q != p.group && (v.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'), q = p.group);
                        p.render(this, t, v)
                    }
                    v.push("\x3c/div\x3e");
                    n.setHtml(v.join(""));
                        ...
                        a.on("contextmenu", function(a) {
                            ...
                            if (!e || !c) {
                                ...
                                var m = a.getTarget().getDocument(),
                                    ...
                                    l = c ? a.$.clientY : a.$.pageY || m.y + a.$.clientY;
                                CKEDITOR.tools.setTimeout(function() {
                                    this.open(f, null, h, l)
        ...
        function a(a, b) {
            ...
            a.on("selectionChange", function() {
                for (var b = [], f = g.list = [], e = [], k = g.filters, m = !0, z = a.elementPath().elements, r, w = z.length; w--;) {
                    var C = z[w],
                        x = 0;
                    r = C.data("cke-display-name") ? C.data("cke-display-name") : C.data("cke-real-element-type") ? C.data("cke-real-element-type") : C.getName();
                ...
                f = f.length;
                for (k = 0; k < f; k++) r = e[k], m = a.lang.elementspath.eleTitle.replace(/%1/, r), r = c.output({
                    id: n + k,
                    label: m,
                    text: r,
        ...
        CKEDITOR.plugins.add("indent", {
            init: function(b) {
                ...
                b.on("dirChanged", function(a) {
                    ...
                    d.setStartBefore(f);
                    d.setEndAfter(f);
                    for (var e = new CKEDITOR.dom.walker(d), l; l = e.next();)
                        if (l.type == CKEDITOR.NODE_ELEMENT)
                            if (!l.equals(f) && l.getDirection()) d.setStartAfter(l),
                                ...
                                if (g)
                                    for (var n = "ltr" == a.data.dir ? ["_rtl", ""] : ["", "_rtl"], v = 0; v < g.length; v++) l.hasClass(g[v] + n[0]) && (l.removeClass(g[v] + n[0]), l.addClass(g[v] + n[1]));
        ...
        CKEDITOR.plugins.indent.specificDefinition.prototype = {
            execJob: function(a, b) {
                var k = this.jobs[b];
                if (k.state != e) return k.exec.call(this, a)
            },
            refreshJob: function(a, b, k) {
                b = this.jobs[b];
                a.activeFilter.checkFeature(this) ? b.state = b.refresh.call(this, a, k) : b.state = e;
                return b.state
            },
        ...
        function a(a) {
            function c(e) {
                ...
                if (!h || !m) return !1;
                for (var q = h, h = [], t = !1; !t;) q.equals(m) && (t = !0), h.push(q), q = q.getNext();
                if (1 > h.length) return !1;
                q = e.getParents(!0);
                for (m = 0; m < q.length; m++)
                    if (q[m].getName && k[q[m].getName()]) {
                        e = q[m];
                        break
                    }
                for (var q = d.isIndent ? 1 : -1, m = h[0], h = h[h.length - 1], t = CKEDITOR.plugins.list.listToArray(e, g), w = t[h.getCustomData("listarray_index")].indent, m = m.getCustomData("listarray_index"); m <= h.getCustomData("listarray_index"); m++)
                    if (t[m].indent += q, 0 < q) {
                        var v = t[m].parent;
                        t[m].parent = new CKEDITOR.dom.element(v.getName(), v.getDocument())
                    }
                for (m = h.getCustomData("listarray_index") + 1; m < t.length && t[m].indent > w; m++) t[m].indent += q;
                h = CKEDITOR.plugins.list.arrayToList(t, g, null, a.config.enterMode, e.getDirection());
                if (!d.isIndent) {
                    var x;
                    if ((x = e.getParent()) && x.is("li"))
                        for (var q = h.listNode.getChildren(), B = [], D, m = q.count() - 1; 0 <= m; m--)(D = q.getItem(m)) && D.is && D.is("li") && B.push(D)
                }
                h && h.listNode.replace(e);
                if (B && B.length)
                    for (m = 0; m < B.length; m++) {
                        for (D = e = B[m];
                            (D = D.getNext()) && D.is && D.getName() in k;) CKEDITOR.env.needsNbspFiller && !e.getFirst(b) && e.append(u.document.createText(" ")), e.append(D);
                        e.insertAfter(x)
                    }
            ...
            for (var d = this, g = this.database, k = this.context, m = a.getSelection(), m = (m && m.getRanges()).createIterator(),
                    u; u = m.getNextRange();) {
                for (var q = u.getCommonAncestor(); q && (q.type != CKEDITOR.NODE_ELEMENT || !k[q.getName()]);) {
                ...
                q || (q = u.startPath().contains(k)) && u.setEndAt(q, CKEDITOR.POSITION_BEFORE_END);
                if (!q) {
                    var t = u.getEnclosedNode();
                    t && t.type == CKEDITOR.NODE_ELEMENT && t.getName() in k && (u.setStartAt(t, CKEDITOR.POSITION_AFTER_START), u.setEndAt(t, CKEDITOR.POSITION_BEFORE_END), q = t)
                }
                q && u.startContainer.type == CKEDITOR.NODE_ELEMENT && u.startContainer.getName() in k && (t = new CKEDITOR.dom.walker(u), t.evaluator = e, u.startContainer = t.next());
                q && u.endContainer.type == CKEDITOR.NODE_ELEMENT && u.endContainer.getName() in k && (t = new CKEDITOR.dom.walker(u), t.evaluator = e, u.endContainer = t.previous());
                if (q) return c(q)
            }
            return 0
        }
        ...
        function b(a, b, c, d) {
            for (var f, e; f = a[d ? "getLast" : "getFirst"](u);)(e = f.getDirection(1)) !== b.getDirection(1) && f.setAttribute("dir", e), f.remove(), c ? f[d ? "insertBefore" : "insertAfter"](c) : b.append(f, d)
        }

        function c(a) {
            function c(d) {
                var f = a[d ? "getPrevious" : "getNext"](g);
                f && f.type == CKEDITOR.NODE_ELEMENT && f.is(a.getName()) && (b(a, f, null, !d), a.remove(), a = f)
            }
            c();
            c(1)
        }
        ...
        function k(a, d, f) {
            ...
            var h = d.createBookmark(),
                ...
                u = new CKEDITOR.dom.elementPath(f.startContainer),
                v = u.contains(CKEDITOR.dtd.$listItem),
                u = u.contains(CKEDITOR.dtd.$list);
            l ? (l = l.getBogus()) && l.remove() : u && (l = u.getPrevious(g)) && n(l) && l.remove();
            (l = e.getLast()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br") && l.remove();
            (l = d.startContainer.getChild(d.startOffset)) ? e.insertBefore(l): d.startContainer.append(e);
            v && (e = m(v)) && (k.contains(v) ? (b(e, v.getParent(), v), e.remove()) : k.append(e));
            for (; f.checkStartOfBlock() && f.checkEndOfBlock();) {
                u = f.startPath();
                e = u.block;
                if (!e) break;
                e.is("li") && (k = e.getParent(), e.equals(k.getLast(g)) && e.equals(k.getFirst(g)) && (e = k));
        ...
        CKEDITOR.plugins.list = {
            ...
            arrayToList: function(a, b, c, d, e) {
                ...
                for (var h, k = a[c].parent.getDocument(), m = new CKEDITOR.dom.documentFragment(k), n = null, u = c, v = Math.max(a[c].indent, 0), D = null, F, E, I = d == CKEDITOR.ENTER_P ? "p" : "div";;) {
                    var G = a[u];
                    h = G.grandparent;
                    ...
                    if (G.indent == v) {
                        ...
                        u++
                    } else if (G.indent == Math.max(v, 0) + 1) G = a[u - 1].element.getDirection(1), u = CKEDITOR.plugins.list.arrayToList(a, null, u, d, G != F ? F : null), !D.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= k.$.documentMode && D.append(k.createText(" ")), D.append(u.listNode), u = u.nextIndex;
                    else if (-1 == G.indent && !c && h) {
                        f[h.getName()] ? (D = G.element.clone(!1, !0), F != h.getDirection(1) && D.setAttribute("dir", F)) : D = new CKEDITOR.dom.documentFragment(k);
                        var n = h.getDirection(1) != F,
                            L = G.element,
                            N = L.getAttribute("class"),
                            H = L.getAttribute("style"),
                            R = D.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (d != CKEDITOR.ENTER_BR || n || H || N),
                            P, T = G.contents.length,
                            O;
                        for (h = 0; h < T; h++)
                            if (P = G.contents[h], l(P) && 1 < T) R ? O = P.clone(1, 1) : D.append(P.clone(1, 1));
                            else if (P.type == CKEDITOR.NODE_ELEMENT && P.isBlockBoundary()) {
                            n && !P.getDirection() && P.setAttribute("dir", F);
                            E = P;
                            var J = L.getAttribute("style");
                            J && E.setAttribute("style", J.replace(/([^;])$/, "$1;") + (E.getAttribute("style") || ""));
                            N && P.addClass(N);
                            E = null;
                            O && (D.append(O), O = null);
                            D.append(P.clone(1, 1))
                        } else R ? (E || (E = k.createElement(I), D.append(E), n && E.setAttribute("dir", F)), H && E.setAttribute("style", H), N && E.setAttribute("class", N), O && (E.append(O), O = null), E.append(P.clone(1, 1))) : D.append(P.clone(1, 1));
                        O && ((E || D).append(O), O = null);
                        D.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && u != a.length - 1 && (CKEDITOR.env.needsBrFiller && (F = D.getLast()) && F.type == CKEDITOR.NODE_ELEMENT && F.is("br") && F.remove(), (F = D.getLast(g)) && F.type == CKEDITOR.NODE_ELEMENT && F.is(CKEDITOR.dtd.$block) || D.append(k.createElement("br")));
                    ...
                    E = null;
                    if (a.length <= u || Math.max(a[u].indent, 0) < v) break
                }
                if (b)
                    for (a = m.getFirst(); a;) {
        ...
        e.prototype = {
            exec: function(b) {
                ...
                for (var d = e.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0;
                    (l = h.getNextRange()) && ++n;) {
                    var u = l.getBoundaryNodes(),
                        x = u.startNode,
                        B = u.endNode;
                    x.type == CKEDITOR.NODE_ELEMENT && "td" == x.getName() && l.setStartAt(u.startNode, CKEDITOR.POSITION_AFTER_START);
                    B.type == CKEDITOR.NODE_ELEMENT && "td" == B.getName() && l.setEndAt(u.endNode, CKEDITOR.POSITION_BEFORE_END);
                    l = l.createIterator();
                    for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; u = l.getNextParagraph();)
                        if (!u.getCustomData("list_block")) {
                            CKEDITOR.dom.element.setMarker(m, u, "list_block", 1);
                            for (var D = b.elementPath(u), x = D.elements, B = 0, D = D.blockLimit, F, E = x.length - 1; 0 <= E && (F = x[E]); E--)
                                if (f[F.getName()] && D.contains(F)) {
                            ...
                            B || (B = D, B.getCustomData("list_group_object_" + n) ? B.getCustomData("list_group_object_" + n).contents.push(u) : (x = {
                                root: B,
                                contents: [u]
                ...
                for (F = []; 0 < k.length;)
                    if (x = k.shift(), this.state == CKEDITOR.TRISTATE_OFF)
                        if (f[x.root.getName()]) {
                            ...
                            for (var E = n.root.getDocument(), I = void 0, G = void 0, u = 0; u < D.length; u++) {
                                var L = D[u].getCustomData("listarray_index"),
                                    I = B[L].parent;
                                I.is(this.type) || (G = E.createElement(this.type), I.copyAttributes(G, {
                                    start: 1,
                                    type: 1
                                }), G.removeStyle("list-style-type"), B[L].parent = G)
                            }
                            x = CKEDITOR.plugins.list.arrayToList(B, x, null, h.config.enterMode);
                            B = void 0;
                            D = x.listNode.getChildCount();
                            for (u = 0; u < D && (B = x.listNode.getChild(u)); u++) B.getName() == this.type && l.push(B);
                            ...
                            for (E = 0; E < D.length; E++) l = l.getCommonAncestor(D[E].getParent());
                            I = B.config.useComputedState;
                            B = x = void 0;
                            I = void 0 === I || I;
                            for (E = 0; E < D.length; E++)
                                for (G = D[E]; L = G.getParent();) {
                                    if (L.equals(l)) {
                                        n.push(G);
                                        !B && G.getDirection() && (B = 1);
                                        G = G.getDirection(I);
                            ...
                            if (!(1 > n.length)) {
                                ...
                                u.push(E);
                                for (I = u = void 0; n.length;) u = n.shift(), I = h.createElement("li"), G = u, G.is("pre") || v.test(G.getName()) || "false" == G.getAttribute("contenteditable") ? u.appendTo(I) : (u.copyAttributes(I), x && u.getDirection() && (I.removeStyle("direction"), I.removeAttribute("dir")), u.moveChildren(I), u.remove()), I.appendTo(E);
                                x && B && E.setAttribute("dir", x);
                                D ? E.insertBefore(D) : E.appendTo(l)
                            }
                        }
                ...
                a.blockless || (a.addCommand("numberedlist", new e("numberedlist", "ol")), a.addCommand("bulletedlist", new e("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton("NumberedList", {
                    ...
                    if ("wysiwyg" == a.mode && c in {
                        ...
                        if (h && h.collapsed) {
                            ...
                            if (u) {
                                var x;
                                (x = l.contains(f)) && h.checkBoundaryOfElement(x, CKEDITOR.START) && (x = x.getParent()) && x.is("li") && (x = m(x)) ? (e = x, x = x.getPrevious(g), c.moveToPosition(x && n(x) ? x : e, CKEDITOR.POSITION_BEFORE_START)) : (C.range.setStartAt(v, CKEDITOR.POSITION_AFTER_START), C.range.setEnd(h.startContainer, h.startOffset), (x = C.previous()) && x.type == CKEDITOR.NODE_ELEMENT && (x.getName() in f || x.is("li")) && (x.is("li") || (C.range.selectNodeContents(x), C.reset(), C.evaluator = d, x = C.previous()), e = x, c.moveToElementEditEnd(e), c.moveToPosition(c.endPath().block, CKEDITOR.POSITION_BEFORE_END)));
                                if (e) k(a, c, h), b.cancel();
                                else {
                                    var B = l.contains(f);
                                    B && h.checkBoundaryOfElement(B, CKEDITOR.START) && (e = B.getFirst(g), h.checkBoundaryOfElement(e, CKEDITOR.START) && (x = B.getPrevious(g), m(e) ? x && (h.moveToElementEditEnd(x), h.select()) : a.execCommand("outdent"), b.cancel()))
                                }
                            } else if (e = l.contains("li")) {
                                if (C.range.setEndAt(v, CKEDITOR.POSITION_BEFORE_END), u = (v = e.getLast(g)) && d(v) ? v : e, l = 0, (x = C.next()) && x.type == CKEDITOR.NODE_ELEMENT && x.getName() in f && x.equals(v) ? (l = 1, x = C.next()) : h.checkBoundaryOfElement(u, CKEDITOR.END) && (l = 2), l && x) {
                                    h = h.clone();
                                    h.moveToElementEditStart(x);
                                    if (1 == l && (c.optimize(), !c.startContainer.equals(e))) {
            ...
            enterBlock: function(a, f, k, v) {
                if (k = k || e(a)) {
                    ...
                    var u = k.document,
                        ...
                        t = k.checkEndOfBlock(),
                        p = a.elementPath(k.startContainer),
                        y = p.block,
                        A = f == CKEDITOR.ENTER_DIV ? "div" : "p",
                        z;
                    if (q && t) {
                        if (y && (y.is("li") || y.getParent().is("li"))) {
                            y.is("li") || (y = y.getParent());
                            k = y.getParent();
                            z = k.getParent();
                            v = !y.hasPrevious();
                            var r = !y.hasNext(),
                                ...
                                w = A.createBookmarks(),
                                q = y.getDirection(1),
                                t = y.getAttribute("class"),
                                C = y.getAttribute("style"),
                                x = z.getDirection(1) != q;
                            a = a.enterMode != CKEDITOR.ENTER_BR || x || C || t;
                            if (z.is("li")) v || r ? (v && r && k.remove(), y[r ? "insertAfter" : "insertBefore"](z)) : y.breakParent(z);
                            else {
                                if (a)
                                    if (p.block.is("li") ? (z = u.createElement(f == CKEDITOR.ENTER_P ? "p" : "div"), x && z.setAttribute("dir", q), C && z.setAttribute("style", C), t && z.setAttribute("class", t), y.moveChildren(z)) : z = p.block, v || r) z[v ? "insertBefore" : "insertAfter"](k);
                                    else y.breakParent(k), z.insertAfter(k);
                                else if (y.appendBogus(!0), v || r)
                                    for (; u = y[v ? "getFirst" : "getLast"]();) u[v ? "insertBefore" : "insertAfter"](k);
                                else
                                    for (y.breakParent(k); u = y.getLast();) u.insertAfter(k);
                                y.remove()
                            }
                            A.selectBookmarks(w);
                            return
                        ...
                        if (y && y.getParent().is("blockquote")) {
                            ...
                            y.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1)) || y.getPrevious().remove();
                            y.getNext().getFirst(CKEDITOR.dom.walker.invisible(1)) || y.getNext().remove();
                            k.moveToElementEditStart(y);
                            k.select();
                            return
                        }
                    } else if (y && y.is("pre") && !t) {
                        m(a, f, k, v);
                        return
                    }
                    if (q = k.splitBlock(A)) {
                        ...
                        p = q.wasStartOfBlock;
                        a = q.wasEndOfBlock;
                        y ? (w = y.getParent(), w.is("li") && (y.breakParent(w), y.move(y.getNext(), 1))) : f && (w = f.getParent()) && w.is("li") && (f.breakParent(w), w = f.getNext(), k.moveToElementEditStart(w), f.move(f.getPrevious()));
                        if (p || a) {
                            if (f) {
                                if (f.is("li") || !h.test(f.getName()) && !f.is("pre")) z = f.clone()
                            } else y && (z = y.clone());
                            z ? v && !z.is("li") && z.renameNode(A) : w && w.is("li") ? z = w : (z = u.createElement(A), f && (r = f.getDirection()) && z.setAttribute("dir", r));
                            if (u = q.elementPath)
                                for (v = 0, A = u.elements.length; v < A; v++) {
                                    w = u.elements[v];
                                    if (w.equals(u.block) || w.equals(u.blockLimit)) break;
                                    CKEDITOR.dtd.$removeEmpty[w.getName()] && (w = w.clone(), z.moveChildren(w), z.append(w))
                                }
                            z.appendBogus();
                            z.getParent() || k.insertNode(z);
                            z.is("li") && z.removeAttribute("value");
                            !CKEDITOR.env.ie || !p || a && f.getChildCount() || (k.moveToElementEditStart(a ? f : z), k.select());
                            k.moveToElementEditStart(p && !a ? y : z)
                        } else y.is("li") && (z = k.clone(), z.selectNodeContents(y), z = new CKEDITOR.dom.walker(z), z.evaluator = function(a) {
                            return !(d(a) || c(a) || a.type == CKEDITOR.NODE_ELEMENT && a.getName() in CKEDITOR.dtd.$inline && !(a.getName() in CKEDITOR.dtd.$empty))
                        }, (w = z.next()) && w.type == CKEDITOR.NODE_ELEMENT && w.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? u.createElement("br") : u.createText(" ")).insertBefore(w)), y && k.moveToElementEditStart(y);
                        k.select();
                        k.scrollIntoView()
                    }
                }
            ...
            enterBr: function(a, b, c, d) {
                if (c = c || e(a)) {
                    var k = c.document,
                        ...
                        p = t.block,
                        y = p && t.block.getName();
                    d || "li" != y ? (!d && m && h.test(y) ? (m = p.getDirection()) ? (k = k.createElement("div"), k.setAttribute("dir", m), k.insertAfter(p), c.setStart(k, 0)) : (k.createElement("br").insertAfter(p), CKEDITOR.env.gecko && k.createText("").insertAfter(p), c.setStartAt(p.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (a = "pre" == y && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? k.createText("\r") : k.createElement("br"), c.deleteContents(), c.insertNode(a), CKEDITOR.env.needsBrFiller ? (k.createText("﻿").insertAfter(a), m && (p || t.blockLimit).appendBogus(), a.getNext().$.nodeValue = "", c.setStartAt(a.getNext(), CKEDITOR.POSITION_AFTER_START)) : c.setStartAt(a, CKEDITOR.POSITION_AFTER_END)), c.collapse(!0), c.select(), c.scrollIntoView()) : f(a, b, c, d)
                }
            }
        };
        var k = CKEDITOR.plugins.enterkey,
            m = k.enterBr,
            f = k.enterBlock,
            h = /^h[1-6]$/
    }(), function() {
        ...
        CKEDITOR.plugins.add("entities", {
            afterInit: function(e) {
                ...
                if (e = (e = e.dataProcessor) && e.htmlFilter) {
                    ...
                    d.entities && (k.length && k.push("quot,iexcl,cent,pound,curren,yen,brvbar,sect,uml,copy,ordf,laquo,not,shy,reg,macr,deg,plusmn,sup2,sup3,acute,micro,para,middot,cedil,sup1,ordm,raquo,frac14,frac12,frac34,iquest,times,divide,fnof,bull,hellip,prime,Prime,oline,frasl,weierp,image,real,trade,alefsym,larr,uarr,rarr,darr,harr,crarr,lArr,uArr,rArr,dArr,hArr,forall,part,exist,empty,nabla,isin,notin,ni,prod,sum,minus,lowast,radic,prop,infin,ang,and,or,cap,cup,int,there4,sim,cong,asymp,ne,equiv,le,ge,sub,sup,nsub,sube,supe,oplus,otimes,perp,sdot,lceil,rceil,lfloor,rfloor,lang,rang,loz,spades,clubs,hearts,diams,circ,tilde,ensp,emsp,thinsp,zwnj,zwj,lrm,rlm,ndash,mdash,lsquo,rsquo,sbquo,ldquo,rdquo,bdquo,dagger,Dagger,permil,lsaquo,rsaquo,euro"), d.entities_latin && k.push("Agrave,Aacute,Acirc,Atilde,Auml,Aring,AElig,Ccedil,Egrave,Eacute,Ecirc,Euml,Igrave,Iacute,Icirc,Iuml,ETH,Ntilde,Ograve,Oacute,Ocirc,Otilde,Ouml,Oslash,Ugrave,Uacute,Ucirc,Uuml,Yacute,THORN,szlig,agrave,aacute,acirc,atilde,auml,aring,aelig,ccedil,egrave,eacute,ecirc,euml,igrave,iacute,icirc,iuml,eth,ntilde,ograve,oacute,ocirc,otilde,ouml,oslash,ugrave,uacute,ucirc,uuml,yacute,thorn,yuml,OElig,oelig,Scaron,scaron,Yuml"), d.entities_greek && k.push("Alpha,Beta,Gamma,Delta,Epsilon,Zeta,Eta,Theta,Iota,Kappa,Lambda,Mu,Nu,Xi,Omicron,Pi,Rho,Sigma,Tau,Upsilon,Phi,Chi,Psi,Omega,alpha,beta,gamma,delta,epsilon,zeta,eta,theta,iota,kappa,lambda,mu,nu,xi,omicron,pi,rho,sigmaf,sigma,tau,upsilon,phi,chi,psi,omega,thetasym,upsih,piv"), d.entities_additional && k.push(d.entities_additional));
                    var m = a(k.join(",")),
                        f = m.regex ? "[" + m.regex + "]" : "a^";
                    delete m.regex;
                    ...
                    e.addRules({
                        text: function(a) {
                            return a.replace(l, b).replace(f, c)
                        }
                    }, {
                        applyToAll: !0,
        ...
        popup: function(a, e, b, c) {
            ...
            var d = parseInt((window.screen.height - b) / 2, 10),
                k = parseInt((window.screen.width - e) / 2, 10);
            c = (c || "location\x3dno,menubar\x3dno,toolbar\x3dno,dependent\x3dyes,minimizable\x3dno,modal\x3dyes,alwaysRaised\x3dyes,resizable\x3dyes,scrollbars\x3dyes") + ",width\x3d" + e + ",height\x3d" + b + ",top\x3d" + d + ",left\x3d" + k;
            var m = window.open("", null, c, !0);
            if (!m) return !1;
            try {
                -1 == navigator.userAgent.toLowerCase().indexOf(" chrome/") && (m.moveTo(k, d), m.resizeTo(e, b)), m.focus(), m.location.href = a
            } catch (f) {
        ...
        function k(a, f, g, m) {
            if (m && m.length)
                for (var v, u = m.length; u--;)
                    if (v = m[u], "hbox" != v.type && "vbox" != v.type && "fieldset" != v.type || k(a, f, g, v.children), v.filebrowser)
                ...
                v.filebrowser.url = q;
                v.hidden = !1;
                d(a, g.getContents(v["for"][0]).get(v["for"][1]), v.filebrowser)
            }
        }
        ...
        CKEDITOR.on("dialogDefinition", function(a) {
            if (a.editor.plugins.filebrowser)
                for (var b = a.data.definition, c, d = 0; d < b.contents.length; ++d)
                    if (c = b.contents[d]) k(a.editor, a.data.name, b, c.elements), c.hidden && c.filebrowser && (c.hidden = !m(b, c.id, c.filebrowser))
        })
    }(), function() {
        function a(a) {
            var d = a.config,
                ...
                m = function() {
                    ...
                    function g(a) {
                        ...
                        switch (a) {
                            case "top":
                                f("absolute", "top", b.y - A - w);
                                break;
                            case "pin":
                                f("fixed", "top", x);
                                break;
                            case "bottom":
                                f("absolute", "top", b.y + (p.height || p.bottom - p.top) + w)
                        }
                        k = a
                    }
                    var k, l, t, p, y, A, z, r = d.floatSpaceDockedOffsetX || 0,
                        w = d.floatSpaceDockedOffsetY || 0,
                        C = d.floatSpacePinnedOffsetX || 0,
                        x = d.floatSpacePinnedOffsetY || 0;
                    return function(f) {
                        if (l = a.editable()) {
            ...
            if (k) {
                var f = new CKEDITOR.template('\x3cdiv id\x3d"cke_{name}" class\x3d"cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} ' + CKEDITOR.env.cssClass + '" dir\x3d"{langDir}" title\x3d"' + (CKEDITOR.env.gecko ? " " : "") + '" lang\x3d"{langCode}" role\x3d"application" style\x3d"{style}"' + (a.title ? ' aria-labelledby\x3d"cke_{name}_arialbl"' : " ") + "\x3e" + (a.title ? '\x3cspan id\x3d"cke_{name}_arialbl" class\x3d"cke_voice_label"\x3e{voiceLabel}\x3c/span\x3e' : " ") + '\x3cdiv class\x3d"cke_inner"\x3e\x3cdiv id\x3d"{topId}" class\x3d"cke_top" role\x3d"presentation"\x3e{content}\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e'),
                    ...
                    l = CKEDITOR.tools.eventsBuffer(500, m),
            ...
            CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({
                ...
                proto: {
                    ...
                    showAll: function() {
                        ...
                        for (var e in b) a = c.getById(b[e]), f = a.getNext(), a.setStyle("display", ""), f && "ul" == f.getName() && f.setStyle("display", "")
                    },
                    mark: function(a) {
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, d) {
                ...
                if (this.modes) {
                    ...
                    a.on("activeFilterChange", k, this);
                    a.on("mode", k, this);
                    !this.readOnly && a.on("readOnly", k, this)
                ...
                if (this.directional) a.on("contentDirChanged", function(b) {
                    ...
                    f.setAttribute("style", CKEDITOR.skin.getIconStyle(y, "rtl" == b, this.icon, this.iconOffset))
                }, this);
                l || (h += "off");
                var p = this.name || this.command,
                    y = p;
                ...
                createPanel: function(a) {
                    if (!this._.panel) {
                        ...
                        f.onShow = function() {
                            ...
                            l._.on = 1;
                            l.editorFocus && !a.focusManager.hasFocus && a.focus();
        ...
        init: function(a) {
            if (!a.blockless) {
                for (var e = a.config, b = a.lang.format, c = e.format_tags.split(";"), d = {}, k = 0, m = [], f = 0; f < c.length; f++) {
                    var h = c[f],
                        l = new CKEDITOR.style(e["format_" + h]);
                    if (!a.filter.customConfig || a.filter.check(l)) k++, d[h] = l, d[h]._.enterMode = a.config.enterMode, m.push(l)
                }
        ...
        CKEDITOR.plugins.add("image", {
            ...
            afterInit: function(b) {
                function c(c) {
                    var k = b.getCommand("justify" + c);
                    if (k) {
                        if ("left" == c || "right" == c) k.on("exec", function(k) {
                            var f = a(b),
                                h;
                            f && (h = e(f), h == c ? (f.removeStyle("float"), c == e(f) && f.removeAttribute("align")) : f.setStyle("float", c), k.cancel())
                        });
        ...
        function b(b, c) {
            ...
            for (var g = 0; g < f.length; g++) d = f[g].toLowerCase(), e = c[d], 0 < g && h.push(","), h.push("'", e ? a(encodeURIComponent(c[d])) : "", "'");
            h.push(")");
            return h.join("")
        }
        ...
        CKEDITOR.plugins.link = {
            ...
            getEditorAnchors: function(a) {
                ...
                for (f = 0; e = c.getItem(f++);)(e = this.tryRestoreFakeAnchor(a, e)) && d.push({
            ...
            parseLinkAttributes: function(a, b) {
                var c = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
                    ...
                    w, C = {};
                c.match(d) && ("encode" == r ? c = c.replace(n, function(a, b, c) {
                    c = c || "";
                    return "mailto:" + String.fromCharCode.apply(String, b.split(",")) + c.replace(/\\'/g, "'")
                }) : r && c.replace(v, function(a, b, c) {
                    if (b == e.name) {
                        C.type = "email";
                        a = C.email = {};
                        b = /(^')|('$)/g;
                ...
                if (!C.type)
                    if (r = c.match(h)) C.type = "anchor", C.anchor = {}, C.anchor.name = C.anchor.id = r[1];
                    else if (r = c.match(k)) {
                    w = c.match(m);
                    c = c.match(f);
                    C.type = "email";
                    var x = C.email = {};
                    x.address = r[1];
                    w && (x.subject = decodeURIComponent(w[1]));
                    c && (x.body = decodeURIComponent(c[1]))
                } else c && (w = c.match(l)) && (C.type = "url", C.url = {}, C.url.protocol = w[1], C.url.url = w[2]);
                if (b) {
                    if (c = b.getAttribute("target")) C.target = {
                        type: c.match(g) ? c : "frame",
                        name: c
                    };
                    else if (c = (c = b.data("cke-pa-onclick") || b.getAttribute("onclick")) && c.match(u))
                        for (C.target = {
                                type: "popup",
                                name: c[1]
                            }; r = q.exec(c[2]);) "yes" != r[2] && "1" != r[2] || r[1] in {
                            height: 1,
                            width: 1,
                            top: 1,
                            left: 1
                        } ? isFinite(r[2]) && (C.target[r[1]] = r[2]) : C.target[r[1]] = !0;
                    var c = {},
                        B;
                    for (B in t)(r = b.getAttribute(B)) && (c[t[B]] = r);
            ...
            getLinkAttributes: function(c, d) {
                    ...
                    case "email":
                        ...
                        switch (f) {
                            ...
                            case "encode":
                                ...
                                "encode" == f ? (f = ["javascript:void(location.href\x3d'mailto:'+", e(g)], k && f.push("+'", a(k), "'"), f.push(")")) : f = ["mailto:", g, k];
                                break;
                            default:
                ...
                if (d.advanced) {
                    for (var q in t)(f = d.advanced[t[q]]) && (h[q] = f);
                ...
                d.advanced && CKEDITOR.tools.extend(q, t);
                for (var u in h) delete q[u];
                return {
                    set: h,
        ...
        function f(a) {
            ...
            B(c, {
                ...
                place: function() {
                    ...
                    g.equals(c) ? (l.left = b.scroll.x, l.right = -b.scroll.x, l.width = "") : (l.left = h.size.left - h.size.margin.left + b.scroll.x - (a.inInlineMode ? b.editable.left + b.editable.border.left : 0), l.width = h.size.outerWidth + h.size.margin.left + h.size.margin.right + b.scroll.x, l.right = "");
                    f && e ? l.top = f.size.margin.bottom === e.size.margin.top ? 0 | f.size.bottom + f.size.margin.bottom / 2 : f.size.margin.bottom < e.size.margin.top ? f.size.bottom + f.size.margin.bottom : f.size.bottom + f.size.margin.bottom - e.size.margin.top : f ? e || (l.top = f.size.bottom + f.size.margin.bottom) : l.top = e.size.top - e.size.margin.top;
                    d.is(T) || k(l.top, b.scroll.y - 15, b.scroll.y + 5) ? (l.top = a.inInlineMode ? 0 : b.scroll.y, this.look(T)) : d.is(O) || k(l.top, b.pane.bottom - 5, b.pane.bottom + 15) ? (l.top = a.inInlineMode ? b.editable.height + b.editable.padding.top + b.editable.padding.bottom : b.pane.bottom - 1, this.look(O)) : (a.inInlineMode && (l.top -= b.editable.top + b.editable.border.top), this.look(J));
                    a.inInlineMode && (l.top--, l.top += b.editable.scroll.top, l.left += b.editable.scroll.left);
                    for (var m in l) l[m] = CKEDITOR.tools.cssLength(l[m]);
                    this.setStyles(l)
                },
                look: function(a) {
                    if (this.oldLook != a) {
            ...
            c.lineChildren[0].on("mouseup", function(b) {
                ...
                h(a, function(b) {
                    ...
                    b[c.is(N) ? "insertBefore" : "insertAfter"](c.is(N) ? c.lower : c.upper)
                }, !0);
                a.editor.focus();
        ...
        function h(a, b, c) {
            var d = new CKEDITOR.dom.range(a.doc),
                f = a.editor,
                e;
            E.ie && a.enterMode == CKEDITOR.ENTER_BR ? e = a.doc.createText(ca) : (e = (e = m(a.element, !0)) && e.data("cke-enter-mode") || a.enterMode, e = new D(L[e], a.doc), e.is("br") || a.doc.createText(ca).appendTo(e));
                ...
                exec: function() {
                    function f(b) {
                        var d = E.ie && 9 > E.version ? " " : ca,
                            e = a.hotNode && a.hotNode.getText() == d && a.element.equals(a.hotNode) && a.lastCmdDirection === !!c;
                        h(a, function(d) {
                            e && a.hotNode && a.hotNode.remove();
                    ...
                    return function(e) {
                        ...
                        var h;
                        e = e.getAscendant(M, 1);
                        if (!t(a, e) && e && !e.equals(a.editable) && !e.contains(a.editable)) {
                            (h = m(e)) && "false" == h.getAttribute("contenteditable") && (e = h);
                            a.element = e;
                            h = d(a, e, !c);
                            var g;
                            n(h) && h.is(a.triggers) && h.is(K) && (!d(a, h, !c) || (g = d(a, h, !c)) && n(g) && g.is(a.triggers)) ? f(h) : (g = b(a, e), n(g) && (d(a, g, !c) ? (e = d(a, g, !c)) && n(e) && e.is(a.triggers) && f(g) : f(g)))
                        }
                    }
                }()
            }
        ...
        function y(a) {
            ...
            if (!n(b) || v(b) || !q(a, b)) return null;
            r(a, b);
            return !h && 0 <= b.size.top && k(c.y, 0, b.size.top + f) ? (a = a.inInlineMode || 0 === d.scroll.y ? T : J, new e([null, b, N, P, a])) : h && b.size.bottom <= d.pane.height && k(c.y, b.size.bottom - f, d.pane.height) ? (a = a.inInlineMode || k(b.size.bottom, d.pane.height - f, d.pane.height) ? O : J, new e([b, null, H, P, a])) : null
        }
        ...
        function A(a) {
            ...
            if (!g) return null;
            r(a, g);
            var h = Math.min(h, 0 | g.size.outerHeight / 2),
                l = [],
                m, u;
            if (k(c.y, g.size.top - 1, g.size.top + h)) u = !1;
            else if (k(c.y, g.size.bottom - h, g.size.bottom + 1)) u = !0;
            else return null;
            if (v(g) || p(a, g, u) || g.getParent().is(W)) return null;
            var t = d(a, g, !u);
            if (t) {
                if (t && t.type == CKEDITOR.NODE_TEXT) return null;
                if (n(t)) {
                    if (v(t) || !q(a, t) || t.getParent().is(W)) return null;
                    l = [t, g][u ? "reverse" : "concat"]().concat([R, P])
                }
            } else g.equals(a.editable[u ? "getLast" : "getFirst"](a.isRelevant)) ? (w(a), u && k(c.y, g.size.bottom - h, f.pane.height) && k(g.size.bottom, f.pane.height - h, f.pane.height) ? m = O : k(c.y, 0, g.size.top + h) && (m = T)) : m = J, l = [null, g][u ? "reverse" : "concat"]().concat([u ? H : N, P, m, g.equals(a.editable[u ? "getLast" : "getFirst"](a.isRelevant)) ? u ? O : T : J]);
            return 0 in l ? new e(l) : null
        }

        function z(a, b, c, d) {
            for (var f = b.getDocumentPosition(), e = {}, h = {}, g = {}, k = {}, l = ba.length; l--;) e[ba[l]] = parseInt(b.getComputedStyle.call(b, "border-" + ba[l] + "-width"), 10) || 0, g[ba[l]] = parseInt(b.getComputedStyle.call(b, "padding-" + ba[l]), 10) || 0, h[ba[l]] = parseInt(b.getComputedStyle.call(b, "margin-" + ba[l]), 10) || 0;
            c && !d || C(a, d);
        ...
        function r(a, b, c) {
            ...
            if (!b.size) b.size = {};
            else if (b.size.ignoreScroll == c && b.size.date > new Date - S) return null;
            return B(b.size, z(a, b, c), {
                date: +new Date
            }, !0)
        }
            ...
            init: function(a) {
                var c = a.config,
                    ...
                    m = {
                        ...
                        triggers: c.magicline_everywhere ? M : {
                            table: 1,
                            hr: 1,
                            div: 1,
                            ul: 1,
                ...
                a.on("contentDom", function() {
                    ...
                    k.is(G.$inline) || (m.inInlineMode && !u(k) && k.setStyles({
                        position: "relative",
                        top: null,
                        left: null
                    }), f.call(this, m), C(m), k.attachListener(a, "beforeUndoImage", function() {
                        m.line.detach()
                        ...
                        if ("wysiwyg" == a.mode)
                            if (m.inInlineMode) {
                                ...
                                var d = m.view.editable,
                                    f = m.view.scroll;
                                c > d.left - f.x && c < d.right - f.x && b > d.top - f.y && b < d.bottom - f.y || (clearTimeout(r), r = null, m.line.detach())
                        ...
                        p = !0;
                        if ("wysiwyg" == a.mode && !a.readOnly && !r) {
                            var c = {
                                x: b.data.$.clientX,
                                y: b.data.$.clientY
                            };
                            r = setTimeout(function() {
                                ...
                                r = m.trigger = null;
                                C(m);
                                p && !m.hiddenMode && a.focusManager.hasFocus && !m.line.mouseNear() && (m.element = da(m, !0)) && ((m.trigger = y(m) || A(m) || ga(m)) && !t(m, m.trigger.upper || m.trigger.lower) ? m.line.attach().place() : (m.trigger = null, m.line.detach()), p = !1)
                            }, 30)
                        }
                    ...
                    }), k.attachListener(I ? n : v, "mousedown", function() {
                        "wysiwyg" == a.mode && (m.line.detach(), m.hiddenMode = 1, m.mouseDown = 1)
                    }), k.attachListener(I ? n : v, "mouseup", function() {
                        m.hiddenMode = 0;
                        m.mouseDown = 0
                    }), a.addCommand("accessPreviousSpace", l(m)), a.addCommand("accessNextSpace", l(m, !0)), a.setKeystroke([
        ...
        var da = function() {
            ...
            ga = function() {
                function b(f) {
                    ...
                    r(f, h);
                    r(f, g);
                    if (!k(f.mouse.y, h.size.top, g.size.bottom)) return null;
                    for (var e = Number.MAX_VALUE, m, q, u, p; g && !g.equals(h) && (q = h.getNext(f.isRelevant));) m = Math.abs(c(f, h, q) - f.mouse.y), m < e && (e = m, u = h, p = q), h = q, r(f, h);
                    if (!u || !p || !k(f.mouse.y, u.size.top, p.size.bottom)) return null;
                    l.upper = u;
                    l.lower = p;
                    return l.set(R, 8)
                }
                ...
                return function(c) {
                    ...
                    if (f = d) {
                        f = d.upper;
                        var e = d.lower;
                        f = !f || !e || v(e) || v(f) || e.equals(f) || f.equals(e) || e.contains(f) || f.contains(e) ? !1 : q(c, f) && q(c, e) && a(c, f, e) ? !0 : !1
                    }
                    return f ? d : null
                }
            }(),
                    ...
                    a.addCommand("maximize", {
                        ...
                        exec: function() {
                            ...
                            if ("wysiwyg" == a.mode) {
                                ...
                                var y = a.editable().$;
                                g = !CKEDITOR.env.ie && [y.selectionStart, y.selectionEnd];
                                n = [y.scrollLeft, y.scrollTop]
                            }
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                l.on("resize", e);
                                v = l.getScrollPosition();
                                ...
                                l.removeListener("resize", e);
                                for (var p = [t, q], A = 0; A < p.length; A++) c(p[A], p[A].getCustomData("maximize_saved_styles")), p[A].removeCustomData("maximize_saved_styles");
                                for (p = a.container; p = p.getParent();) c(p, p.getCustomData("maximize_saved_styles")), p.removeCustomData("maximize_saved_styles");
                                CKEDITOR.env.ie ? setTimeout(function() {
                                    l.$.scrollTo(v.x, v.y)
                                }, 0) : l.$.scrollTo(v.x, v.y);
                            ...
                            this.toggleState();
                            if (p = this.uiItems[0]) t = this.state == CKEDITOR.TRISTATE_OFF ? f.maximize.maximize : f.maximize.minimize, p = CKEDITOR.document.getById(p._.id), p.getChild(1).setHtml(t), p.setAttribute("title", t), p.setAttribute("href", 'javascript:void("' + t + '");');
                            "wysiwyg" == a.mode ? g ? (CKEDITOR.env.gecko && d(a), a.getSelection().selectRanges(g), (y = a.getSelection().getStartElement()) && y.scrollIntoView(!0)) : l.$.scrollTo(n.x, n.y) : (g && (y.selectionStart = g[0], y.selectionEnd = g[1]), y.scrollLeft = n[0], y.scrollTop = n[1]);
                            g = n = null;
                            u = this.state;
                ...
                b.on("paste", function(e) {
                    ...
                    if (f && (c || /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(f))) {
                        ...
                        var h = a(b, d, function() {
                            if (h) b.fire("paste", m);
                            else if (!b.config.pasteFromWordPromptCleanup || c || confirm(b.lang.pastefromword.confirmCleanup)) m.dataValue = CKEDITOR.cleanWord(f, b);
                            c = 0
                        });
                        h && e.cancel()
                    }
            ...
            removeformat: {
                exec: function(a) {
                    for (var e = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), c = CKEDITOR.plugins.removeformat.filter,
                            d = a.getSelection().getRanges(), k = d.createIterator(), m = function(a) {
                                return a.type == CKEDITOR.NODE_ELEMENT
                            }, f; f = k.getNextRange();) {
                        ...
                        var h = f.createBookmark(),
                            ...
                            g = h.endNode,
                            n = function(b) {
                                for (var d = a.elementPath(b), f = d.elements, h = 1, g;
                                    (g = f[h]) && !g.equals(d.block) && !g.equals(d.blockLimit); h++) e.test(g.getName()) && c(a, g) && b.breakParent(g)
                            };
                        n(l);
                        if (g)
                            for (n(g), l = l.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); l && !l.equals(g);)
                                if (l.isReadOnly()) {
                                    if (l.getPosition(g) & CKEDITOR.POSITION_CONTAINS) break;
                                    l = l.getNext(m)
                                } else n = l.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), "img" == l.getName() && l.data("cke-realelement") || !c(a, l) || (e.test(l.getName()) ? l.remove(1) : (l.removeAttributes(b), a.fire("removeFormatCleanup", l))), l = n;
                        f.moveToBookmark(h)
                    }
                    a.forceNextSelectionCheck();
        ...
        init: function(a) {
            function e(b) {
                var d = h.width,
                    e = h.height,
                    m = d + (b.data.$.screenX - f.x) * ("rtl" == k ? -1 : 1);
                b = e + (b.data.$.screenY - f.y);
                l && (d = Math.max(c.resize_minWidth, Math.min(m, c.resize_maxWidth)));
            ...
            if (!1 !== c.resize_enabled) {
                var m = null,
                    f, h, l = ("both" == c.resize_dir || "horizontal" == c.resize_dir) && c.resize_minWidth != c.resize_maxWidth,
                ...
                a.on("uiSpace", function(b) {
                    if ("bottom" == b.data.space) {
                        ...
                        var f = '\x3cspan id\x3d"' + d + '" class\x3d"cke_resizer' + c + " cke_resizer_" + k + '" title\x3d"' + CKEDITOR.tools.htmlEncode(a.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event)"\x3e' + ("ltr" == k ? "◢" : "◣") + "\x3c/span\x3e";
                        "ltr" == k && "ltr" == c ? b.data.html += f : b.data.html = f + b.data.html
                    }
                }, a, null, 100);
        ...
        init: function(a) {
            ...
            a.contextMenu && a.addMenuItems && (a.contextMenu.addListener(function(b, c) {
                var d = a.scayt,
                    h, l;
                d && (l = d.getSelectionNode()) && (h = e.menuGenerator(a, l), d.showBanner("." + a.contextMenu._.definition.panel.className.split(" ").join(" .")));
                return h
        ...
        bindEvents: function(a) {
                ...
                k = function() {
                    ...
                    c.attachListener(c, "focus", function(c) {
                        ...
                        if ((b || c) && a._.savedSelection) {
                            ...
                            for (var m = 0; m < c.length; m++) e = c[m], "string" === typeof e.startContainer.$.nodeValue && (f = e.startContainer.getText().length, (f < e.startOffset || f < e.endOffset) && a.unlockSelection(!1))
                        }
                    }, this, null, -10)
                },
                m = function() {
            ...
            a.on("reloadMarkupScayt", function(b) {
                ...
                setTimeout(function() {
                    ...
                    d && d.ltr && d.rtl && (a.document.fire("keydown", new CKEDITOR.dom.event({
                        keyCode: 37
                    })), b.removeMarkupInSelectionNode(c), b.fire("startSpellCheck, startGrammarCheck"))
            ...
            if (a.config.scayt_disableOptionsStorage) {
                ...
                a.config.scayt_disableOptionsStorage = function(a) {
                    for (var b = [], c = 0; c < a.length; c++) {
                        var e = a[c],
                            v = !!m(a, "options");
                        if (!m(d, e) || v && m(k, function(a) {
                                if ("lang" === a) return !1
                            })) return;
                        m(k, e) && k.splice(f(k, e), 1);
                        if ("all" === e || v && m(a, "lang")) return [];
                        "options" === e && (k = ["lang"])
                    }
                    return b = b.concat(k)
                }(e)
            ...
            if (0 < e.length && "no_any_suggestions" !== e[0])
                if (b)
                    for (b = 0; b < e.length; b++) {
                        ...
                        a.addCommand(h, this.createCommand(CKEDITOR.plugins.scayt.suggestions[b], k, m));
                        ...
                        for (b = 0; b < e.length; b++) h = "grayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[b].replace(" ", "_"), a.addCommand(h, this.createCommand(CKEDITOR.plugins.scayt.suggestions[b], k, m)), a.addMenuItem(h, {
                            label: e[b],
                            command: h,
                            group: "grayt_suggest",
                            order: b + 1
        ...
        menuGenerator: function(a, e) {
            ...
            for (var l in c) f && -1 == CKEDITOR.tools.indexOf(k, l.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (d[l] = "undefined" != typeof c[l].state ? c[l].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof c[l].verification || c[l].verification(a) || delete d[l], a.addCommand(l, {
                exec: c[l].exec
            }), a.addMenuItem(l, {
                label: a.lang.scayt[c[l].label] || c[l].label,
                command: l,
                group: c[l].group,
                order: c[l].order
            }));
        ...
        CKEDITOR.plugins.add("stylescombo", {
            ...
            init: function(a) {
                ...
                a.on("stylesSet", function(b) {
                    if (b = b.data.styles) {
                        for (var f, h, l, g = 0, n = b.length; g < n; g++)(f = b[g], a.blockless && f.element in CKEDITOR.dtd.$block || (h = f.name, f = new CKEDITOR.style(f), a.filter.customConfig && !a.filter.check(f))) || (f._name = h, f._.enterMode = e.enterMode, f._.type = l = f.assignedTo || f.type, f._.weight = g + 1E3 * (l == CKEDITOR.STYLE_OBJECT ? 1 : l == CKEDITOR.STYLE_BLOCK ? 2 : 3), c[h] = f, d.push(f), k.push(f));
                        d.sort(function(a, b) {
                ...
                a.ui.addRichCombo("Styles", {
                    ...
                    init: function() {
                        var a, c, e, l, g, k;
                        g = 0;
                        for (k = d.length; g < k; g++) a = d[g], c = a._name, l = a._.type, l != e && (this.startGroup(b["panelTitle" + String(l)]), e = l), this.add(c, a.type == CKEDITOR.STYLE_OBJECT ? c : a.buildPreview(), c);
                        this.commit()
                    },
                    onClick: function(b) {
                        a.focus();
                    ...
                    onRender: function() {
                        a.on("selectionChange", function(b) {
                            ...
                            for (var e = 0, l = b.length, g; e < l; e++) {
                                g = b[e];
                                for (var k in c)
                                    if (c[k].checkElementRemovable(g, !0, a)) {
                                        k != d && this.setValue(k);
                                        return
                                    }
                            }
                    ...
                    onOpen: function() {
                        ...
                        for (var e in c) {
                            var l = c[e],
                                g = l._.type;
                            l.checkApplicable(d, a, a.activeFilter) ? f[g]++ : this.hideItem(e);
                            l.checkActive(d, a) && this.mark(e)
                        }
                    ...
                    if (b.editable().hasFocus) {
                        ...
                        if (f = (new CKEDITOR.dom.elementPath(c.getCommonAncestor(), c.root)).contains({
                            ...
                            if (e || a)
                                ...
                                for (var l = f.getAscendant("table").$, e = f.getParent().$.cells, l = new CKEDITOR.dom.element(l.insertRow(-1), b.document), g = 0, n = e.length; g < n; g++) l.append((new CKEDITOR.dom.element(e[g], b.document)).clone(!1, !1)).appendBogus();
        ...
        CKEDITOR.plugins.add("tab", {
            init: function(d) {
                for (var k = !1 !== d.config.enableTabKeyTools, m = d.config.tabSpaces || 0, f = ""; m--;) f += " ";
            ...
            for (f = this.getNextSourceNode(a, CKEDITOR.NODE_ELEMENT); f;) {
                ...
                for (f = this.getDocument().getBody().getFirst(); f = f.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT);) {
                    ...
                    if (f.isVisible() && !(0 > (h = f.getTabIndex()))) {
                        ...
                        h > b && (!k || !m || h < m) ? (k = f, m = h) : k || 0 !== h || (k = f, m = h)
                    }
                }
        k && k.focus()
    }, CKEDITOR.dom.element.prototype.focusPrevious = function(a, e) {
        for (var b = void 0 === e ? this.getTabIndex() : e, c, d, k, m = 0, f, h = this.getDocument().getBody().getLast(); h = h.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT);) {
            if (!c)
                if (!d && h.equals(this)) {
                    if (d = !0, a) {
            ...
            if (h.isVisible() && !(0 > (f = h.getTabIndex())))
                if (0 >= b) {
                    if (c && 0 === f) {
                        k = h;
                        break
        ...
        function a(a) {
            ...
            for (var c = [], d = {}, f = 0; f < a.length; f++) {
                var e = a[f];
                if (e.collapsed) e = e.getCommonAncestor(), (e = e.getAscendant("td", !0) || e.getAscendant("th", !0)) && c.push(e);
                else {
                    var e = new CKEDITOR.dom.walker(e),
                        g;
                    for (e.guard = b; g = e.next();) g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.table) || (g = g.getAscendant("td", !0) || g.getAscendant("th", !0)) && !g.getCustomData("selected_cell") && (CKEDITOR.dom.element.setMarker(d, g, "selected_cell", !0), c.push(g))
                }
            }
        ...
        function e(b, c) {
            for (var d = a(b), f = d[0], e = f.getAscendant("table"), f = f.getDocument(), g = d[0].getParent(), h = g.$.rowIndex, d = d[d.length - 1], l = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = new CKEDITOR.dom.element(e.$.rows[l]), h = c ? h : l, g = c ? g : d, d = CKEDITOR.tools.buildTableMap(e), e = d[h], h = c ? d[h - 1] : d[h + 1], d = d[0].length, f = f.createElement("tr"), l = 0; e[l] && l < d; l++) {
                var k;
                1 < e[l].rowSpan && h && e[l] == h[l] ? (k = e[l], k.rowSpan += 1) : (k = (new CKEDITOR.dom.element(e[l])).clone(), k.removeAttribute("rowSpan"), k.appendBogus(), f.append(k), k = k.$);
                l += k.colSpan - 1
            }
            ...
            if (c instanceof CKEDITOR.dom.selection) {
                ...
                for (var d = d[d.length - 1], g = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [], h = c; h <= g; h++) {
                    for (var l = e[h], k = new CKEDITOR.dom.element(f.$.rows[h]),
                            m = 0; m < l.length; m++) {
                        var n = new CKEDITOR.dom.element(l[m]),
                            v = n.getParent().$.rowIndex;
                        1 == n.$.rowSpan ? n.remove() : (--n.$.rowSpan, v == h && (v = e[h + 1], v[m - 1] ? n.insertAfter(new CKEDITOR.dom.element(v[m - 1])) : (new CKEDITOR.dom.element(f.$.rows[h + 1])).append(n, 1)));
                        m += n.$.colSpan - 1
                    }
                    d.push(k)
                }
                e = f.$.rows;
                f = new CKEDITOR.dom.element(e[g + 1] || (0 < c ? e[c - 1] : null) || f.$.parentNode);
        ...
        function c(a, b) {
            for (var c = b ? Infinity : 0, d = 0; d < a.length; d++) {
                var f;
                f = a[d];
                for (var e = b, g = f.getParent().$.cells, h = 0, l = 0; l < g.length; l++) {
                    var k = g[l],
                        h = h + (e ? 1 : k.colSpan);
                    if (k == f.$) break
                }
        ...
        function d(b, d) {
            for (var f = a(b), e = f[0].getAscendant("table"), g = c(f, 1), f = c(f), g = d ? g : f, h = CKEDITOR.tools.buildTableMap(e), e = [], f = [], l = h.length, k = 0; k < l; k++) e.push(h[k][g]), f.push(d ? h[k][g - 1] : h[k][g + 1]);
            for (k = 0; k < l; k++) e[k] && (1 < e[k].colSpan && f[k] == e[k] ? (g = e[k], g.colSpan += 1) : (g = (new CKEDITOR.dom.element(e[k])).clone(), g.removeAttribute("colSpan"), g.appendBogus(), g[d ? "insertBefore" : "insertAfter"].call(g, new CKEDITOR.dom.element(e[k])), g = g.$), k += g.rowSpan - 1)
        }
        ...
        function m(b) {
            if (b instanceof CKEDITOR.dom.selection) {
                ...
                var c = b[0] && b[0].getAscendant("table"),
                    d;
                a: {
                    var e = 0;d = b.length - 1;
                    for (var g = {}, h, l; h = b[e++];) CKEDITOR.dom.element.setMarker(g, h, "delete_cell", !0);
                    for (e = 0; h = b[e++];)
                        if ((l = h.getPrevious()) && !l.getCustomData("delete_cell") || (l = h.getNext()) && !l.getCustomData("delete_cell")) {
                            CKEDITOR.dom.element.clearAllMarkers(g);
                            d = l;
                            break a
                        }
                    CKEDITOR.dom.element.clearAllMarkers(g);l = b[0].getParent();
                    (l = l.getPrevious()) ? d = l.getLast() : (l = b[d].getParent(), d = (l = l.getNext()) ? l.getChild(0) : null)
                }
                for (l = b.length - 1; 0 <= l; l--) m(b[l]);
                d ? f(d, !0) : c && c.remove()
        ...
        function l(b, c, d) {
            ...
            var l = CKEDITOR.tools.buildTableMap(e),
                k = l.length,
                m = l[0].length,
            ...
            if (c) {
                ...
                try {
                    ...
                    B = l["up" == c ? n - D : "down" == c ? n + D : n]["left" == c ? v - g : "right" == c ? v + g : v]
                } catch (F) {
                    return !1
                }
                if (!B || b.$ == B) return !1;
                f["up" == c || "left" == c ? "unshift" : "push"](new CKEDITOR.dom.element(B))
            }
            c = b.getDocument();
            var E = n,
                D = B = 0,
            ...
            for (c = 0; c < f.length; c++) {
                ...
                var L = g.getParent(),
                    ...
                    D = Math.max(D, P - v + H);
                B = Math.max(B, L - n + R);
                d || (H = g, (R = H.getBogus()) && R.remove(), H.trim(), g.getChildren().count() && (L == E || !N || N.isBlockBoundary && N.isBlockBoundary({
                    br: 1
                }) || (E = I.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !E || E.is && E.is("br") || I.append("br")), g.moveChildren(I)), c ? g.remove() : g.setHtml(""));
                E = L
            }
            if (d) return B * D == G;
            I.moveChildren(b);
            ...
            B >= k ? b.removeAttribute("colSpan") : b.$.colSpan = D;
        ...
        function g(b, c) {
            ...
            if (1 < m) {
                n = Math.ceil(m / 2);
                for (var m = Math.floor(m / 2), f = l + n, e = new CKEDITOR.dom.element(e.$.rows[f]), g = h(g, f), v, f = d.clone(), l = 0; l < g.length; l++)
                    if (v = g[l], v.parentNode == e.$ && l > k) {
                        f.insertBefore(new CKEDITOR.dom.element(v));
                        break
                    } else v = null;
                v || e.append(f)
            } else
                for (m = n = 1, e = f.clone(), e.insertAfter(f), e.append(f = d.clone()), v = h(g, l), k = 0; k < v.length; k++) v[k].rowSpan++;
            f.appendBogus();
            d.$.rowSpan = n;
            f.$.rowSpan = m;
        ...
        function n(b, c) {
            ...
            var d = d[0],
                ...
                g = h(e, f.$.rowIndex, d),
                l = d.$.colSpan;
            if (1 < l) f = Math.ceil(l / 2), l = Math.floor(l / 2);
            else {
                for (var l = f = 1, k = [], m = 0; m < e.length; m++) {
                    var n = e[m];
                    k.push(n[g]);
            ...
            init: function(c) {
                ...
                t("columnDelete", h({
                    ...
                    exec: function(b) {
                        ...
                        for (var e = CKEDITOR.tools.buildTableMap(b), g, h, l = [], k = 0, m = e.length; k < m; k++)
                            for (var n = 0, q = e[k].length; n < q; n++) e[k][n] == c.$ && (g = n), e[k][n] == d.$ && (h = n);
                        for (k = g; k <= h; k++)
                            for (n = 0; n < e.length; n++) d = e[n], c = new CKEDITOR.dom.element(b.$.rows[n]), d = new CKEDITOR.dom.element(d[k]), d.$ && (1 == d.$.colSpan ? d.remove() : --d.$.colSpan, n += d.$.rowSpan - 1, c.$.cells.length || l.push(c));
        ...
        function a(a) {
            function b() {
                for (var g = c(), h = CKEDITOR.tools.clone(a.config.toolbarGroups) || e(a), l = 0; l < h.length; l++) {
                    var k = h[l];
                    if ("/" != k) {
                        "string" == typeof k && (k = h[l] = {
                            name: k
                        });
                        var t, p = k.groups;
                        if (p)
                            for (var y = 0; y < p.length; y++) t = p[y], (t = g[t]) && f(k, t);
                        (t = g[k.name]) && f(k, t)
                    }
                }
                return h
            ...
            function c() {
                var b = {},
                    f, e, g;
                for (f in a.ui.items) e = a.ui.items[f], g = e.toolbar || "others", g = g.split(","), e = g[0], g = parseInt(g[1] || -1, 10), b[e] || (b[e] = []), b[e].push({
                    name: f,
                    order: g
                });
            ...
            function f(b, c) {
                if (c.length) {
                    ...
                    for (var f; f = c.shift();) f = "string" == typeof f ? f : f.name, l && -1 != CKEDITOR.tools.indexOf(l, f) || (f = a.ui.create(f)) && a.addFeature(f) && b.items.push(f)
                }
            }
                    ...
                    if (c.data.space == d.config.toolbarLocation) {
                        ...
                        for (var v = d.toolbox.toolbars, u = a(d), q = 0; q < u.length; q++) {
                            var t, p = 0,
                                ...
                                z;
                            if (A)
                                if (g && (l.push("\x3c/span\x3e"), k = g = 0), "/" === A) l.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e');
                                else {
                                    z = A.items || A;
                                    for (var r = 0; r < z.length; r++) {
                                        ...
                                        if (w) {
                                            var x = function(a) {
                                                a = a.render(d, l);
                                                B = p.items.push(a) - 1;
                                                0 < B && (a.previous = p.items[B - 1], a.previous.next = a);
                                                a.toolbar = p;
                                                a.onkey = m;
                                                a.onfocus = function() {
                                            ...
                                            if (w.type == CKEDITOR.UI_SEPARATOR) k = g && w;
                                            else {
                                                C = !1 !== w.canGroup;
                                                if (!p) {
                                                    ...
                                                    y = A.name && (d.lang.toolbar.toolbarGroups[A.name] || A.name);
                                                    l.push('\x3cspan id\x3d"', t, '" class\x3d"cke_toolbar"', y ? ' aria-labelledby\x3d"' + t + '_label"' : "", ' role\x3d"toolbar"\x3e');
                                                    y && l.push('\x3cspan id\x3d"', t, '_label" class\x3d"cke_voice_label"\x3e', y, "\x3c/span\x3e");
                                                    l.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e');
                                                    var B = v.push(p) - 1;
                                                    0 < B && (p.previous = v[B - 1], p.previous.next = p)
                                                }
                                    ...
                                    g && (l.push("\x3c/span\x3e"), k = g = 0);
                                    p && l.push('\x3cspan class\x3d"cke_toolbar_end"\x3e\x3c/span\x3e\x3c/span\x3e')
                                }
                        }
                        ...
                        if (d.config.toolbarCanCollapse && d.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                            ...
                            l.push('" onclick\x3d"CKEDITOR.tools.callFunction(' + D + ')"\x3e', '\x3cspan class\x3d"cke_arrow"\x3e\x26#9650;\x3c/span\x3e', "\x3c/a\x3e")
                        }
                        l.push("\x3c/span\x3e");
                        c.data.html += l.join("")
                    }
                ...
                d.on("destroy", function() {
                    if (this.toolbox) {
                        ...
                        for (a = this.toolbox.toolbars; b < a.length; b++)
                            for (d = a[b].items, c = 0; c < d.length; c++) e = d[c], e.clickFn && CKEDITOR.tools.removeFunction(e.clickFn), e.keyDownFn && CKEDITOR.tools.removeFunction(e.keyDownFn)
                    }
                });
        ...
        CKEDITOR.ui.prototype.addToolbarGroup = function(a, b, c) {
            ...
            h ? f.splice(0, 0, a) : "number" == typeof b ? f.splice(b + 1, 0, l) : f.push(a)
        }
        ...
        function a(a) {
            ...
            var c = this.editor,
                f = a.document,
                h = f.body,
                l = f.getElementById("cke_actscrpt");
            l && l.parentNode.removeChild(l);
            (l = f.getElementById("cke_shimscrpt")) && l.parentNode.removeChild(l);
            (l = f.getElementById("cke_basetagscrpt")) && l.parentNode.removeChild(l);
            h.contentEditable = !0;
            ...
            proto: {
                setData: function(a, c) {
                    ...
                    if (c) this.setHtml(a), this.fixInitialSelection(), e.fire("dataReady");
                        ...
                        h ? (/<body[\s|>]/.test(a) || (a = "\x3cbody\x3e" + a), /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a + "\x3c/html\x3e"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(/<html[^>]*>/, "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"), n && (a = a.replace(/<head[^>]*?>/, "$\x26" + n)), a = a.replace(/<\/head\s*>/, g + "$\x26"), a = l + a) : a = f.docType + '\x3chtml dir\x3d"' + f.contentsLangDirection + '" lang\x3d"' + (f.contentsLanguage || e.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle + "\x3c/title\x3e" + n + g + "\x3c/head\x3e\x3cbody" + (f.bodyId ? ' id\x3d"' + f.bodyId + '"' : "") + (f.bodyClass ? ' class\x3d"' + f.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
